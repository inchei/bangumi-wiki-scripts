...
`)+`
`}function Ta(t,e,n,i,r,o,s){if(typeof s=="function"&&(s={callback:s}),s?.callback){let{callback:l}=s;$a(t,e,n,i,r,o,Object.assign(Object.assign({},s),{callback:d=>{l(d?ps(d,s.headerOptions):void 0)}}))}else{let l=$a(t,e,n,i,r,o,s);return l?ps(l,s?.headerOptions):void 0}}function uh(t){let e=t.endsWith(`
`),n=t.split(`
`).map(i=>i+`
`);return e?n.pop():n.push(n.pop().slice(0,-1)),n}fs.name="@git-diff-view/file";function hf(t,e,n,i,r,o,s,l){let d=Ta(t,n,e,i,"","",s);return new Xi(t,e,n,i,[d],r,o,l)}var $r;(function(t){t[t.CRLF=1]="CRLF",t[t.CR=2]="CR",t[t.LF=3]="LF",t[t.NEWLINE=4]="NEWLINE",t[t.NORMAL=5]="NORMAL",t[t.NULL=6]="NULL"})($r||($r={}));var jt;(function(t){t[t.SplitGitHub=1]="SplitGitHub",t[t.SplitGitLab=2]="SplitGitLab",t[t.Split=3]="Split",t[t.Unified=4]="Unified"})(jt||(jt={}));typeof window<"u"&&((window.__svelte??={}).v??=new Set).add("5");var ei={};var Ue=Symbol("uninitialized"),tn=Symbol("filename");var hs="http://www.w3.org/1999/xhtml",Co="http://www.w3.org/2000/svg",Da="http://www.w3.org/1998/Math/MathML";var mf=globalThis.process?.env?.NODE_ENV,F=mf&&!mf.toLowerCase().startsWith("prod");var gi=Array.isArray,gf=Array.prototype.indexOf,$i=Array.prototype.includes,Tr=Array.from,Fa=Object.keys,At=Object.defineProperty,un=Object.getOwnPropertyDescriptor,Ma=Object.getOwnPropertyDescriptors,Ha=Object.prototype,vf=Array.prototype,Dr=Object.getPrototypeOf,Ba=Object.isExtensible;var ht=()=>{};function ms(t){for(var e=0;e<t.length;e++)t[e]()}function gs(){var t,e,n=new Promise((i,r)=>{t=i,e=r});return{promise:n,resolve:t,reject:e}}var pn=Symbol("$state"),vs=Symbol("component"),_s=Symbol("legacy props"),_f=Symbol(""),bs=Symbol("proxy path"),ws=Symbol("attributes"),$o=Symbol("class"),To=Symbol("style"),Do=Symbol("text");var Ra=Symbol("hmr anchor"),vi=new class extends Error{name="StaleReactionError";message="The reaction that called `getAbortSignal()` was re-run or destroyed"},Oa=!!globalThis.document?.contentType&&globalThis.document.contentType.includes("xml");var Fr=3,hn=8;var _i="font-weight: bold",bi="font-weight: normal";function bf(t){F?console.warn(`%c[svelte] await_reactivity_loss
%cDetected reactivity loss when reading \`${t}\`. This happens when state is read in an async function after an earlier \`await\`
https://svelte.dev/e/await_reactivity_loss`,_i,bi):console.warn("https://svelte.dev/e/await_reactivity_loss")}function wf(t,e){F?console.warn(`%c[svelte] await_waterfall
...
https://svelte.dev/e/await_waterfall`,_i,bi):console.warn("https://svelte.dev/e/await_waterfall")}function xf(){F?console.warn(`%c[svelte] derived_inert
%cReading a derived belonging to a now-destroyed effect may result in stale values
https://svelte.dev/e/derived_inert`,_i,bi):console.warn("https://svelte.dev/e/derived_inert")}function yf(t,e,n){F?console.warn(`%c[svelte] hydration_attribute_changed
...
https://svelte.dev/e/hydration_attribute_changed`,_i,bi):console.warn("https://svelte.dev/e/hydration_attribute_changed")}function Ef(t){F?console.warn(`%c[svelte] hydration_html_changed
...
https://svelte.dev/e/hydration_mismatch`,_i,bi):console.warn("https://svelte.dev/e/hydration_mismatch")}function Af(){F?console.warn(`%c[svelte] lifecycle_double_unmount
%cTried to unmount a component that was not mounted
https://svelte.dev/e/lifecycle_double_unmount`,_i,bi):console.warn("https://svelte.dev/e/lifecycle_double_unmount")}function xs(t){F?console.warn(`%c[svelte] state_proxy_equality_mismatch
%cReactive \`$state(...)\` proxies and the values they proxy have different identities. Because of this, comparisons with \`${t}\` will produce unexpected results
https://svelte.dev/e/state_proxy_equality_mismatch`,_i,bi):console.warn("https://svelte.dev/e/state_proxy_equality_mismatch")}function Lf(){F?console.warn("%c[svelte] svelte_boundary_reset_noop\n%cA `<svelte:boundary>` `reset` function only resets the boundary the first time it is called\nhttps://svelte.dev/e/svelte_boundary_reset_noop",_i,bi):console.warn("https://svelte.dev/e/svelte_boundary_reset_noop")}var le=!1;function mt(t){le=t}var _e;function Be(t){if(t===null)throw Ti(),ei;return _e=t}function Lt(){return Be(kt(_e))}function T(t){if(le){if(kt(_e)!==null)throw Ti(),ei;_e=t}}function er(t=1){if(le){for(var e=t,n=_e;e--;)n=kt(n);_e=n}}function ti(t=!0){for(var e=0,n=_e;;){if(n.nodeType===hn){var i=n.data;if(i==="]"){if(e===0)return n;e-=1}else(i==="["||i==="[!"||i[0]==="["&&!isNaN(Number(i.slice(1))))&&(e+=1)}var r=kt(n);t&&n.remove(),n=r}}function Mo(t){if(!t||t.nodeType!==hn)throw Ti(),ei;return t.data}function ys(t){return t===this.v}function Pa(t,e){return t!=t?e==e:t!==e||t!==null&&typeof t=="object"||typeof t=="function"}function Es(t){return!Pa(t,this.v)}function kf(t){if(F){let e=new Error(`invariant_violation
...
https://svelte.dev/e/lifecycle_outside_component`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/lifecycle_outside_component")}function Sf(){if(F){let t=new Error("async_derived_orphan\nCannot create a `$derived(...)` with an `await` expression outside of an effect tree\nhttps://svelte.dev/e/async_derived_orphan");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/async_derived_orphan")}function Nf(){if(F){let t=new Error(`derived_references_self
A derived value cannot reference itself recursively
https://svelte.dev/e/derived_references_self`);throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/derived_references_self")}function ja(t,e,n){if(F){let i=new Error(`each_key_duplicate
${n?`Keyed each block has duplicate key \`${n}\` at indexes ${t} and ${e}`:`Keyed each block has duplicate key at indexes ${t} and ${e}`}
https://svelte.dev/e/each_key_duplicate`);throw i.name="Svelte error",i}else throw new Error("https://svelte.dev/e/each_key_duplicate")}function Cf(t,e,n){if(F){let i=new Error(`each_key_volatile
...
https://svelte.dev/e/each_key_volatile`);throw i.name="Svelte error",i}else throw new Error("https://svelte.dev/e/each_key_volatile")}function $f(t){if(F){let e=new Error(`effect_in_teardown
\`${t}\` cannot be used inside an effect cleanup function
https://svelte.dev/e/effect_in_teardown`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/effect_in_teardown")}function Tf(){if(F){let t=new Error("effect_in_unowned_derived\nEffect cannot be created inside a `$derived` value that was not itself created inside an effect\nhttps://svelte.dev/e/effect_in_unowned_derived");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/effect_in_unowned_derived")}function Df(t){if(F){let e=new Error(`effect_orphan
\`${t}\` can only be used inside an effect (e.g. during component initialisation)
https://svelte.dev/e/effect_orphan`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/effect_orphan")}function Ff(){if(F){let t=new Error(`effect_update_depth_exceeded
Maximum update depth exceeded. This typically indicates that an effect reads and writes the same piece of state
https://svelte.dev/e/effect_update_depth_exceeded`);throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/effect_update_depth_exceeded")}function Mf(){if(F){let t=new Error(`hydration_failed
Failed to hydrate the application
https://svelte.dev/e/hydration_failed`);throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/hydration_failed")}function Hf(){if(F){let t=new Error("invalid_snippet\nCould not `{@render}` snippet due to the expression being `null` or `undefined`. Consider using optional chaining `{@render snippet?.()}`\nhttps://svelte.dev/e/invalid_snippet");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/invalid_snippet")}function Bf(t){if(F){let e=new Error(`props_rest_readonly
Rest element properties of \`$props()\` such as \`${t}\` are readonly
https://svelte.dev/e/props_rest_readonly`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/props_rest_readonly")}function Rf(t){if(F){let e=new Error(`rune_outside_svelte
The \`${t}\` rune is only available inside \`.svelte\` and \`.svelte.js/ts\` files
https://svelte.dev/e/rune_outside_svelte`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/rune_outside_svelte")}function Of(){if(F){let t=new Error("set_context_after_init\n`setContext` must be called when a component first initializes, not in a subsequent effect or after an `await` expression\nhttps://svelte.dev/e/set_context_after_init");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/set_context_after_init")}function Pf(){if(F){let t=new Error("state_descriptors_fixed\nProperty descriptors defined on `$state` objects must contain `value` and always be `enumerable`, `configurable` and `writable`.\nhttps://svelte.dev/e/state_descriptors_fixed");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/state_descriptors_fixed")}function jf(){if(F){let t=new Error("state_prototype_fixed\nCannot set prototype of `$state` object\nhttps://svelte.dev/e/state_prototype_fixed");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/state_prototype_fixed")}function Uf(){if(F){let t=new Error("state_unsafe_mutation\nUpdating state inside `$derived(...)`, `$inspect(...)` or a template expression is forbidden. If the value should not be reactive, declare it without `$state`\nhttps://svelte.dev/e/state_unsafe_mutation");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/state_unsafe_mutation")}function Gf(){if(F){let t=new Error("svelte_boundary_reset_onerror\nA `<svelte:boundary>` `reset` function cannot be called while an error is still being handled\nhttps://svelte.dev/e/svelte_boundary_reset_onerror");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/svelte_boundary_reset_onerror")}var gt=!1,wi=!1,Hn=!1;function zf(){wi=!0}var Ho=null;function Ut(t,e){return t.label=e,Ls(t.v,e),t}function Ls(t,e){return t?.[bs]?.(e),t}function Bn(t){let e=new Error,n=mh();return n.length===0?null:(n.unshift(`
`),At(e,"stack",{value:n.join(`
`)}),At(e,"name",{value:t}),e)}function mh(){let t=Error.stackTraceLimit;Error.stackTraceLimit=1/0;let e=new Error().stack;if(Error.stackTraceLimit=t,!e)return[];let n=e.split(`
`),i=[];for(let r=0;r<n.length;r++){let o=n[r],s=o.replaceAll("\\","/");if(o.trim()!=="Error"){if(o.includes("validate_each_keys"))return[];s.includes("svelte/src/internal")||s.includes("node_modules/.vite")||i.push(o)}}return i}function Vf(t,e){if(!F)throw new Error("invariant(...) was not guarded by if (DEV)");t||kf(e)}function gh(t){let e=t.p;for(;e!==null&&e.c===null;)e=e.p;return e?.c??null}function Ua(t,e){return t===null&&Br(e),t.c??=new Map(gh(t)||void 0)}var Ae=null;function xi(t){Ae=t}var Rn=null;function Rr(t){Rn=t}var mn=null;function ks(t){mn=t}function Qe(t){return Ua(Ae,"getContext").get(t)}function Ye(t,e){let n=Ua(Ae,"setContext");if(gt){var i=se.f,r=!ge&&(i&32)!==0&&!Ae.i;r||Of()}return n.set(t,e),e}function de(t,e=!1,n){Ae={p:Ae,i:!1,c:null,e:null,s:t,x:null,r:se,l:wi&&!e?{s:null,u:null,$:[]}:null},F&&(Ae.function=n,mn=n)}function fe(t){var e=Ae,n=e.e;if(n!==null){e.e=null;for(var i of n)Ga(i)}return t!==void 0&&(e.x=t),e.i=!0,Ae=e.p,F&&(mn=Ae?.function??null),Is(t)}function Is(t={}){return At(t,vs,{value:!0}),t}function ni(){return!wi||Ae!==null&&Ae.l===null}var tr=[];function Qf(){var t=tr;tr=[],ms(t)}function It(t){if(tr.length===0&&!nr){var e=tr;queueMicrotask(()=>{e===tr&&Qf()})}tr.push(t)}function Yf(){for(;tr.length>0;)Qf()}var vh=-7169;function Oe(t,e){t.f=t.f&vh|e}function Or(t){(t.f&512)!==0||t.deps===null?Oe(t,1024):Oe(t,4096)}function Jf(t){if(t!==null)for(let e of t)(e.f&2)===0||(e.f&65536)===0||(e.f^=65536,Jf(e.deps))}function Ss(t,e,n){(t.f&2048)!==0?e.add(t):(t.f&4096)!==0&&n.add(t),Jf(t.deps),Oe(t,1024)}var qf=!1;function ii(t){var e=ge,n=se;wt(null),xt(null);try{return t()}finally{wt(e),xt(n)}}function Ns(t,e,n,i){let r=ni()?jr:Ur;var o=t.filter(g=>!g.settled),s=e.map(r);if(F&&s.forEach((g,v)=>{g.label=e[v].toString().replace("() => ","").replaceAll("$.eager(() => ","$state.eager(").replace(/\$\.get\((.+?)\)/g,(y,w)=>w)}),n.length===0&&o.length===0){i(s);return}var l=se,d=Xf(),u=o.length===1?o[0].promise:o.length>1?Promise.all(o.map(g=>g.promise)):null;function c(g){if((l.f&16384)===0){d();try{i([...s,...g])}catch(v){rn(v,l)}Pr()}}var f=za();if(n.length===0){u.then(()=>c([])).finally(f);return}function p(){Promise.all(n.map(g=>Va(g))).then(c).catch(g=>rn(g,l)).finally(f)}u?u.then(()=>{d(),p(),Pr()}):p()}function Xf(){var t=se,e=ge,n=Ae,i=be;if(F)var r=Rn;return function(s=!0){xt(t),wt(e),xi(n),s&&(t.f&16384)===0&&(i?.activate(),i?.apply()),F&&(Wa(null),Rr(r))}}var wh=!1;function Pr(t=!0){wh=!1,xt(null),wt(null),xi(null),t&&be?.deactivate(),F&&(Wa(null),Rr(null))}function za(){var t=se,e=t.b,n=be,i=!!e?.is_rendered();return e?.update_pending_count(1,n),n.increment(i,t),()=>{e?.update_pending_count(-1,n),n.decrement(i,t)}}var on=null;function Wa(t){on=t}var Oo=new Set;function jr(t){var e=2050;se!==null&&(se.f|=524288);let n={ctx:Ae,deps:null,effects:null,equals:ys,f:e,fn:t,reactions:null,rv:0,v:Ue,wv:0,parent:se,ac:null};return F&&Hn&&(n.created=Bn("created at")),n}var Gr=Symbol("obsolete");function Va(t,e,n){let i=se;i===null&&Sf();var r=void 0,o=Vt(Ue);F&&(o.label=e??t.toString());var s=!ge,l=new Set;return tc(()=>{var d=se;F&&(on={effect:d,effect_deps:new Set,warned:!1});var u=gs();r=u.promise;try{Promise.resolve(t()).then(u.resolve,g=>{g!==vi&&u.reject(g)}).finally(Pr)}catch(g){u.reject(g),Pr()}if(F){if(on){if(d.deps!==null)for(let g=0;g<Yt;g+=1)on.effect_deps.add(d.deps[g]);if(St!==null)for(let g=0;g<St.length;g+=1)on.effect_deps.add(St[g])}on=null}var c=be;if(s){if((d.f&32768)!==0)var f=za();if(i.b?.is_rendered())c.async_deriveds.get(d)?.reject(Gr);else for(let g of l.values())g.reject(Gr);l.add(u),c.async_deriveds.set(d,u)}let p=(g,v=void 0)=>{F&&(on=null),f?.(),l.delete(u),v!==Gr&&(c.activate(),v?(o.f|=8388608,Pn(o,v)):((o.f&8388608)!==0&&(o.f^=8388608),F&&n!==void 0&&!o.equals(g)&&(Oo.add(o),setTimeout(()=>{Oo.has(o)&&(d.f&16384)===0&&(wf(o.label,n),Oo.delete(o))})),Pn(o,g)),c.deactivate())};u.promise.then(p,g=>p(null,g||"unknown"))}),zt(()=>{for(let d of l)d.reject(Gr)}),F&&(o.f|=4194304),new Promise(d=>{function u(c){function f(){c===r?d(o):u(r)}c.then(f,f)}u(r)})}function I(t){let e=jr(t);return gt||Ts(e),e}function Ur(t){let e=jr(t);return e.equals=Es,e}function Zf(t){var e=t.effects;if(e!==null){t.effects=null;for(var n=0;n<e.length;n+=1)tt(e[n])}}var Qa=[];function Po(t){var e,n=se,i=t.parent;if(!xn&&i!==null&&t.v!==Ue&&(i.f&24576)!==0)return xf(),t.v;if(xt(i),F){let r=sr;Cs(new Set);try{$i.call(Qa,t)&&Nf(),Qa.push(t),t.f&=-65537,Zf(t),e=$s(t)}finally{xt(n),Cs(r),Qa.pop()}}else try{t.f&=-65537,Zf(t),e=$s(t)}finally{xt(n)}return e}function Ya(t){var e=Po(t);if(!t.equals(e)&&(t.wv=zr(),(!be?.is_fork||t.deps===null)&&(be!==null?(be.capture(t,e,!0),Fi?.capture(t,e,!0)):t.v=e,t.deps===null))){Oe(t,1024);return}xn||(Nt!==null?(Di()||be?.is_fork)&&Nt.set(t,e):Or(t))}function ec(t){if(t.effects!==null)for(let e of t.effects)(e.teardown||e.ac)&&(e.teardown?.(),e.ac!==null&&ii(()=>{e.ac.abort(vi),e.ac=null}),e.fn!==null&&(e.teardown=ht),ar(e,0),jo(e))}function Ja(t){if(t.effects!==null)for(let e of t.effects)e.teardown&&e.fn!==null&&ri(e)}var Ds=null,Wr=null,be=null,Fi=null,Nt=null,Xa=null,nr=!1,qa=!1,lr=null,Uo=null,nc=0,Ka=new Set,Eh=1,gn=class t{id=Eh++;#e=!1;linked=!0;#t=null;#n=null;async_deriveds=new Map;current=new Map;previous=new Map;#l=new Set;#o=new Set;#s=0;#i=new Map;#a=null;#r=[];#m=[];#f=new Set;#c=new Set;#u=new Map;#g=new Set;is_fork=!1;#d=!1;constructor(){Wr===null?Ds=Wr=this:(Wr.#n=this,this.#t=Wr),Wr=this}#b(){if(this.is_fork)return!0;for(let i of this.#i.keys()){for(var e=i,n=!1;e.parent!==null;){if(this.#u.has(e)){n=!0;break}e=e.parent}if(!n)return!0}return!1}skip_effect(e){this.#u.has(e)||this.#u.set(e,{d:[],m:[]}),this.#g.delete(e)}unskip_effect(e,n=i=>this.schedule(i)){var i=this.#u.get(e);if(i){this.#u.delete(e);for(var r of i.d)Oe(r,2048),n(r);for(r of i.m)Oe(r,4096),n(r)}this.#g.add(e)}#v(){if(this.#e=!0,nc++>1e3&&(this.#h(),Ah()),F)for(let d of this.current.keys())Ka.add(d);for(let d of this.#f)this.#c.delete(d),Oe(d,2048),this.schedule(d);for(let d of this.#c)Oe(d,4096),this.schedule(d);let e=this.#r;this.#r=[],this.apply();var n=lr=[],i=[],r=Uo=[];for(let d of e)try{this.#w(d,n,i)}catch(u){throw sc(d),this.#b()||this.discard(),u}if(be=null,r.length>0){var o=t.ensure();for(let d of r)o.schedule(d)}if(lr=null,Uo=null,this.#b()){this.#p(i),this.#p(n);for(let[d,u]of this.#u)oc(d,u);r.length>0&&be.#v();return}let s=this.#x();if(s){this.#p(i),this.#p(n),s.#y(this);return}this.#f.clear(),this.#c.clear();for(let d of this.#l)d(this);this.#l.clear(),Fi=this,ic(i),ic(n),Fi=null,this.#a?.resolve();var l=be;if(this.#s===0&&(this.#r.length===0||l!==null)&&(this.#h(),gt&&(this.#_(),be=l)),this.#r.length>0)if(l!==null){let d=l;d.#r.push(...this.#r.filter(u=>!d.#r.includes(u)))}else l=this;l!==null&&(En.clear(),l.#v())}#w(e,n,i){e.f^=1024;for(var r=e.first;r!==null;){var o=r.f,s=(o&96)!==0,l=s&&(o&1024)!==0,d=l||(o&8192)!==0||this.#u.has(r);if(!d&&r.fn!==null){s?r.f^=1024:(o&4)!==0?n.push(r):gt&&(o&16777224)!==0?i.push(r):Mi(r)&&((o&16)!==0&&this.#c.add(r),ri(r));var u=r.first;if(u!==null){r=u;continue}}for(;r!==null;){var c=r.next;if(c!==null){r=c;break}r=r.parent}}}#x(){for(var e=this.#t;e!==null;){if(!e.is_fork){for(let[n,[,i]]of this.current)if(e.current.has(n)&&!i)return e}e=e.#t}return null}#y(e){for(let[i,r]of e.current)!this.previous.has(i)&&e.previous.has(i)&&this.previous.set(i,e.previous.get(i)),this.current.set(i,r);for(let[i,r]of e.async_deriveds){let o=this.async_deriveds.get(i);o&&r.promise.then(o.resolve).catch(o.reject)}e.async_deriveds.clear(),this.transfer_effects(e.#f,e.#c);let n=i=>{var r=i.reactions;if(r!==null&&!((i.f&2)!==0&&(i.f&6144)===0))for(let l of r){var o=l.f;if((o&2)!==0)n(l);else{var s=l;o&4194320&&!this.async_deriveds.has(s)&&(this.#c.delete(s),Oe(s,2048),this.schedule(s))}}};for(let i of this.current.keys())n(i);this.oncommit(()=>e.discard()),e.#h(),be=this,this.#v()}#p(e){for(var n=0;n<e.length;n+=1)Ss(e[n],this.#f,this.#c)}capture(e,n,i=!1){e.v!==Ue&&!this.previous.has(e)&&this.previous.set(e,e.v),(e.f&8388608)===0&&(this.current.set(e,[n,i]),Nt?.set(e,n)),this.is_fork||(e.v=n)}activate(){be=this}deactivate(){be=null,Nt=null}flush(){try{F&&Ka.clear(),qa=!0,be=this,this.#v()}finally{if(nc=0,Xa=null,lr=null,Uo=null,qa=!1,be=null,Nt=null,En.clear(),F)for(let e of Ka)e.updated=null}}discard(){for(let e of this.#o)e(this);this.#o.clear();for(let e of this.async_deriveds.values())e.reject(Gr);this.#h(),this.#a?.resolve()}register_created_effect(e){this.#m.push(e)}#_(){for(let f=Ds;f!==null;f=f.#n){var e=f.id<this.id,n=[];for(let[p,[g,v]]of this.current){if(f.current.has(p)){var i=f.current.get(p)[0];if(e&&g!==i)f.current.set(p,[g,v]);else continue}n.push(p)}if(e)for(let[p,g]of this.async_deriveds){let v=f.async_deriveds.get(p);v&&g.promise.then(v.resolve).catch(v.reject)}var r=[...f.current.keys()].filter(p=>!f.current.get(p)[1]);if(!(!f.#e||r.length===0)){var o=r.filter(p=>!this.current.has(p));if(o.length===0)e&&f.discard();else if(n.length>0){if(F&&!f.#d&&Vf(f.#r.length===0,"Batch has scheduled roots"),e)for(let p of this.#g)f.unskip_effect(p,g=>{(g.f&4194320)!==0?f.schedule(g):f.#p([g])});f.activate();var s=new Set,l=new Map;for(var d of n)rc(d,o,s,l);l=new Map;var u=[...f.current].filter(([p,g])=>{let v=this.current.get(p);return v?v[0]!==g[0]||v[1]!==g[1]:!0}).map(([p])=>p);if(u.length>0)for(let p of this.#m)(p.f&155648)===0&&Za(p,u,l)&&((p.f&4194320)!==0?(Oe(p,2048),f.schedule(p)):f.#f.add(p));if(f.#r.length>0&&!f.#d){f.apply();for(var c of f.#r)f.#w(c,[],[]);f.#r=[]}f.deactivate()}}}}increment(e,n){if(this.#s+=1,e){let i=this.#i.get(n)??0;this.#i.set(n,i+1)}}decrement(e,n){if(this.#s-=1,e){let i=this.#i.get(n)??0;i===1?this.#i.delete(n):this.#i.set(n,i-1)}this.#d||(this.#d=!0,It(()=>{this.#d=!1,this.linked&&this.flush()}))}transfer_effects(e,n){for(let i of e)this.#f.add(i);for(let i of n)this.#c.add(i);e.clear(),n.clear()}oncommit(e){this.#l.add(e)}ondiscard(e){this.#o.add(e)}settled(){return(this.#a??=gs()).promise}static ensure(){if(be===null){let e=be=new t;!qa&&!nr&&It(()=>{e.#e||e.flush()})}return be}apply(){if(!gt||!this.is_fork&&this.#t===null&&this.#n===null){Nt=null;return}Nt=new Map;for(let[n,[i]]of this.current)Nt.set(n,i);for(let n=Ds;n!==null;n=n.#n)if(!(n===this||n.is_fork)){var e=!1;if(n.id<this.id){for(let[i,[,r]]of n.current)if(!r&&this.current.has(i)){e=!0;break}}if(!e)for(let[i,r]of n.previous)Nt.has(i)||Nt.set(i,r)}}schedule(e){if(Xa=e,e.b?.is_pending&&(e.f&16777228)!==0&&(e.f&32768)===0){e.b.defer_effect(e);return}for(var n=e;n.parent!==null;){n=n.parent;var i=n.f;if(lr!==null&&n===se&&(gt||(ge===null||(ge.f&2)===0)&&!qf))return;if((i&96)!==0){if((i&1024)===0)return;n.f^=1024}}this.#r.push(n)}#h(){if(this.linked){var e=this.#t,n=this.#n;e===null?Ds=n:e.#n=n,n===null?Wr=e:n.#t=e,this.linked=!1}}};function Qr(t){var e=nr;nr=!0;try{var n;for(t&&(be!==null&&!be.is_fork&&be.flush(),n=t());;){if(Yf(),be===null)return n;be.flush()}}finally{nr=e}}function Ah(){if(F){var t=new Map;for(let n of be.current.keys())for(let[i,r]of n.updated??[]){var e=t.get(i);e||(e={error:r.error,count:0},t.set(i,e)),e.count+=r.count}for(let n of t.values())n.error&&console.error(n.error)}try{Ff()}catch(n){F&&At(n,"stack",{value:""}),rn(n,Xa)}}var yn=null;function ic(t){var e=t.length;if(e!==0){for(var n=0;n<e;){var i=t[n++];if((i.f&24576)===0&&Mi(i)&&(yn=new Set,ri(i),i.deps===null&&i.first===null&&i.nodes===null&&i.teardown===null&&i.ac===null&&el(i),yn?.size>0)){En.clear();for(let r of yn){if((r.f&24576)!==0)continue;let o=[r],s=r.parent;for(;s!==null;)yn.has(s)&&(yn.delete(s),o.push(s)),s=s.parent;for(let l=o.length-1;l>=0;l--){let d=o[l];(d.f&24576)===0&&ri(d)}}yn.clear()}}yn=null}}function rc(t,e,n,i){if(!n.has(t)&&(n.add(t),t.reactions!==null))for(let r of t.reactions){let o=r.f;(o&2)!==0?rc(r,e,n,i):(o&4194320)!==0&&(o&2048)===0&&Za(r,e,i)&&(Oe(r,2048),Go(r))}}function Za(t,e,n){let i=n.get(t);if(i!==void 0)return i;if(t.deps!==null)for(let r of t.deps){if($i.call(e,r))return!0;if((r.f&2)!==0&&Za(r,e,n))return n.set(r,!0),!0}return n.set(t,!1),!1}function Go(t){be.schedule(t)}function oc(t,e){if(!((t.f&32)!==0&&(t.f&1024)!==0)){(t.f&2048)!==0?e.d.push(t):(t.f&4096)!==0&&e.m.push(t),Oe(t,1024);for(var n=t.first;n!==null;)oc(n,e),n=n.next}}function sc(t){Oe(t,1024);for(var e=t.first;e!==null;)sc(e),e=e.next}var sr=new Set,En=new Map;function Cs(t){sr=t}var tl=!1;function lc(){tl=!0}function Vt(t,e){var n={f:0,v:t,reactions:null,equals:ys,rv:0,wv:0};return F&&Hn&&(n.created=e??Bn("created at"),n.updated=null,n.set_during_effect=!1,n.trace=null),n}function ce(t,e){let n=Vt(t,e);return Ts(n),n}function ir(t,e=!1,n=!0){let i=Vt(t);return e||(i.equals=Es),wi&&n&&Ae!==null&&Ae.l!==null&&(Ae.l.s??=[]).push(i),i}function ne(t,e,n=!1){ge!==null&&(!Jt||(ge.f&131072)!==0)&&ni()&&(ge.f&4325394)!==0&&(jn===null||!jn.has(t))&&Uf();let i=n?Ee(e):e;return F&&Ls(i,t.label),Pn(t,i,Uo)}function Pn(t,e,n=null){if(!t.equals(e)){xn?En.set(t,e):En.has(t)||En.set(t,t.v);var i=gn.ensure();if(i.capture(t,e),F){if(Hn||se!==null){t.updated??=new Map;let r=(t.updated.get("")?.count??0)+1;if(t.updated.set("",{error:null,count:r}),Hn||r>5){let o=Bn("updated at");if(o!==null){let s=t.updated.get(o.stack);s||(s={error:o,count:0},t.updated.set(o.stack,s)),s.count++}}}se!==null&&(t.set_during_effect=!0)}if((t.f&2)!==0){let r=t;(t.f&2048)!==0&&Po(r),Nt===null&&Or(r)}t.wv=zr(),dc(t,2048,n),ni()&&se!==null&&(se.f&1024)!==0&&(se.f&96)===0&&(vn===null?fc([t]):vn.push(t)),!i.is_fork&&sr.size>0&&!tl&&Fs()}return e}function Fs(){tl=!1;for(let t of sr){(t.f&1024)!==0&&Oe(t,4096);let e;try{e=Mi(t)}catch{e=!0}e&&ri(t)}sr.clear()}function fr(t){ne(t,t.v+1)}function dc(t,e,n){var i=t.reactions;if(i!==null)for(var r=ni(),o=i.length,s=0;s<o;s++){var l=i[s],d=l.f;if(!(!r&&l===se)){var u=(d&2048)===0;if(u&&Oe(l,e),(d&131072)!==0)sr.add(l);else if((d&2)!==0){var c=l;Nt?.delete(c),(d&65536)===0&&(d&512&&(se===null||(se.f&2097152)===0)&&(l.f|=65536),dc(c,4096,n))}else if(u){var f=l;(d&16)!==0&&yn!==null&&yn.add(f),n!==null?n.push(f):Go(f)}}}}var kh=/^[a-zA-Z_$][a-zA-Z_$0-9]*$/;function Ee(t){if(typeof t!="object"||t===null||pn in t||vs in t)return t;let e=Dr(t);if(e!==Ha&&e!==vf)return t;var n=new Map,i=gi(t),r=ce(0),o=F&&Hn?Bn("created at"):null,s=Hi,l=f=>{if(Hi===s)return f();var p=ge,g=Hi;wt(null),nl(s);var v=f();return wt(p),nl(g),v};i&&(n.set("length",ce(t.length,o)),F&&(t=Sh(t)));var d="";let u=!1;function c(f){if(!u){u=!0,d=f,Ut(r,`${d} version`);for(let[p,g]of n)Ut(g,cr(d,p));u=!1}}return new Proxy(t,{defineProperty(f,p,g){(!("value"in g)||g.configurable===!1||g.enumerable===!1||g.writable===!1)&&Pf();var v=n.get(p);return v===void 0?l(()=>{var y=ce(g.value,o);return n.set(p,y),F&&typeof p=="string"&&Ut(y,cr(d,p)),y}):ne(v,g.value,!0),!0},deleteProperty(f,p){var g=n.get(p);if(g===void 0){if(p in f){let v=l(()=>ce(Ue,o));n.set(p,v),fr(r),F&&Ut(v,cr(d,p))}}else ne(g,Ue),fr(r);return!0},get(f,p,g){if(p===pn)return t;if(F&&p===bs)return c;var v=n.get(p),y=p in f;if(v===void 0&&(!y||un(f,p)?.writable)&&(v=l(()=>{var b=Ee(y?f[p]:Ue),E=ce(b,o);return F&&Ut(E,cr(d,p)),E}),n.set(p,v)),v!==void 0){var w=a(v);return w===Ue?void 0:w}return Reflect.get(f,p,g)},getOwnPropertyDescriptor(f,p){var g=Reflect.getOwnPropertyDescriptor(f,p);if(g&&"value"in g){var v=n.get(p);v&&(g.value=a(v))}else if(g===void 0){var y=n.get(p),w=y?.v;if(y!==void 0&&w!==Ue)return{enumerable:!0,configurable:!0,value:w,writable:!0}}return g},has(f,p){if(p===pn)return!0;var g=n.get(p),v=g!==void 0&&g.v!==Ue||Reflect.has(f,p);if(g!==void 0||se!==null&&(!v||un(f,p)?.writable)){g===void 0&&(g=l(()=>{var w=v?Ee(f[p]):Ue,b=ce(w,o);return F&&Ut(b,cr(d,p)),b}),n.set(p,g));var y=a(g);if(y===Ue)return!1}return v},set(f,p,g,v){var y=n.get(p),w=p in f;if(i&&p==="length")for(var b=g;b<y.v;b+=1){var E=n.get(b+"");E!==void 0?ne(E,Ue):b in f&&(E=l(()=>ce(Ue,o)),n.set(b+"",E),F&&Ut(E,cr(d,b)))}if(y===void 0)(!w||un(f,p)?.writable)&&(y=l(()=>ce(void 0,o)),F&&Ut(y,cr(d,p)),ne(y,Ee(g)),n.set(p,y));else{w=y.v!==Ue;var x=l(()=>Ee(g));ne(y,x)}var S=Reflect.getOwnPropertyDescriptor(f,p);if(S?.set&&S.set.call(v,g),!w){if(i&&typeof p=="string"){var k=n.get("length"),h=Number(p);Number.isInteger(h)&&h>=k.v&&ne(k,h+1)}fr(r)}return!0},ownKeys(f){a(r);var p=Reflect.ownKeys(f).filter(y=>{var w=n.get(y);return w===void 0||w.v!==Ue});for(var[g,v]of n)v.v!==Ue&&!(g in f)&&p.push(g);return p},setPrototypeOf(){jf()}})}function cr(t,e){return typeof e=="symbol"?`${t}[Symbol(${e.description??""})]`:kh.test(e)?`${t}.${e}`:/^\d+$/.test(e)?`${t}[${e}]`:`${t}['${e}']`}function Ms(t){try{if(t!==null&&typeof t=="object"&&pn in t)return t[pn]}catch{}return t}var Ih=new Set(["copyWithin","fill","pop","push","reverse","shift","sort","splice","unshift"]);function Sh(t){return new Proxy(t,{get(e,n,i){var r=Reflect.get(e,n,i);return Ih.has(n)?function(...o){lc();var s=r.apply(this,o);return Fs(),s}:r}})}function cc(){let t=Array.prototype,e=Array.__svelte_cleanup;e&&e();let{indexOf:n,lastIndexOf:i,includes:r}=t;t.indexOf=function(o,s){let l=n.call(this,o,s);if(l===-1){for(let d=s??0;d<this.length;d+=1)if(Ms(this[d])===o){xs("array.indexOf(...)");break}}return l},t.lastIndexOf=function(o,s){let l=i.call(this,o,s??this.length-1);if(l===-1){for(let d=0;d<=(s??this.length-1);d+=1)if(Ms(this[d])===o){xs("array.lastIndexOf(...)");break}}return l},t.includes=function(o,s){let l=r.call(this,o,s);if(!l){for(let d=0;d<this.length;d+=1)if(Ms(this[d])===o){xs("array.includes(...)");break}}return l},Array.__svelte_cleanup=()=>{t.indexOf=n,t.lastIndexOf=i,t.includes=r}}var il,uc,zo,pc,hc;function Hs(){if(il===void 0){il=window,uc=document,zo=/Firefox/.test(navigator.userAgent);var t=Element.prototype,e=Node.prototype,n=Text.prototype;pc=un(e,"firstChild").get,hc=un(e,"nextSibling").get,Ba(t)&&(t[$o]=void 0,t[ws]=null,t[To]=void 0,t.__e=void 0),Ba(n)&&(n[Do]=void 0),F&&(t.__svelte_meta=null,cc())}}function dt(t=""){return document.createTextNode(t)}function ze(t){return pc.call(t)}function kt(t){return hc.call(t)}function D(t,e){if(!le)return ze(t);var n=ze(_e);if(n===null)n=_e.appendChild(dt());else if(e&&n.nodeType!==Fr){var i=dt();return n?.before(i),Be(i),i}return e&&Rs(n),Be(n),n}function te(t,e=!1){if(!le){var n=ze(t);return n instanceof Comment&&n.data===""?kt(n):n}if(e){if(_e?.nodeType!==Fr){var i=dt();return _e?.before(i),Be(i),i}Rs(_e)}return _e}function Le(t,e=!1){if(!le)return ze(t);var n=D(t,e);return T(t),n}function J(t,e=1,n=!1){let i=le?_e:t;for(var r;e--;)r=i,i=kt(i);if(!le)return i;if(n){if(i?.nodeType!==Fr){var o=dt();return i===null?r?.after(o):i.before(o),Be(o),o}Rs(i)}return Be(i),i}function Ro(t){t.textContent=""}function Bs(){if(!gt||yn!==null)return!1;var t=se.f;return(t&32768)!==0}function Un(t,e,n){return e==null||e===hs?n?document.createElement(t,{is:n}):document.createElement(t):n?document.createElementNS(e,t,{is:n}):document.createElementNS(e,t)}function Rs(t){if(t.nodeValue.length<65536)return;let e=t.nextSibling;for(;e!==null&&e.nodeType===Fr;)e.remove(),t.nodeValue+=e.nodeValue,e=t.nextSibling}var rl=new WeakMap;function mc(t){var e=se;if(e===null)return ge.f|=8388608,t;if(F&&t instanceof Error&&!rl.has(t)&&rl.set(t,Nh(t,e)),(e.f&32768)===0&&(e.f&4)===0)throw F&&!e.parent&&t instanceof Error&&gc(t),t;rn(t,e)}function rn(t,e){if(!(e!==null&&(e.f&16384)!==0)){for(;e!==null;){if((e.f&128)!==0&&(e.f&33570816)===0){if((e.f&32768)===0)throw t;try{e.b.error(t);return}catch(n){t=n}}e=e.parent}throw F&&t instanceof Error&&gc(t),t}}function Nh(t,e){let n=un(t,"message");if(!(n&&!n.configurable)){for(var i=zo?"  ":"	",r=`
...
`)}}}function gc(t){let e=rl.get(t);e&&(At(t,"message",{value:e.message}),At(t,"stack",{value:e.stack}))}function _c(t){se===null&&(ge===null&&Df(t),Tf()),xn&&$f(t)}function $h(t,e){var n=e.last;n===null?e.last=e.first=t:(n.next=t,t.prev=n,e.last=t)}function Gn(t,e){var n=se;if(F)for(;n!==null&&(n.f&131072)!==0;)n=n.parent;n!==null&&(n.f&8192)!==0&&(t|=8192);var i={ctx:Ae,deps:null,nodes:null,f:t|2048|512,first:null,fn:e,last:null,next:null,parent:n,b:n&&n.b,prev:null,teardown:null,wv:0,ac:null};F&&(i.component_function=mn),be?.register_created_effect(i);var r=i;if((t&4)!==0)lr!==null?lr.push(i):gn.ensure().schedule(i);else if(e!==null){try{ri(i)}catch(s){throw tt(i),s}r.deps===null&&r.teardown===null&&r.nodes===null&&r.first===r.last&&(r.f&524288)===0&&(r=r.first,(t&16)!==0&&(t&65536)!==0&&r!==null&&(r.f|=65536))}if(r!==null&&(r.parent=n,n!==null&&$h(r,n),ge!==null&&(ge.f&2)!==0&&(t&64)===0)){var o=ge;(o.effects??=[]).push(r)}return i}function Di(){return ge!==null&&!Jt}function zt(t){let e=Gn(8,null);return Oe(e,1024),e.teardown=t,e}function ye(t){_c("$effect"),F&&At(t,"name",{value:"$effect"});var e=se.f,n=!ge&&(e&32)!==0&&Ae!==null&&!Ae.i;if(n){var i=Ae;(i.e??=[]).push(t)}else return Ga(t)}function Ga(t){return Gn(1048580,t)}function al(t){gn.ensure();let e=Gn(524352,t);return()=>{tt(e)}}function bc(t){gn.ensure();let e=Gn(524352,t);return(n={})=>new Promise(i=>{n.outro?oi(e,()=>{tt(e),i(void 0)}):(tt(e),i(void 0))})}function An(t){return Gn(4,t)}function tc(t){return Gn(4718592,t)}function qt(t,e=0){return Gn(8|e,t)}function K(t,e=[],n=[],i=[]){Ns(i,e,n,r=>{Gn(8,()=>{t(...r.map(a))})})}function ln(t,e=0){var n=Gn(16|e,t);return F&&(n.dev_stack=Rn),n}function ll(t,e=0){var n=Gn(16777216|e,t);return F&&(n.dev_stack=Rn),n}function ft(t){return Gn(524320,t)}function dl(t){var e=t.teardown;if(e!==null){let n=xn,i=ge;ol(!0),wt(null);try{e.call(null)}catch(r){rn(r,t.parent)}finally{ol(n),wt(i)}}}function jo(t,e=!1){var n=t.first;for(t.first=t.last=null;n!==null;){let r=n.ac;r!==null&&ii(()=>{r.abort(vi)});var i=n.next;(n.f&64)!==0?n.parent=null:tt(n,e),n=i}}function wc(t){for(var e=t.first;e!==null;){var n=e.next;(e.f&32)===0&&tt(e),e=n}}function tt(t,e=!0){var n=!1;(e||(t.f&262144)!==0)&&t.nodes!==null&&t.nodes.end!==null&&(fl(t.nodes.start,t.nodes.end),n=!0),t.f|=33554432,jo(t,e&&!n),ar(t,0);var i=t.nodes&&t.nodes.t;if(i!==null)for(let o of i)o.stop();dl(t),t.f^=33554432,t.f|=16384;var r=t.parent;r!==null&&r.first!==null&&el(t),F&&(t.component_function=null),t.next=t.prev=t.teardown=t.ctx=t.deps=t.fn=t.nodes=t.ac=t.b=null}function fl(t,e){for(;t!==null;){var n=t===e?null:kt(t);t.remove(),t=n}}function el(t){var e=t.parent,n=t.prev,i=t.next;n!==null&&(n.next=i),i!==null&&(i.prev=n),e!==null&&(e.first===t&&(e.first=i),e.last===t&&(e.last=n))}function oi(t,e,n=!0){var i=[];t.f|=256,xc(t,i,!0);var r=()=>{n&&tt(t),e&&e()},o=i.length;if(o>0){var s=()=>--o||r();for(var l of i)l.out(s)}else r()}function xc(t,e,n){if((t.f&8192)===0){t.f^=8192;var i=t.nodes&&t.nodes.t;if(i!==null)for(let l of i)(l.is_global||n)&&e.push(l);for(var r=t.first;r!==null;){var o=r.next;if((r.f&64)===0){var s=(r.f&65536)!==0||(r.f&32)!==0&&(t.f&16)!==0;xc(r,e,s?n:!1)}r=o}}}function Jr(t){t.f&=-257,yc(t,!0)}function yc(t,e){if((t.f&256)===0&&(t.f&8192)!==0){t.f^=8192,(t.f&1024)===0&&(Oe(t,2048),gn.ensure().schedule(t));for(var n=t.first;n!==null;){var i=n.next,r=(n.f&65536)!==0||(n.f&32)!==0;yc(n,r?e:!1),n=i}var o=t.nodes&&t.nodes.t;if(o!==null)for(let s of o)(s.is_global||e)&&s.in()}}function qr(t,e){if(t.nodes)for(var n=t.nodes.start,i=t.nodes.end;n!==null;){var r=n===i?null:kt(n);e.append(n),n=r}}var Ec=null;var Os=!1,xn=!1;function ol(t){xn=t}var ge=null,Jt=!1;function wt(t){ge=t}var se=null;function xt(t){se=t}var jn=null;function Ts(t){ge!==null&&(!gt||(ge.f&2)!==0)&&(jn??=new Set).add(t)}var St=null,Yt=0,vn=null;function fc(t){vn=t}var Lc=1,ur=0,Hi=ur;function nl(t){Hi=t}function zr(){return++Lc}function Mi(t){var e=t.f;if((e&2048)!==0)return!0;if(e&2&&(t.f&=-65537),(e&4096)!==0){for(var n=t.deps,i=n.length,r=0;r<i;r++){var o=n[r];if(Mi(o)&&Ya(o),o.wv>t.wv)return!0}(e&512)!==0&&Nt===null&&Oe(t,1024)}return!1}function kc(t,e,n=!0){var i=t.reactions;if(i!==null&&!(!gt&&jn!==null&&jn.has(t)))for(var r=0;r<i.length;r++){var o=i[r];(o.f&2)!==0?kc(o,e,!1):e===o&&(n?Oe(o,2048):(o.f&1024)!==0&&Oe(o,4096),Go(o))}}function $s(t){var e=St,n=Yt,i=vn,r=ge,o=jn,s=Ae,l=Jt,d=Hi,u=t.f;St=null,Yt=0,vn=null,ge=(u&96)===0?t:null,jn=null,xi(t.ctx),Jt=!1,Hi=++ur,t.ac!==null&&(ii(()=>{t.ac.abort(vi)}),t.ac=null);try{t.f|=2097152;var c=t.fn,f=c();t.f|=32768;var p=Ac(t);if(ni()&&vn!==null&&!Jt&&p!==null&&(t.f&6146)===0)for(var g=0;g<vn.length;g++)kc(vn[g],t);if(r!==null&&r!==t){if(ur++,r.deps!==null)for(let v=0;v<n;v+=1)r.deps[v].rv=ur;if(e!==null)for(let v of e)v.rv=ur;vn!==null&&(i===null?i=vn:i.push(...vn))}return(t.f&8388608)!==0&&(t.f^=8388608),f}catch(v){return Ac(t),mc(v)}finally{t.f^=2097152,St=e,Yt=n,vn=i,ge=r,jn=o,xi(s),Jt=l,Hi=d}}function Ac(t){var e=t.deps,n=be?.is_fork;if(St!==null){var i;if(n||ar(t,Yt),e!==null&&Yt>0)for(e.length=Yt+St.length,i=0;i<St.length;i++)e[Yt+i]=St[i];else t.deps=e=St;if(Di()&&(t.f&512)!==0)for(i=Yt;i<e.length;i++)(e[i].reactions??=[]).push(t)}else!n&&e!==null&&Yt<e.length&&(ar(t,Yt),e.length=Yt);return e}function Th(t,e){let n=e.reactions;if(n!==null){var i=gf.call(n,t);if(i!==-1){var r=n.length-1;r===0?n=e.reactions=null:(n[i]=n[r],n.pop())}}if(n===null&&(e.f&2)!==0&&(St===null||!$i.call(St,e))){var o=e;(o.f&512)!==0&&(o.f^=512,o.f&=-65537),o.v!==Ue&&Or(o),o.ac!==null&&ii(()=>{o.ac.abort(vi),o.ac=null,Oe(o,2048)}),ec(o),ar(o,0)}}function ar(t,e){var n=t.deps;if(n!==null)for(var i=e;i<n.length;i++)Th(t,n[i])}function ri(t){var e=t.f;if((e&16384)===0){Oe(t,1024);var n=se,i=Os;if(se=t,Os=(e&96)===0,F){var r=mn;ks(t.component_function);var o=Rn;Rr(t.dev_stack??Rn)}try{(e&16777232)!==0?wc(t):jo(t),dl(t);var s=$s(t);if(t.teardown=typeof s=="function"?s:null,t.wv=Lc,F&&Hn&&(t.f&2048)!==0&&t.deps!==null)for(var l of t.deps)l.set_during_effect&&(l.wv=zr(),l.set_during_effect=!1)}finally{Os=i,se=n,F&&(ks(r),Rr(o))}}}function a(t){var e=t.f,n=(e&2)!==0;if(Ec?.add(t),ge!==null&&!Jt){var i=se!==null&&(se.f&16384)!==0;if(!i&&(jn===null||!jn.has(t))){var r=ge.deps;if((ge.f&2097152)!==0)t.rv<ur&&(t.rv=ur,St===null&&r!==null&&r[Yt]===t?Yt++:St===null?St=[t]:St.push(t));else{ge.deps??=[],$i.call(ge.deps,t)||ge.deps.push(t);var o=t.reactions;o===null?t.reactions=[ge]:$i.call(o,ge)||o.push(ge)}}}if(F){if(!Jt&&on&&be===null&&Fi===null&&!on.warned&&(on.effect.f&2097152)===0&&!on.effect_deps.has(t)){on.warned=!0,bf(t.label);var s=Bn("traced at");s&&console.warn(s)}if(Oo.delete(t),Hn&&!Jt&&Ho!==null&&ge!==null&&Ho.reaction===ge){if(t.trace)t.trace();else if(s=Bn("traced at"),s){var l=Ho.entries.get(t);l===void 0&&(l={traces:[]},Ho.entries.set(t,l));var d=l.traces[l.traces.length-1];s.stack!==d?.stack&&l.traces.push(s)}}}if(xn&&En.has(t))return En.get(t);if(n){var u=t;if(xn){var c=u.v;return((u.f&1024)===0&&u.reactions!==null||Sc(u))&&(c=Po(u)),En.set(u,c),c}var f=(u.f&512)===0&&!Jt&&ge!==null&&(Os||(ge.f&512)!==0),p=(u.f&32768)===0;Mi(u)&&(f&&(u.f|=512),Ya(u)),f&&!p&&(Ja(u),Ic(u))}if(Nt?.has(t))return Nt.get(t);if((t.f&8388608)!==0)throw t.v;return t.v}function Ic(t){if(t.f|=512,t.deps!==null)for(let e of t.deps)(e.reactions??=[]).push(t),(e.f&2)!==0&&(e.f&512)===0&&(Ja(e),Ic(e))}function Sc(t){if(t.v===Ue)return!0;if(t.deps===null)return!1;for(let e of t.deps)if(En.has(e)||(e.f&2)!==0&&Sc(e))return!0;return!1}function Ze(t){var e=Jt;try{return Jt=!0,t()}finally{Jt=e}}var Wo=Symbol("events"),pl=new Set,Ps=new Set;function we(t,e,n){(e[Wo]??={})[t]=n}function ot(t){for(var e=0;e<t.length;e++)pl.add(t[e]);for(var n of Ps)n(t)}var cl=null,ul=!1;function hl(t){var e=this,n=e.ownerDocument,i=t.type,r=t.composedPath?.()||[],o=r[0]||t.target;cl=t,ul||(ul=!0,setTimeout(()=>{ul=!1,cl=null}));var s=0,l=cl===t&&t[Wo];if(l){var d=r.indexOf(l);if(d!==-1&&(e===document||e===window)){t[Wo]=e;return}var u=r.indexOf(e);if(u===-1)return;d<=u&&(s=d)}if(o=r[s]||t.target,o!==e){At(t,"currentTarget",{configurable:!0,get(){return o||n}});var c=ge,f=se;wt(null),xt(null);try{for(var p,g=[];o!==null&&o!==e;){try{var v=o[Wo]?.[i];v!=null&&(!o.disabled||t.target===o)&&v.call(o,t)}catch(y){p?g.push(y):p=y}if(t.cancelBubble)break;s++,o=s<r.length?r[s]:null}if(p){for(let y of g)queueMicrotask(()=>{throw y});throw p}}finally{t[Wo]=e,delete t.currentTarget,wt(c),xt(f)}}}var Dh=globalThis?.window?.trustedTypes&&globalThis.window.trustedTypes.createPolicy("svelte-trusted-html",{createHTML:t=>t});function Nc(t){return Dh?.createHTML(t)??t}function js(t){var e=Un("template");return e.innerHTML=Nc(t.replaceAll("<!>","<!---->")),e.content}function Ht(t,e){var n=se;n.nodes===null&&(n.nodes={start:t,end:e,a:null,t:null})}function j(t,e){var n=(e&1)!==0,i=(e&2)!==0,r,o=!t.startsWith("<!>");return()=>{if(le)return Ht(_e,null),_e;r===void 0&&(r=js(o?t:"<!>"+t),n||(r=ze(r)));var s=i||zo?document.importNode(r,!0):r.cloneNode(!0);if(n){var l=ze(s),d=s.lastChild;Ht(l,d)}else Ht(s,s);return s}}function Bh(t,e,n="svg"){var i=!t.startsWith("<!>"),r=(e&1)!==0,o=`<${n}>${i?t:"<!>"+t}</${n}>`,s;return()=>{if(le)return Ht(_e,null),_e;if(!s){var l=js(o),d=ze(l);if(r)for(s=document.createDocumentFragment();ze(d);)s.appendChild(ze(d));else s=ze(d)}var u=s.cloneNode(!0);if(r){var c=ze(u),f=u.lastChild;Ht(c,f)}else Ht(u,u);return u}}function Ai(t,e){return Bh(t,e,"svg")}function me(){if(le)return Ht(_e,null),_e;var t=document.createDocumentFragment(),e=document.createComment(""),n=dt();return t.append(e,n),Ht(e,n),t}function C(t,e){if(le){var n=se;((n.f&32768)===0||n.nodes.end===null)&&(n.nodes.end=_e),Lt();return}t!==null&&t.before(e)}var Rh=/\r/g;function $c(t){t=t.replace(Rh,"");let e=5381,n=t.length;for(;n--;)e=(e<<5)-e^t.charCodeAt(n);return(e>>>0).toString(36)}var Oh=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","disabled","formnovalidate","indeterminate","inert","ismap","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","seamless","selected","webkitdirectory","defer","disablepictureinpicture","disableremoteplayback"];var t0=[...Oh,"formNoValidate","isMap","noModule","playsInline","readOnly","value","volume","defaultValue","defaultChecked","srcObject","noValidate","allowFullscreen","disablePictureInPicture","disableRemotePlayback"];var Ph=["touchstart","touchmove"];function Tc(t){return Ph.includes(t)}var jh=["$state","$state.raw","$derived","$derived.by"],n0=[...jh,"$state.eager","$state.snapshot","$props","$props.id","$bindable","$effect","$effect.pre","$effect.tracking","$effect.root","$effect.pending","$inspect","$inspect().with","$inspect.trace","$host"];function Us(t){return t?.replace(/\//g,"/​")}function Dc(t){let e=0,n=Vt(0),i;return F&&Ut(n,"createSubscriber version"),()=>{Di()&&(a(n),qt(()=>(e===0&&(i=Ze(()=>t(()=>fr(n)))),e+=1,()=>{It(()=>{e-=1,e===0&&(i?.(),i=void 0,fr(n))})})))}}var Uh=589824;function gl(t,e,n,i){new ml(t,e,n,i)}var ml=class{parent;is_pending=!1;transform_error;#e;#t=le?_e:null;#n;#l;#o;#s=null;#i=null;#a=null;#r=null;#m=0;#f=0;#c=!1;#u=new Set;#g=new Set;#d=null;#b=Dc(()=>(this.#d=Vt(this.#m),F&&Ut(this.#d,"$effect.pending()"),()=>{this.#d=null}));constructor(e,n,i,r){this.#e=e,this.#n=n,this.#l=o=>{var s=se;s.b=this,s.f|=128,i(o)},this.parent=se.b,this.transform_error=r??this.parent?.transform_error??(o=>o),this.#o=ln(()=>{if(le){let o=this.#t;Lt();let s=o.data==="[!";if(o.data.startsWith("[?")){let d=JSON.parse(o.data.slice("[?".length));this.#w(d)}else s?this.#y():this.#v()}else this.#p()},Uh),le&&(this.#e=_e)}#v(){try{this.#s=ft(()=>this.#l(this.#e))}catch(e){this.error(e)}}#w(e){let n=this.#n.failed,{reset:i,invoke_onerror:r}=this.#x(e);It(r),n&&(this.#a=ft(()=>{n(this.#e,()=>e,()=>i)}))}#x(e){var n=!1,i=!1;let r=()=>{if(n){Lf();return}n=!0,i&&Gf(),this.#a!==null&&oi(this.#a,()=>{this.#a=null}),this.#h(()=>{this.#p()})};return{reset:r,invoke_onerror:()=>{try{i=!0,this.#n.onerror?.(e,r),i=!1}catch(s){rn(s,this.#o&&this.#o.parent)}}}}#y(){let e=this.#n.pending;e&&(this.is_pending=!0,this.#i=ft(()=>e(this.#e)),It(()=>{var n=this.#r=document.createDocumentFragment(),i=dt(),r=!1;if(n.append(i),this.#s=this.#h(()=>{try{return ft(()=>this.#l(i))}catch(o){try{this.error(o),r=!0}catch(s){rn(s,this.#o.parent)}return null}}),this.#s===null){this.#r=null,r&&this.#_(be);return}this.#f===0&&(this.#e.before(n),this.#r=null,oi(this.#i,()=>{this.#i=null}),this.#_(be))}))}#p(){try{if(this.is_pending=this.has_pending_snippet(),this.#f=0,this.#m=0,this.#s=ft(()=>{this.#l(this.#e)}),this.#f>0){var e=this.#r=document.createDocumentFragment();qr(this.#s,e);let n=this.#n.pending;this.#i=ft(()=>n(this.#e))}else this.#_(be)}catch(n){this.error(n)}}#_(e){this.is_pending=!1,e.transfer_effects(this.#u,this.#g)}defer_effect(e){Ss(e,this.#u,this.#g)}is_rendered(){return!this.is_pending&&(!this.parent||this.parent.is_rendered())}has_pending_snippet(){return!!this.#n.pending}#h(e){var n=se,i=ge,r=Ae;xt(this.#o),wt(this.#o),xi(this.#o.ctx);try{return gn.ensure(),e()}finally{xt(n),wt(i),xi(r)}}#E(e,n){if(!this.has_pending_snippet()){this.parent&&this.parent.#E(e,n);return}this.#f+=e,this.#f===0&&(this.#_(n),this.#i&&oi(this.#i,()=>{this.#i=null}),this.#r&&(this.#e.before(this.#r),this.#r=null))}update_pending_count(e,n){this.#E(e,n),this.#m+=e,!(!this.#d||this.#c)&&(this.#c=!0,It(()=>{this.#c=!1,this.#d&&Pn(this.#d,this.#m)}))}get_effect_pending(){return this.#b(),a(this.#d)}error(e){if(!this.#n.onerror&&!this.#n.failed)throw e;be?.is_fork?(this.#s&&be.skip_effect(this.#s),this.#i&&be.skip_effect(this.#i),this.#a&&be.skip_effect(this.#a),be.oncommit(()=>{this.#A(e)})):this.#A(e)}#A(e){this.#s&&(tt(this.#s),this.#s=null),this.#i&&(tt(this.#i),this.#i=null),this.#a&&(tt(this.#a),this.#a=null),le&&(Be(this.#t),er(),Be(ti()));let n=this.#n.failed,i=r=>{let{reset:o,invoke_onerror:s}=this.#x(r);s(),n&&(this.#a=this.#h(()=>{try{return ft(()=>{var l=se;l.b=this,l.f|=128,n(this.#e,()=>r,()=>o)})}catch(l){return rn(l,this.#o.parent),null}}))};It(()=>{var r;try{r=this.transform_error(e)}catch(o){rn(o,this.#o&&this.#o.parent);return}r!==null&&typeof r=="object"&&typeof r.then=="function"?r.then(i,o=>rn(o,this.#o&&this.#o.parent)):i(r)})}};var vl=!0;function $e(t,e){var n=e==null?"":typeof e=="object"?`${e}`:e;n!==(t[Do]??=t.nodeValue)&&(t[Do]=n,t.nodeValue=`${n}`)}function Kr(t,e){return Mc(t,e)}function bl(t,e){Hs(),e.intro=e.intro??!1;let n=e.target,i=le,r=_e;try{for(var o=ze(n);o&&(o.nodeType!==hn||o.data!=="[");)o=kt(o);if(!o)throw ei;mt(!0),Be(o);let s=Mc(t,{...e,anchor:o});return mt(!1),s}catch(s){if(s instanceof Error&&s.message.split(`
`).some(l=>l.startsWith("https://svelte.dev/e/")))throw s;return s!==ei&&console.warn("Failed to hydrate: ",s),e.recover===!1&&Mf(),Hs(),Ro(n),mt(!1),Kr(t,e)}finally{mt(i),Be(r)}}var Gs=new Map;function Mc(t,{target:e,anchor:n,props:i={},events:r,context:o,intro:s=!0,transformError:l}){Hs();var d=void 0,u=bc(()=>{var c=n??e.appendChild(dt());gl(c,{pending:()=>{}},g=>{de({});var v=Ae;if(o&&(v.c=o),r&&(i.$$events=r),le&&Ht(g,null),vl=s,d=t(g,i)||Is(),vl=!0,le&&(se.nodes.end=_e,_e===null||_e.nodeType!==hn||_e.data!=="]"))throw Ti(),ei;fe()},l);var f=new Set,p=g=>{for(var v=0;v<g.length;v++){var y=g[v];if(!f.has(y)){f.add(y);var w=Tc(y);for(let x of[e,document]){var b=Gs.get(x);b===void 0&&(b=new Map,Gs.set(x,b));var E=b.get(y);E===void 0?(x.addEventListener(y,hl,{passive:w}),b.set(y,1)):b.set(y,E+1)}}}};return p(Tr(pl)),Ps.add(p),()=>{for(var g of f)for(let w of[e,document]){var v=Gs.get(w),y=v.get(g);--y==0?(w.removeEventListener(g,hl),v.delete(g),v.size===0&&Gs.delete(w)):v.set(g,y)}Ps.delete(p),c!==n&&c.parentNode?.removeChild(c)}});return _l.set(d,u),d}var _l=new WeakMap;function Vo(t,e){let n=_l.get(t);return n?(_l.delete(t),n(e)):(F&&Af(),Promise.resolve())}var si=class{anchor;#e=new Map;#t=new Map;#n=new Map;#l=new Set;#o=!0;constructor(e,n=!0){this.anchor=e,this.#o=n}#s=e=>{if(this.#e.has(e)){var n=this.#e.get(e),i=this.#t.get(n);if(i)Jr(i),this.#l.delete(n);else{var r=this.#n.get(n);r&&(Jr(r.effect),this.#t.set(n,r.effect),this.#n.delete(n),F&&(r.fragment.lastChild[Ra]=this.anchor),r.fragment.lastChild.remove(),this.anchor.before(r.fragment),i=r.effect)}for(let[o,s]of this.#e){if(this.#e.delete(o),o===e)break;let l=this.#n.get(s);l&&(tt(l.effect),this.#n.delete(s))}for(let[o,s]of this.#t){if(o===n||this.#l.has(o))continue;let l=()=>{if(Array.from(this.#e.values()).includes(o)){var u=document.createDocumentFragment();qr(s,u),u.append(dt()),this.#n.set(o,{effect:s,fragment:u})}else tt(s);this.#l.delete(o),this.#t.delete(o)};this.#o||!i?(this.#l.add(o),oi(s,l,!1)):l()}}};#i=e=>{this.#e.delete(e);let n=Array.from(this.#e.values());for(let[i,r]of this.#n)n.includes(i)||(tt(r.effect),this.#n.delete(i))};ensure(e,n){var i=be,r=Bs();if(n&&!this.#t.has(e)&&!this.#n.has(e))if(r){var o=document.createDocumentFragment(),s=dt();o.append(s),this.#n.set(e,{effect:ft(()=>n(s)),fragment:o})}else this.#t.set(e,ft(()=>n(this.anchor)));if(this.#e.set(i,e),r){for(let[l,d]of this.#t)l===e?i.unskip_effect(d):i.skip_effect(d);for(let[l,d]of this.#n)l===e?i.unskip_effect(d.effect):i.skip_effect(d.effect);i.oncommit(this.#s),i.ondiscard(this.#i)}else le&&(this.anchor=_e),this.#s(i)}};function Bt(t,e,...n){var i=new si(t);ln(()=>{let r=e()??null;F&&r==null&&Hf(),i.ensure(r,r&&(o=>r(o,...n)))},65536)}if(F){let t=function(e){if(!(e in globalThis)){let n;Object.defineProperty(globalThis,e,{configurable:!0,get:()=>{if(n!==void 0)return n;Rf(e)},set:i=>{n=i}})}};t("$state"),t("$effect"),t("$derived"),t("$inspect"),t("$props"),t("$bindable")}function Wh(t){Ae===null&&Br("onMount"),wi&&Ae.l!==null?Vh(Ae).m.push(t):ye(()=>{let e=Ze(t);if(typeof e=="function")return e})}function We(t){Ae===null&&Br("onDestroy"),Wh(()=>()=>Ze(t))}function Vh(t){var e=t.l;return e.u??={a:[],b:[],m:[]}}function Q(t,e,n=!1){var i;le&&(i=_e,Lt());var r=new si(t),o=n?65536:0;function s(l,d){if(le){var u=Mo(i);if(l!==parseInt(u.substring(1))){var c=ti();Be(c),r.anchor=c,mt(!1),r.ensure(l,d),mt(!0);return}}r.ensure(l,d)}ln(()=>{var l=!1;e((d,u=0)=>{l=!0,s(u,d)}),l||s(-1,null)},o)}function li(t,e){return e}function em(t,e,n){for(var i=[],r=e.length,o,s=e.length,l=0;l<r;l++){let f=e[l];oi(f,()=>{if(o){if(o.pending.delete(f),o.done.add(f),o.pending.size===0){var p=t.outrogroups;wl(t,Tr(o.done)),p.delete(o),p.size===0&&(t.outrogroups=null)}}else s-=1},!1)}if(s===0){var d=i.length===0&&n!==null&&t.pending.size===0;if(d){var u=n,c=u.parentNode;Ro(c),c.append(u),t.items.clear()}wl(t,e,!d)}else o={pending:new Set(e),done:new Set},(t.outrogroups??=new Set).add(o)}function wl(t,e,n=!0){var i;if(t.pending.size>0){i=new Set;for(let s of t.pending.values())for(let l of s)i.add(t.items.get(l).e)}for(var r=0;r<e.length;r++){var o=e[r];if(i?.has(o)){o.f|=33554432;let s=document.createDocumentFragment();qr(o,s)}else tt(e[r],n)}}var Rc;function di(t,e,n,i,r,o=null){var s=t,l=new Map,d=(e&4)!==0;if(d){var u=t;s=le?Be(ze(u)):u.appendChild(dt())}le&&Lt();var c=null,f=Ur(()=>{var x=n();return gi(x)?x:x==null?[]:Tr(x)});F&&Ut(f,"{#each ...}");var p,g=new Map,v=!0;function y(x){(E.effect.f&16384)===0&&(E.pending.delete(x),E.fallback=c,tm(E,p,s,e,i),c!==null&&(p.length===0?(c.f&33554432)===0?Jr(c):(c.f^=33554432,Yo(c,null,s)):oi(c,()=>{c=null})))}function w(x){E.pending.delete(x)}var b=ln(()=>{p=a(f);var x=p.length;let S=!1;if(le){var k=Mo(s)==="[!";k!==(x===0)&&(s=ti(),Be(s),mt(!1),S=!0)}for(var h=new Set,m=be,A=Bs(),N=0;N<x;N+=1){le&&_e.nodeType===hn&&_e.data==="]"&&(s=_e,S=!0,mt(!1));var $=p[N],P=i($,N);if(F){var X=i($,N);P!==X&&Cf(String(N),String(P),String(X))}var z=v?null:l.get(P);z?(z.v&&Pn(z.v,$),z.i&&Pn(z.i,N),A&&m.unskip_effect(z.e)):(z=nm(l,v?s:Rc??=dt(),$,P,N,r,e,n),v||(z.e.f|=33554432),l.set(P,z)),h.add(P)}if(x===0&&o&&!c&&(v?c=ft(()=>o(s)):(c=ft(()=>o(Rc??=dt())),c.f|=33554432)),x>h.size&&(F?im(p,i):ja("","","")),le&&x>0&&Be(ti()),!v)if(g.set(m,h),A){for(let[q,Y]of l)h.has(q)||m.skip_effect(Y.e);m.oncommit(y),m.ondiscard(w)}else y(m);S&&mt(!0),a(f)}),E={effect:b,flags:e,items:l,pending:g,outrogroups:null,fallback:c};v=!1,le&&(s=_e)}function Qo(t){for(;t!==null&&(t.f&32)===0;)t=t.next;return t}function tm(t,e,n,i,r){var o=(i&8)!==0,s=e.length,l=t.items,d=Qo(t.effect.first),u,c=null,f,p=[],g=[],v,y,w,b;if(o)for(b=0;b<s;b+=1)v=e[b],y=r(v,b),w=l.get(y).e,(w.f&33554432)===0&&(w.nodes?.a?.measure(),(f??=new Set).add(w));for(b=0;b<s;b+=1){if(v=e[b],y=r(v,b),w=l.get(y).e,t.outrogroups!==null)for(let $ of t.outrogroups)$.pending.delete(w),$.done.delete(w);if((w.f&8192)!==0&&(Jr(w),o&&(w.nodes?.a?.unfix(),(f??=new Set).delete(w))),(w.f&33554432)!==0)if(w.f^=33554432,w===d)Yo(w,null,n);else{var E=c?c.next:d;w===t.effect.last&&(t.effect.last=w.prev),w.prev&&(w.prev.next=w.next),w.next&&(w.next.prev=w.prev),Bi(t,c,w),Bi(t,w,E),Yo(w,E,n),c=w,p=[],g=[],d=Qo(c.next);continue}if(w!==d){if(u!==void 0&&u.has(w)){if(p.length<g.length){var x=g[0],S;c=x.prev;var k=p[0],h=p[p.length-1];for(S=0;S<p.length;S+=1)Yo(p[S],x,n);for(S=0;S<g.length;S+=1)u.delete(g[S]);Bi(t,k.prev,h.next),Bi(t,c,k),Bi(t,h,x),d=x,c=h,b-=1,p=[],g=[]}else u.delete(w),Yo(w,d,n),Bi(t,w.prev,w.next),Bi(t,w,c===null?t.effect.first:c.next),Bi(t,c,w),c=w;continue}for(p=[],g=[];d!==null&&d!==w;)(u??=new Set).add(d),g.push(d),d=Qo(d.next);if(d===null)continue}(w.f&33554432)===0&&p.push(w),c=w,d=Qo(w.next)}if(t.outrogroups!==null){for(let $ of t.outrogroups)$.pending.size===0&&(wl(t,Tr($.done)),t.outrogroups?.delete($));t.outrogroups.size===0&&(t.outrogroups=null)}if(d!==null||u!==void 0){var m=[];if(u!==void 0)for(w of u)(w.f&8192)===0&&m.push(w);for(;d!==null;)(d.f&8192)===0&&d!==t.fallback&&m.push(d),d=Qo(d.next);var A=m.length;if(A>0){var N=(i&4)!==0&&s===0?n:null;if(o){for(b=0;b<A;b+=1)m[b].nodes?.a?.measure();for(b=0;b<A;b+=1)m[b].nodes?.a?.fix()}em(t,m,N)}}o&&It(()=>{if(f!==void 0)for(w of f)w.nodes?.a?.apply()})}function nm(t,e,n,i,r,o,s,l){var d=(s&1)!==0?(s&16)===0?ir(n,!1,!1):Vt(n):null,u=(s&2)!==0?Vt(r):null;return F&&d&&(d.trace=()=>{l()[u?.v??r]}),{v:d,i:u,e:ft(()=>(o(e,d??n,u??r,l),()=>{t.delete(i)}))}}function Yo(t,e,n){if(t.nodes)for(var i=t.nodes.start,r=t.nodes.end,o=e&&(e.f&33554432)===0?e.nodes.start:n;i!==null;){var s=kt(i);if(o.before(i),i===r)return;i=s}}function Bi(t,e,n){e===null?t.effect.first=n:e.next=n,n===null?t.effect.last=e:n.prev=e}function im(t,e){let n=new Map,i=t.length;for(let r=0;r<i;r++){let o=e(t[r],r);if(n.has(o)){let s=String(n.get(o)),l=String(r),d=String(o);d.startsWith("[object ")&&(d=null),ja(s,l,d)}n.set(o,r)}}function rm(t,e,n){if(!e||e===$c(String(n??"")))return;let i,r=t.__svelte_meta?.loc;r?i=`near ${r.file}:${r.line}:${r.column}`:mn?.[tn]&&(i=`in ${mn[tn]}`),Ef(Us(i))}function pr(t,e,n=!1,i=!1,r=!1,o=!1){var s=t,l="";if(n){var d=t;le&&(s=Be(ze(d)))}K(()=>{var u=se;if(l===(l=e()??"")){le&&Lt();return}if(n&&!le){u.nodes=null,d.innerHTML=l,l!==""&&Ht(ze(d),d.lastChild);return}if(u.nodes!==null&&(fl(u.nodes.start,u.nodes.end),u.nodes=null),l!==""){if(le){for(var c=_e.data,f=Lt(),p=f;f!==null&&(f.nodeType!==hn||f.data!=="");)p=f,f=kt(f);if(f===null)throw Ti(),ei;F&&!o&&rm(f.parentNode,c,l),Ht(_e,p),s=Be(f);return}var g=i?Co:r?Da:void 0,v=Un(i?"svg":r?"math":"template",g);v.innerHTML=l;var y=i||r?v:v.content;if(Ht(ze(y),y.lastChild),i||r)for(;ze(y);)s.before(ze(y));else s.before(y)}})}function lt(t,e){var n=void 0,i;ll(()=>{n!==(n=e())&&(i&&(tt(i),i=null),n&&(i=ft(()=>{An(()=>n(t))})))})}function jc(t){var e,n,i="";if(typeof t=="string"||typeof t=="number")i+=t;else if(typeof t=="object")if(Array.isArray(t)){var r=t.length;for(e=0;e<r;e++)t[e]&&(n=jc(t[e]))&&(i&&(i+=" "),i+=n)}else for(n in t)t[n]&&(i&&(i+=" "),i+=n);return i}function Uc(){for(var t,e,n=0,i="",r=arguments.length;n<r;n++)(t=arguments[n])&&(e=jc(t))&&(i&&(i+=" "),i+=e);return i}function dn(t){return typeof t=="object"?Uc(t):t??""}var Gc=[...` 	
\r\f \v\uFEFF`];function Wc(t,e,n){var i=t==null?"":""+t;if(e&&(i=i?i+" "+e:e),n){for(var r of Object.keys(n))if(n[r])i=i?i+" "+r:r;else if(i.length)for(var o=r.length,s=0;(s=i.indexOf(r,s))>=0;){var l=s+o;(s===0||Gc.includes(i[s-1]))&&(l===i.length||Gc.includes(i[l]))?i=(s===0?"":i.substring(0,s))+i.substring(l+1):s=l}}return i===""?null:i}function zc(t,e=!1){var n=e?" !important;":";",i="";for(var r of Object.keys(t)){var o=t[r];o!=null&&o!==""&&(i+=" "+r+": "+o+n)}return i}function xl(t){return t[0]!=="-"||t[1]!=="-"?t.toLowerCase():t}function Vc(t,e){if(e){var n="",i,r;if(Array.isArray(e)?(i=e[0],r=e[1]):i=e,t){t=String(t).replaceAll(/\/\*.*?\*\//g,"").trim();var o=!1,s=0,l=!1,d=[];i&&d.push(...Object.keys(i).map(xl)),r&&d.push(...Object.keys(r).map(xl));var u=0,c=-1;let y=t.length;for(var f=0;f<y;f++){var p=t[f];if(l?p==="/"&&t[f-1]==="*"&&(l=!1):o?o===p&&(o=!1):p==="/"&&t[f+1]==="*"?l=!0:p==='"'||p==="'"?o=p:p==="("?s++:p===")"&&s--,!l&&o===!1&&s===0){if(p===":"&&c===-1)c=f;else if(p===";"||f===y-1){if(c!==-1){var g=xl(t.substring(u,c).trim());if(!d.includes(g)){p!==";"&&f++;var v=t.substring(u,f).trim();n+=" "+v+";"}}u=f+1,c=-1}}}}return i&&(n+=zc(i)),r&&(n+=zc(r,!0)),n=n.trim(),n===""?null:n}return t==null?null:String(t)}function Se(t,e,n,i,r,o){var s=t[$o];if(le||s!==n||s===void 0){var l=Wc(n,i,o);(!le||l!==t.getAttribute("class"))&&(l==null?t.removeAttribute("class"):e?t.className=l:t.setAttribute("class",l)),t[$o]=n}else if(o&&r!==o)for(var d in o){var u=!!o[d];(r==null||u!==!!r[d])&&t.classList.toggle(d,u)}return o}function yl(t,e={},n,i){for(var r in n){var o=n[r];e[r]!==o&&(n[r]==null?t.style.removeProperty(r):t.style.setProperty(r,o,i))}}function V(t,e,n,i){var r=t[To];if(le||r!==e){var o=Vc(e,i);(!le||o!==t.getAttribute("style"))&&(o==null?t.removeAttribute("style"):t.style.cssText=o),t[To]=e}else i&&(Array.isArray(i)?(yl(t,n?.[0],i[0]),yl(t,n?.[1],i[1],"important")):yl(t,n,i));return i}var hm=Symbol("is custom element"),mm=Symbol("is html"),gm=Oa?"link":"LINK";function G(t,e,n,i){var r=vm(t);if(le&&(r[e]=t.getAttribute(e),e==="src"||e==="srcset"||e==="href"&&t.nodeName===gm)){i||bm(t,e,n??"");return}r[e]!==(r[e]=n)&&(e==="loading"&&(t[_f]=n),n==null?t.removeAttribute(e):typeof n!="string"&&_m(t).has(e)?t[e]=n:t.setAttribute(e,n))}function vm(t){return t[ws]??={[hm]:t.nodeName.includes("-"),[mm]:t.namespaceURI===hs}}var Qc=new Map;function _m(t){var e=t.getAttribute("is")||t.nodeName,n=Qc.get(e);if(n)return n;Qc.set(e,n=new Set);for(var i,r=t,o=Element.prototype;o!==r;){i=Ma(r);for(var s in i)i[s].set&&s!=="innerHTML"&&s!=="textContent"&&s!=="innerText"&&n.add(s);r=Dr(r)}return n}function bm(t,e,n){F&&(e==="srcset"&&wm(t,n)||El(t.getAttribute(e)??"",n)||yf(e,t.outerHTML.replace(t.innerHTML,t.innerHTML&&"..."),String(n)))}function El(t,e){return t===e?!0:new URL(t,document.baseURI).href===new URL(e,document.baseURI).href}function Yc(t){return t.split(",").map(e=>e.trim().split(" ").filter(Boolean))}function wm(t,e){var n=Yc(t.srcset),i=Yc(e);return i.length===n.length&&i.every(([r,o],s)=>o===n[s][1]&&(El(n[s][0],r)||El(r,n[s][0])))}var ym={get(t,e){if(!t.exclude.has(e))return t.props[e]},set(t,e){return F&&Bf(`${t.name}.${String(e)}`),!1},getOwnPropertyDescriptor(t,e){if(!t.exclude.has(e)&&e in t.props)return{enumerable:!0,configurable:!0,value:t.props[e]}},has(t,e){return t.exclude.has(e)?!1:e in t.props},ownKeys(t){return Reflect.ownKeys(t.props).filter(e=>!t.exclude.has(e))}};function he(t,e,n){return new Proxy(F?{props:t,exclude:e,name:n}:{props:t,exclude:e},ym)}function Jc(t){return new Ll(t)}var Ll=class{#e;#t;constructor(e){var n=new Map,i=(o,s)=>{var l=ir(s,!1,!1);return n.set(o,l),l};let r=new Proxy({...e.props||{},$$events:{}},{get(o,s){return a(n.get(s)??i(s,Reflect.get(o,s)))},has(o,s){return s===_s?!0:(a(n.get(s)??i(s,Reflect.get(o,s))),Reflect.has(o,s))},set(o,s,l){return ne(n.get(s)??i(s,l),l),Reflect.set(o,s,l)}});this.#t=(e.hydrate?bl:Kr)(e.component,{target:e.target,anchor:e.anchor,props:r,context:e.context,intro:e.intro??!1,recover:e.recover,transformError:e.transformError}),!gt&&(!e?.props?.$$host||e.sync===!1)&&Qr(),this.#e=r.$$events;for(let o of Object.keys(this.#t))o==="$set"||o==="$destroy"||o==="$on"||At(this,o,{get(){return this.#t[o]},set(s){this.#t[o]=s},enumerable:!0});this.#t.$set=o=>{Object.assign(r,o)},this.#t.$destroy=()=>{Vo(this.#t)}}$set(e){this.#t.$set(e)}$on(e,n){this.#e[e]=this.#e[e]||[];let i=(...r)=>n.call(this,...r);return this.#e[e].push(i),()=>{this.#e[e]=this.#e[e].filter(r=>r!==i)}}$destroy(){this.#t.$destroy()}};var Cm;typeof HTMLElement=="function"&&(Cm=class extends HTMLElement{$$ctor;$$s;$$c;$$cn=!1;$$d={};$$r=!1;$$p_d={};$$l={};$$l_u=new Map;$$me;$$shadowRoot=null;constructor(t,e,n){super(),this.$$ctor=t,this.$$s=e,n&&(this.$$shadowRoot=this.attachShadow(n))}addEventListener(t,e,n){if(this.$$l[t]=this.$$l[t]||[],this.$$l[t].push(e),this.$$c){let i=this.$$c.$on(t,e);this.$$l_u.set(e,i)}super.addEventListener(t,e,n)}removeEventListener(t,e,n){if(super.removeEventListener(t,e,n),this.$$c){let i=this.$$l_u.get(e);i&&(i(),this.$$l_u.delete(e))}}async connectedCallback(){if(this.$$cn=!0,!this.$$c){let t=function(i){return r=>{let o=Un("slot");i!=="default"&&(o.name=i),C(r,o)}};if(await Promise.resolve(),!this.$$cn||this.$$c)return;let e={},n=$m(this);for(let i of this.$$s)i in n&&(i==="default"&&!this.$$d.children?(this.$$d.children=t(i),e.default=!0):e[i]=t(i));for(let i of this.attributes){let r=this.$$g_p(i.name);r in this.$$d||(this.$$d[r]=kl(r,i.value,this.$$p_d,"toProp"))}for(let i in this.$$p_d)!(i in this.$$d)&&this[i]!==void 0&&(this.$$d[i]=this[i],delete this[i]);this.$$c=Jc({component:this.$$ctor,target:this.$$shadowRoot||this,props:{...this.$$d,$$slots:e,$$host:this}}),this.$$me=al(()=>{qt(()=>{this.$$r=!0;for(let i of Fa(this.$$c)){if(!this.$$p_d[i]?.reflect)continue;this.$$d[i]=this.$$c[i];let r=kl(i,this.$$d[i],this.$$p_d,"toAttribute");r==null?this.removeAttribute(this.$$p_d[i].attribute||i):this.setAttribute(this.$$p_d[i].attribute||i,r)}this.$$r=!1})});for(let i in this.$$l)for(let r of this.$$l[i]){let o=this.$$c.$on(i,r);this.$$l_u.set(r,o)}this.$$l={}}}attributeChangedCallback(t,e,n){this.$$r||(t=this.$$g_p(t),this.$$d[t]=kl(t,n,this.$$p_d,"toProp"),this.$$c?.$set({[t]:this.$$d[t]}))}disconnectedCallback(){this.$$cn=!1,Promise.resolve().then(()=>{!this.$$cn&&this.$$c&&(this.$$c.$destroy(),this.$$me(),this.$$c=void 0)})}$$g_p(t){return Fa(this.$$p_d).find(e=>this.$$p_d[e].attribute===t||!this.$$p_d[e].attribute&&e.toLowerCase()===t)||t}});function kl(t,e,n,i){let r=n[t]?.type;if(e=r==="Boolean"&&typeof e!="boolean"?e!=null:e,!i||!n[t])return e;if(i==="toAttribute")switch(r){case"Object":case"Array":return e==null?null:JSON.stringify(e);case"Boolean":return e?"":null;case"Number":return e??null;default:return e}else switch(r){case"Object":case"Array":return e&&JSON.parse(e);case"Boolean":return e;case"Number":return e!=null?+e:e;default:return e}}function $m(t){let e={};return t.childNodes.forEach(n=>{e[n.slot||"default"]=!0}),e}var nt="--diff-font-size--",Te="--diff-aside-width--";var fi=()=>{let t=ce(!1);return ye(()=>{ne(t,!0)}),()=>a(t)};var qc=Symbol("fontSize");function Kc(t){Ye(qc,()=>t.diffViewFontSize||14)}function Xr(){return Qe(qc)}var Xc=Symbol("enableWrap");function Zc(t){Ye(Xc,()=>t.diffViewWrap)}function Ln(){return Qe(Xc)}var eu=Symbol("renderWidget");function tu(t){Ye(eu,()=>t.renderWidgetLine)}function Zr(){return Qe(eu)}var nu=Symbol("id");function iu(t){Ye(nu,t)}function Ws(){return Qe(nu)}var ru=Symbol("dom");function ou(t){Ye(ru,t)}function Vs(){return Qe(ru)}var su=Symbol("extend");function au(t){Ye(su,()=>t.extendData)}function eo(){return Qe(su)}var lu=Symbol("widget");function du(t){Ye(lu,()=>t)}function kn(){return Qe(lu)}var fu=Symbol("renderExtendLine");function cu(t){Ye(fu,()=>t.renderExtendLine)}function to(){return Qe(fu)}var uu=Symbol("onAddWidgetClick");function pu(t){Ye(uu,()=>t.onAddWidgetClick)}function no(){return Qe(uu)}var hu=Symbol("enableHighlight");function mu(t){Ye(hu,()=>t.diffViewHighlight)}function io(){return Qe(hu)}var gu=Symbol("enableAddWidget");function vu(t){Ye(gu,()=>t.diffViewAddWidget)}function ro(){return Qe(gu)}var _u=Symbol("mode");function bu(t){Ye(_u,()=>t.diffViewMode||jt.Split)}function Qs(){return Qe(_u)}var Il=null,Tm=(t,e)=>`${t.fontFamily}-${t.fontStyle}-${t.fontSize}-${e}`,Dm=(t,e)=>Tm(t,"0".repeat(e.length)),Nl=class{#e="";#t={};#n(){return Il=Il||document.createElement("canvas").getContext("2d"),Il}measure(e,n){let i=Dm(n||{},e);if(this.#t[i])return this.#t[i];let r=this.#n();if(n){let s=`${n.fontFamily}-${n.fontStyle}-${n.fontSize}`;this.#e!==s&&(this.#e=s,r.font=`${n.fontStyle||""} ${n.fontSize||""} ${n.fontFamily||""}`)}else r.font="";return r.measureText(e).width}},Sl=null,wu=()=>(Sl=Sl||new Nl,Sl);var oo=({text:t,font:e})=>{let n=I(fi()),i=parseInt(e().fontSize||"14"),r=6;r+=i>10?(i-10)*.6:0;let o=ce(r*t().length);return ye(()=>{a(n)&&ne(o,wu().measure(t()||"",e()),!0)}),()=>a(o)};var In=()=>{window.getSelection()?.removeAllRanges()},xu=(t,e)=>{let n=function(i){i===null||i.target===null||(i.target===t?(e.scrollTop=t.scrollTop,e.scrollLeft=t.scrollLeft):(t.scrollTop=e.scrollTop,t.scrollLeft=e.scrollLeft))};return t.onscroll||(t.onscroll=n),e.onscroll||(e.onscroll=n),()=>{t.onscroll=null,e.onscroll=null}},Ys=t=>{if(t){let e=t.getRootNode();return e instanceof ShadowRoot?e:t.ownerDocument}return document},so=t=>{if(t){if(typeof t.closest=="function")return t.closest('[data-component="git-diff-view"]')?.querySelector?.(".diff-view-wrapper")?.getAttribute?.("id");{let e=t;for(;e;){if(e.getAttribute&&e.getAttribute("data-component")==="git-diff-view")return e.querySelector(".diff-view-wrapper")?.getAttribute("id");e=e.parentElement}}}};var Cl="--diff-add-content--",$l="--diff-del-content--",_n="--diff-border--",Tl="--diff-add-lineNumber--",Dl="--diff-del-lineNumber--",Fl="--diff-plain-content--",Js="--diff-expand-content--",ct="--diff-plain-lineNumber-color--",hr="--diff-expand-lineNumber-color--",Ml="--diff-plain-lineNumber--",Fm="--diff-expand-lineNumber--",fn="--diff-hunk-content--",zn="--diff-hunk-content-color--",Wn="--diff-hunk-lineNumber--";var qs="--diff-add-widget--",Ks="--diff-add-widget-color--",Kt="--diff-empty-content--",Jo=(t,e,n)=>t?`var(${Cl})`:e?`var(${$l})`:n?`var(${Fl})`:`var(${Js})`,qo=(t,e,n)=>t?`var(${Tl})`:e?`var(${Dl})`:n?`var(${Ml})`:`var(${Fm})`;var Mm=new Set(["$$slots","$$events","$$legacy"]),Hm=j('<div><button class="diff-add-widget z-[1] flex h-full w-full origin-center cursor-pointer items-center justify-center rounded-md text-[1.2em]">+</button></div>');function Ri(t,e){de(e,!0);let n=he(e,Mm);var i=Hm(),r=Le(i);K(()=>{G(i,"data-add-widget",H[e.side]),Se(i,1,"diff-add-widget-wrapper invisible select-none transition-transform hover:scale-110 group-hover:visible"+(e.className?" "+e.className:"")),V(i,`
    ...
    `)}),we("mousedown",r,o=>{o.stopPropagation(),e.onOpenAddWidget(e.lineNumber,e.side),e.onWidgetClick?.(e.lineNumber,e.side)}),C(t,i),fe()}ot(["mousedown"]);zf();var Bm=Ai('<svg aria-label="No newline at end of file" role="img" viewBox="0 0 16 16" version="1.1" fill="currentColor"><path d="M4.25 7.25a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5h-7.5Z"></path><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0Zm-1.5 0a6.5 6.5 0 1 0-13 0 6.5 6.5 0 0 0 13 0Z"></path></svg>');function Ko(t){var e=Bm();C(t,e)}var Rm=new Set(["$$slots","$$events","$$legacy"]),Om=j('<span data-no-newline-at-end-of-file-symbol=""><!></span>'),Pm=j('<span class="diff-line-content-raw"><span data-template=""></span><!></span>'),yu=j('<span class="diff-line-content-raw"> </span>'),jm=j('<span class="diff-line-content-raw"><span data-template=""></span></span>');function Xo(t,e){de(e,!0);let n=he(e,Rm);e.diffLine?.changes?.hasLineChange?e.diffLine?.plainTemplate&&typeof ko=="function"&&ko({diffLine:e.diffLine,rawLine:e.rawLine,operator:e.operator||"add"}):e.plainLine&&!e.plainLine?.template&&(e.plainLine.template=Ia(e.plainLine.value));var r=me(),o=te(r);{var s=u=>{var c=me(),f=te(c);{var p=v=>{var y=Pm(),w=D(y);pr(w,()=>e.diffLine.plainTemplate,!0),T(w);var b=J(w);{var E=x=>{var S=Om(),k=D(S);Ko(k,{}),T(S),K(()=>{Se(S,1,dn(e.enableWrap?"block !text-red-500":"inline-block align-middle !text-red-500")),V(S,`
						width: var(${nt});
						height: var(${nt})
					`)}),C(x,S)};Q(b,x=>{e.diffLine.changes.newLineSymbol===$r.NEWLINE&&x(E)})}T(y),C(v,y)},g=v=>{var y=yu(),w=Le(y,!0);K(()=>$e(w,e.rawLine)),C(v,y)};Q(f,v=>{e.diffLine?.plainTemplate?v(p):v(g,-1)})}C(u,c)},l=u=>{var c=jm(),f=D(c);pr(f,()=>e.plainLine.template,!0),T(f),T(c),C(u,c)},d=u=>{var c=yu(),f=Le(c,!0);K(()=>$e(f,e.rawLine)),C(u,c)};Q(o,u=>{e.diffLine?.changes?.hasLineChange?u(s):e.plainLine?.template?u(l,1):u(d,-1)})}C(t,r),fe()}var Um=new Set(["$$slots","$$events","$$legacy"]),Gm=j('<span data-no-newline-at-end-of-file-symbol=""><!></span>'),zm=j('<span class="diff-line-syntax-raw"><span data-template=""></span><!></span>'),Eu=j("<span> </span>"),Au=j('<span class="diff-line-syntax-raw"></span>'),Wm=j('<span class="diff-line-syntax-raw"><span data-template=""></span></span>');function Hl(t,e){de(e,!0);let n=he(e,Um);e.diffLine?.changes?.hasLineChange?e.syntaxLine&&e.diffLine&&!e.diffLine?.syntaxTemplate&&typeof Io=="function"&&Io({diffFile:e.diffFile,diffLine:e.diffLine,syntaxLine:e.syntaxLine,operator:e.operator||"add"}):e.syntaxLine&&!e.syntaxLine.template&&(e.syntaxLine.template=ka(e.syntaxLine));var r=me(),o=te(r);{var s=c=>{Xo(c,{get rawLine(){return e.rawLine},get diffLine(){return e.diffLine},get operator(){return e.operator},get enableWrap(){return e.enableWrap}})},l=c=>{var f=me(),p=te(f);{var g=y=>{var w=zm(),b=D(w);pr(b,()=>e.diffLine.syntaxTemplate,!0),T(b);var E=J(b);{var x=S=>{var k=Gm(),h=D(k);Ko(h,{}),T(k),K(()=>{Se(k,1,dn(e.enableWrap?"block !text-red-500":"inline-block align-middle !text-red-500")),V(k,`
                width: var(${nt});
                height: var(${nt});
              `)}),C(S,k)};Q(E,S=>{e.diffLine.changes.newLineSymbol===$r.NEWLINE&&S(x)})}T(w),C(y,w)},v=y=>{var w=Au();di(w,21,()=>e.syntaxLine.nodeList,li,(b,E)=>{let x=()=>a(E).node,S=()=>a(E).wrapper;var k=Eu(),h=Le(k,!0);K(m=>{G(k,"data-start",x().startIndex),G(k,"data-end",x().endIndex),Se(k,1,m),V(k,S()?.properties?.style),$e(h,x().value)},[()=>dn(S()?.properties?.className?.join(" "))]),C(b,k)}),T(w),C(y,w)};Q(p,y=>{e.diffLine?.syntaxTemplate?y(g):y(v,-1)})}C(c,f)},d=c=>{var f=Wm(),p=D(f);pr(p,()=>e.syntaxLine.template,!0),T(p),T(f),C(c,f)},u=c=>{var f=Au();di(f,21,()=>e.syntaxLine.nodeList,li,(p,g)=>{let v=()=>a(g).node,y=()=>a(g).wrapper;var w=Eu(),b=Le(w,!0);K(E=>{G(w,"data-start",v().startIndex),G(w,"data-end",v().endIndex),Se(w,1,E),V(w,y()?.properties?.style),$e(b,v().value)},[()=>dn(y()?.properties?.className?.join(" "))]),C(p,w)}),T(f),C(c,f)};Q(o,c=>{e.syntaxLine?e.diffLine?.changes?.hasLineChange?c(l,1):e.syntaxLine.template?c(d,2):c(u,-1):c(s)})}C(t,r),fe()}var Vm=new Set(["$$slots","$$events","$$legacy"]),Qm=j('<div class="diff-line-content-item pl-[2.0em]"><span class="diff-line-content-operator ml-[-1.5em] inline-block w-[1.5em] select-none indent-[0.2em]"> </span> <!></div>');function ci(t,e){de(e,!0);let n=he(e,Vm),i=I(()=>e.diffLine?.type===Re.Add),r=I(()=>e.diffLine?.type===Re.Delete),o=I(()=>e.syntaxLine&&e.syntaxLine?.nodeList?.length>150);var s=Qm(),l=D(s),d=Le(l,!0),u=J(l,2);{var c=p=>{{let g=I(()=>a(i)?"add":a(r)?"del":void 0);Hl(p,{get operator(){return a(g)},get rawLine(){return e.rawLine},get diffFile(){return e.diffFile},get diffLine(){return e.diffLine},get syntaxLine(){return e.syntaxLine},get enableWrap(){return e.enableWrap}})}},f=p=>{{let g=I(()=>a(i)?"add":a(r)?"del":void 0);Xo(p,{get operator(){return a(g)},get rawLine(){return e.rawLine},get diffLine(){return e.diffLine},get plainLine(){return e.plainLine},get enableWrap(){return e.enableWrap}})}};Q(u,p=>{e.enableHighlight&&e.syntaxLine&&!a(o)?p(c):p(f,-1)})}T(s),K(()=>{V(s,`
		white-space: ${e.enableWrap?"pre-wrap":"pre"};
		word-break: ${e.enableWrap?"break-all":"initial"}
	`),G(l,"data-operator",a(i)?"+":a(r)?"-":void 0),$e(d,a(i)?"+":a(r)?"-":" ")}),C(t,s),fe()}var Ym=new Set(["$$slots","$$events","$$legacy"]),Jm=j('<td class="diff-line-old-num group relative w-[1%] min-w-[40px] select-none pl-[10px] pr-[10px] text-right align-top"><!> <span> </span></td> <td class="diff-line-old-content group relative pr-[10px] align-top"><!> <!></td>',1),qm=j('<td class="diff-line-old-placeholder select-none"><span>&ensp;</span></td>'),Km=j('<td class="diff-line-new-num group relative w-[1%] min-w-[40px] select-none border-l-[1px] pl-[10px] pr-[10px] text-right align-top"><!> <span> </span></td> <td class="diff-line-new-content group relative pr-[10px] align-top"><!> <!></td>',1),Xm=j('<td class="diff-line-new-placeholder select-none border-l-[1px]"><span>&ensp;</span></td>'),Zm=j('<tr class="diff-line"><!><!></tr>');function Bl(t,e){de(e,!0);let n=he(e,Ym),i=I(kn()),r=I(ro()),o=I(io()),s=I(no()),l=I(()=>e.diffFile.getSplitLeftLine(e.index)),d=I(()=>e.diffFile.getSplitRightLine(e.index)),u=()=>e.diffFile.getOldSyntaxLine(a(l)?.lineNumber||0),c=()=>e.diffFile.getNewSyntaxLine(a(d)?.lineNumber||0),f=()=>e.diffFile.getOldPlainLine(a(l)?.lineNumber||0),p=()=>e.diffFile.getNewPlainLine(a(d)?.lineNumber||0),g=ce(Ee(u())),v=ce(Ee(c())),y=ce(Ee(f())),w=ce(Ee(p())),b=I(()=>!!a(l)?.diff||!!a(d)?.diff),E=I(()=>Zi(a(l)?.diff)||Zi(a(d)?.diff)),x=I(()=>a(l)?.isHidden&&a(d)?.isHidden),S=()=>a(l)?.diff?.type===Re.Delete,k=()=>a(d)?.diff?.type===Re.Add,h=()=>{ne(g,u(),!0),ne(v,c(),!0),ne(y,f(),!0),ne(w,p(),!0)},m={current:()=>{}};ye(()=>{m.current(),h(),m.current=e.diffFile.subscribe(h)}),We(()=>m.current());let A=(X,z)=>{a(i).side=z,a(i).lineNumber=X};var N=me(),$=te(N);{var P=X=>{var z=Zm(),q=D(z);{var Y=O=>{var M=Jm(),ee=te(M),ae=D(ee);{var ie=xe=>{{let ke=I(()=>a(l)?.lineNumber||0);Ri(xe,{get index(){return e.index},get lineNumber(){return a(ke)},get side(){return H.old},get diffFile(){return e.diffFile},get onWidgetClick(){return a(s)},className:"absolute left-[100%] z-[1] translate-x-[-50%]",onOpenAddWidget:A})}};Q(ae,xe=>{a(b)&&a(r)&&xe(ie)})}var re=J(ae,2),Z=Le(re,!0);T(ee);var oe=J(ee,2),ue=D(oe);{var pe=xe=>{{let ke=I(()=>a(l)?.lineNumber||0);Ri(xe,{get index(){return e.index},get lineNumber(){return a(ke)},get side(){return H.old},get diffFile(){return e.diffFile},get onWidgetClick(){return a(s)},className:"absolute right-[100%] z-[1] translate-x-[50%]",onOpenAddWidget:A})}};Q(ue,xe=>{a(b)&&a(r)&&xe(pe)})}var Me=J(ue,2);{let xe=I(()=>a(l)?.value||""),ke=I(()=>a(l)?.diff),De=I(()=>!!a(o));ci(Me,{enableWrap:!0,get diffFile(){return e.diffFile},get rawLine(){return a(xe)},get diffLine(){return a(ke)},get plainLine(){return a(y)},get syntaxLine(){return a(g)},get enableHighlight(){return a(De)}})}T(oe),K((xe,ke)=>{V(ee,xe),G(ee,"data-side",H[H.old]),G(re,"data-line-num",a(l)?.lineNumber),V(re,`opacity: ${a(E)?void 0:.5} `),$e(Z,a(l)?.lineNumber),V(oe,ke),G(oe,"data-side",H[H.old])},[()=>`
					background-color: ${qo(!1,S(),a(b))};
					color: var(${a(b)?ct:hr})
				`,()=>` background-color: ${Jo(!1,S(),a(b))} `]),C(O,M)},ve=O=>{var M=qm();G(M,"colspan",2),K(()=>V(M,`background-color: var(${Kt}) `)),C(O,M)};Q(q,O=>{a(l)?.lineNumber?O(Y):O(ve,-1)})}var U=J(q);{var B=O=>{var M=Km(),ee=te(M),ae=D(ee);{var ie=xe=>{{let ke=I(()=>a(d)?.lineNumber||0);Ri(xe,{get index(){return e.index},get lineNumber(){return a(ke)},get side(){return H.new},get diffFile(){return e.diffFile},get onWidgetClick(){return a(s)},className:"absolute left-[100%] z-[1] translate-x-[-50%]",onOpenAddWidget:A})}};Q(ae,xe=>{a(b)&&a(r)&&xe(ie)})}var re=J(ae,2),Z=Le(re,!0);T(ee);var oe=J(ee,2),ue=D(oe);{var pe=xe=>{{let ke=I(()=>a(d)?.lineNumber||0);Ri(xe,{get index(){return e.index},get lineNumber(){return a(ke)},get side(){return H.new},get diffFile(){return e.diffFile},get onWidgetClick(){return a(s)},className:"absolute right-[100%] z-[1] translate-x-[50%]",onOpenAddWidget:A})}};Q(ue,xe=>{a(b)&&a(r)&&xe(pe)})}var Me=J(ue,2);{let xe=I(()=>a(d)?.value||""),ke=I(()=>a(d)?.diff),De=I(()=>!!a(o));ci(Me,{enableWrap:!0,get diffFile(){return e.diffFile},get rawLine(){return a(xe)},get diffLine(){return a(ke)},get plainLine(){return a(w)},get syntaxLine(){return a(v)},get enableHighlight(){return a(De)}})}T(oe),K((xe,ke)=>{V(ee,xe),G(ee,"data-side",H[H.new]),G(re,"data-line-num",a(d)?.lineNumber),V(re,` opacity: ${a(E)?void 0:.5} `),$e(Z,a(d)?.lineNumber),V(oe,ke),G(oe,"data-side",H[H.new])},[()=>`
					background-color: ${qo(k(),!1,a(b))};
					color: var(${a(b)?ct:hr});
					border-left-color: var(${_n});
					border-left-style: solid
				`,()=>`background-color: ${Jo(k(),!1,a(b))} `]),C(O,M)},R=O=>{var M=Xm();G(M,"colspan",2),K(()=>V(M,`
					background-color: var(${Kt});
					border-left-color: var(${_n});
					border-left-style: solid;
				`)),C(O,M)};Q(U,O=>{a(d)?.lineNumber?O(B):O(R,-1)})}T(z),K(()=>{G(z,"data-line",e.lineNumber),G(z,"data-state",a(b)?"diff":"plain")}),C(X,z)};Q($,X=>{a(x)||X(P)})}C(t,N),fe()}var eg=new Set(["$$slots","$$events","$$legacy"]),tg=j('<td class="diff-line-extend-old-content p-0"><div class="diff-line-extend-wrapper"><!></div></td>'),ng=j('<td class="diff-line-extend-old-placeholder select-none p-0"></td>'),ig=j('<td class="diff-line-extend-new-content border-l-[1px] p-0"><div class="diff-line-extend-wrapper"><!></div></td>'),rg=j('<td class="diff-line-extend-new-placeholder select-none border-l-[1px] p-0"></td>'),og=j('<tr data-state="extend" class="diff-line diff-line-extend"><!><!></tr>');function Rl(t,e){de(e,!0);let n=he(e,eg),i=I(eo()),r=I(to()),o=I(()=>e.diffFile.getSplitLeftLine(e.index)),s=I(()=>e.diffFile.getSplitRightLine(e.index)),l=I(()=>e.diffFile.getExpandEnabled()),d=I(()=>a(i)?.oldFile?.[a(o)?.lineNumber||""]),u=I(()=>a(i)?.newFile?.[a(s)?.lineNumber||""]),c=I(()=>!!((a(d)||a(u))&&(!a(o)?.isHidden&&!a(s)?.isHidden||a(l))&&a(r)));var f=me(),p=te(f);{var g=v=>{var y=og(),w=D(y);{var b=h=>{var m=tg();G(m,"colspan",2);var A=D(m),N=D(A);Bt(N,()=>a(r),()=>({diffFile:e.diffFile,side:H.old,lineNumber:a(o)?.lineNumber||0,data:a(d)?.data,onUpdate:e.diffFile.notifyAll})),T(A),T(m),C(h,m)},E=h=>{var m=ng();G(m,"colspan",2),K(()=>V(m,`background-color: var(${Kt})`)),C(h,m)};Q(w,h=>{a(r)&&a(d)?h(b):h(E,-1)})}var x=J(w);{var S=h=>{var m=ig();G(m,"colspan",2);var A=D(m),N=D(A);Bt(N,()=>a(r),()=>({diffFile:e.diffFile,side:H.new,lineNumber:a(s)?.lineNumber||0,data:a(u)?.data,onUpdate:e.diffFile.notifyAll})),T(A),T(m),K(()=>V(m,`border-left-color: var(${_n}); border-left-style: solid `)),C(h,m)},k=h=>{var m=rg();G(m,"colspan",2),K(()=>V(m,`
					background-color: var(${Kt});
					border-left-color: var(${_n});
					border-left-style: solid;
				`)),C(h,m)};Q(x,h=>{a(r)&&a(u)?h(S):h(k,-1)})}T(y),K(()=>G(y,"data-line",`${e.lineNumber}-extend`)),C(v,y)};Q(p,v=>{a(c)&&v(g)})}C(t,f),fe()}var sg=new Set(["$$slots","$$events","$$legacy"]),ag=Ai('<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16"><path d="M7.823 1.677 4.927 4.573A.25.25 0 0 0 5.104 5H7.25v3.236a.75.75 0 1 0 1.5 0V5h2.146a.25.25 0 0 0 .177-.427L8.177 1.677a.25.25 0 0 0-.354 0ZM13.75 11a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5Zm-3.75.75a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75ZM7.75 11a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5ZM4 11.75a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75ZM1.75 11a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5Z"></path></svg>');function Ct(t,e){de(e,!0);let n=he(e,sg);var i=ag();K(()=>Se(i,0,dn(e.className))),C(t,i),fe()}var lg=new Set(["$$slots","$$events","$$legacy"]),dg=Ai('<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16"><path d="m8.177 14.323 2.896-2.896a.25.25 0 0 0-.177-.427H8.75V7.764a.75.75 0 1 0-1.5 0V11H5.104a.25.25 0 0 0-.177.427l2.896 2.896a.25.25 0 0 0 .354 0ZM2.25 5a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM6 4.25a.75.75 0 0 1-.75.75h-.5a.75.75 0 0 1 0-1.5h.5a.75.75 0 0 1 .75.75ZM8.25 5a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM12 4.25a.75.75 0 0 1-.75.75h-.5a.75.75 0 0 1 0-1.5h.5a.75.75 0 0 1 .75.75Zm2.25.75a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5Z"></path></svg>');function $t(t,e){de(e,!0);let n=he(e,lg);var i=dg();K(()=>Se(i,0,dn(e.className))),C(t,i),fe()}var fg=new Set(["$$slots","$$events","$$legacy"]),cg=Ai('<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16"><path d="m8.177.677 2.896 2.896a.25.25 0 0 1-.177.427H8.75v1.25a.75.75 0 0 1-1.5 0V4H5.104a.25.25 0 0 1-.177-.427L7.823.677a.25.25 0 0 1 .354 0ZM7.25 10.75a.75.75 0 0 1 1.5 0V12h2.146a.25.25 0 0 1 .177.427l-2.896 2.896a.25.25 0 0 1-.354 0l-2.896-2.896A.25.25 0 0 1 5.104 12H7.25v-1.25Zm-5-2a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM6 8a.75.75 0 0 1-.75.75h-.5a.75.75 0 0 1 0-1.5h.5A.75.75 0 0 1 6 8Zm2.25.75a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM12 8a.75.75 0 0 1-.75.75h-.5a.75.75 0 0 1 0-1.5h.5A.75.75 0 0 1 12 8Zm2.25.75a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5Z"></path></svg>');function Sn(t,e){de(e,!0);let n=he(e,fg);var i=cg();K(()=>Se(i,0,dn(e.className))),C(t,i),fe()}var ug=new Set(["$$slots","$$events","$$legacy"]),pg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),hg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),mg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),gg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),vg=j('<div class="min-h-[28px]">&ensp;</div>'),_g=j('<tr data-state="hunk" class="diff-line diff-line-hunk"><td class="diff-line-hunk-action relative w-[1%] min-w-[40px] select-none p-[1px]"><!></td><td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td></tr>');function Ol(t,e){de(e,!0);let n=he(e,ug),i=I(()=>e.diffFile.getSplitHunkLine(e.index)),r=I(()=>e.diffFile.getExpandEnabled()),o=I(()=>a(r)&&a(i)?.splitInfo),s=()=>{let b=a(i);return b&&b.splitInfo&&b.splitInfo.endHiddenIndex-b.splitInfo.startHiddenIndex<je},l=ce(Ee(s())),d=()=>{let b=a(i);return b&&b.splitInfo&&b.splitInfo.startHiddenIndex<b.splitInfo.endHiddenIndex},u=ce(Ee(d())),c=I(()=>{let b=a(i);return b&&b.isFirst}),f=I(()=>{let b=a(i);return b&&e.diffFile._getIsPureDiffRender()&&!b.splitInfo}),p=I(()=>{let b=a(i);return b&&b.isLast}),g={current:()=>{}};ye(()=>{g.current();let b=()=>{ne(u,d(),!0),ne(l,s(),!0)};b(),g.current=e.diffFile.subscribe(b)}),We(()=>g.current());var v=me(),y=te(v);{var w=b=>{var E=_g(),x=D(E),S=D(x);{var k=$=>{var P=me(),X=te(P);{var z=U=>{var B=pg(),R=D(B);Ct(R,{className:"fill-current"}),T(B),we("click",B,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(U,B)},q=U=>{var B=hg(),R=D(B);$t(R,{className:"fill-current"}),T(B),we("click",B,()=>e.diffFile.onSplitHunkExpand("down",e.index)),C(U,B)},Y=U=>{var B=mg(),R=D(B);Sn(R,{className:"fill-current"}),T(B),we("click",B,()=>e.diffFile.onSplitHunkExpand("all",e.index)),C(U,B)},ve=U=>{var B=gg(),R=te(B),O=D(R);$t(O,{className:"fill-current"}),T(R);var M=J(R,2),ee=D(M);Ct(ee,{className:"fill-current"}),T(M),we("click",R,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",M,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(U,B)};Q(X,U=>{a(c)?U(z):a(p)?U(q,1):a(l)?U(Y,2):U(ve,-1)})}C($,P)},h=$=>{var P=vg();C($,P)};Q(S,$=>{a(o)?$(k):$(h,-1)})}T(x);var m=J(x);G(m,"colspan",3);var A=D(m),N=Le(A,!0);T(m),T(E),K(()=>{G(E,"data-line",`${e.lineNumber}-hunk`),V(x,`
				background-color: var(${Wn});
				color: var(${ct})
			`),V(m,`background-color: var(${fn})`),V(A,`
					color: var(${zn})
				`),$e(N,a(i)?.splitInfo?.plainText||a(i)?.text)}),C(b,E)};Q(y,b=>{(a(u)||a(f))&&b(w)})}C(t,v),fe()}ot(["click"]);var bg=new Set(["$$slots","$$events","$$legacy"]),Lu=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),ku=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),Iu=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),Su=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),Nu=j('<div class="min-h-[28px]">&ensp;</div>'),wg=j('<tr data-state="hunk" class="diff-line diff-line-hunk"><td class="diff-line-hunk-action relative w-[1%] min-w-[40px] select-none p-[1px]"><!></td><td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td><td class="diff-line-hunk-action relative z-[1] w-[1%] min-w-[40px] select-none border-l-[1px] p-[1px]"><!></td><td class="diff-line-hunk-content relative pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td></tr>');function Pl(t,e){de(e,!0);let n=he(e,bg),i=I(()=>e.diffFile.getSplitHunkLine(e.index)),r=I(()=>e.diffFile.getExpandEnabled()),o=I(()=>a(r)&&a(i)?.splitInfo),s=()=>{let b=a(i);return b&&b.splitInfo&&b.splitInfo.endHiddenIndex-b.splitInfo.startHiddenIndex<je},l=ce(Ee(s())),d=()=>{let b=a(i);return b&&b.splitInfo&&b.splitInfo.startHiddenIndex<b.splitInfo.endHiddenIndex},u=ce(Ee(d())),c=I(()=>{let b=a(i);return b&&b.isFirst}),f=I(()=>{let b=a(i);return b&&e.diffFile._getIsPureDiffRender()&&!b.splitInfo}),p=I(()=>{let b=a(i);return b&&b.isLast}),g={current:()=>{}};ye(()=>{g.current();let b=()=>{ne(u,d(),!0),ne(l,s(),!0)};b(),g.current=e.diffFile.subscribe(b)}),We(()=>g.current());var v=me(),y=te(v);{var w=b=>{var E=wg(),x=D(E),S=D(x);{var k=U=>{var B=me(),R=te(B);{var O=ie=>{var re=Lu(),Z=D(re);Ct(Z,{className:"fill-current"}),T(re),we("click",re,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(ie,re)},M=ie=>{var re=ku(),Z=D(re);$t(Z,{className:"fill-current"}),T(re),we("click",re,()=>e.diffFile.onSplitHunkExpand("down",e.index)),C(ie,re)},ee=ie=>{var re=Iu(),Z=D(re);Sn(Z,{className:"fill-current"}),T(re),we("click",re,()=>e.diffFile.onSplitHunkExpand("all",e.index)),C(ie,re)},ae=ie=>{var re=Su(),Z=te(re),oe=D(Z);$t(oe,{className:"fill-current"}),T(Z);var ue=J(Z,2),pe=D(ue);Ct(pe,{className:"fill-current"}),T(ue),we("click",Z,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",ue,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(ie,re)};Q(R,ie=>{a(c)?ie(O):a(p)?ie(M,1):a(l)?ie(ee,2):ie(ae,-1)})}C(U,B)},h=U=>{var B=Nu();C(U,B)};Q(S,U=>{a(o)?U(k):U(h,-1)})}T(x);var m=J(x),A=D(m),N=Le(A,!0);T(m);var $=J(m),P=D($);{var X=U=>{var B=me(),R=te(B);{var O=ie=>{var re=Lu(),Z=D(re);Ct(Z,{className:"fill-current"}),T(re),we("click",re,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(ie,re)},M=ie=>{var re=ku(),Z=D(re);$t(Z,{className:"fill-current"}),T(re),we("click",re,()=>e.diffFile.onSplitHunkExpand("down",e.index)),C(ie,re)},ee=ie=>{var re=Iu(),Z=D(re);Sn(Z,{className:"fill-current"}),T(re),we("click",re,()=>e.diffFile.onSplitHunkExpand("all",e.index)),C(ie,re)},ae=ie=>{var re=Su(),Z=te(re),oe=D(Z);$t(oe,{className:"fill-current"}),T(Z);var ue=J(Z,2),pe=D(ue);Ct(pe,{className:"fill-current"}),T(ue),we("click",Z,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",ue,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(ie,re)};Q(R,ie=>{a(c)?ie(O):a(p)?ie(M,1):a(l)?ie(ee,2):ie(ae,-1)})}C(U,B)},z=U=>{var B=Nu();C(U,B)};Q(P,U=>{a(o)?U(X):U(z,-1)})}T($);var q=J($),Y=D(q),ve=Le(Y,!0);T(q),T(E),K(()=>{G(E,"data-line",`${e.lineNumber}-hunk`),V(x,`
				background-color: var(${Wn});
				color: var(${ct})
			`),V(m,`background-color: var(${fn})`),V(A,`
					color: var(${zn})
			...
			`),V(q,`background-color: var(${fn})`),V(Y,`
					color: var(${zn})
				`),$e(ve,a(i)?.splitInfo?.plainText||a(i)?.text)}),C(b,E)};Q(y,b=>{(a(u)||a(f))&&b(w)})}C(t,v),fe()}ot(["click"]);var xg=new Set(["$$slots","$$events","$$legacy"]);function Xs(t,e){de(e,!0);let n=he(e,xg),i=I(Qs());var r=me(),o=te(r);{var s=d=>{Ol(d,{get index(){return e.index},get diffFile(){return e.diffFile},get lineNumber(){return e.lineNumber}})},l=d=>{Pl(d,{get index(){return e.index},get diffFile(){return e.diffFile},get lineNumber(){return e.lineNumber}})};Q(o,d=>{a(i)===jt.SplitGitHub||a(i)===jt.Split?d(s):d(l,-1)})}C(t,r),fe()}var yg=new Set(["$$slots","$$events","$$legacy"]),Eg=j('<td class="diff-line-widget-old-content p-0"><div class="diff-line-widget-wrapper"><!></div></td>'),Ag=j('<td class="diff-line-widget-old-placeholder select-none p-0"></td>'),Lg=j('<td class="diff-line-widget-new-content border-l-[1px] p-0"><div class="diff-line-widget-wrapper"><!></div></td>'),kg=j('<td class="diff-line-widget-new-placeholder select-none border-l-[1px] p-0"></td>'),Ig=j('<tr data-state="widget" class="diff-line diff-line-widget"><!><!></tr>');function jl(t,e){de(e,!0);let n=he(e,yg),i=I(Zr()),r=I(kn()),o=I(()=>e.diffFile.getSplitLeftLine(e.index)),s=I(()=>e.diffFile.getSplitRightLine(e.index)),l=I(()=>a(o)?.lineNumber&&a(r)?.side===H.old&&a(r)?.lineNumber===a(o)?.lineNumber),d=I(()=>a(s)?.lineNumber&&a(r)?.side===H.new&&a(r)?.lineNumber===a(s)?.lineNumber),u=I(()=>(!!a(l)||!!a(d))&&!a(o)?.isHidden&&!a(s)?.isHidden&&!!a(i)),c=()=>{a(r).side=void 0,a(r).lineNumber=void 0};var f=me(),p=te(f);{var g=v=>{var y=Ig(),w=D(y);{var b=h=>{var m=Eg();G(m,"colspan",2);var A=D(m),N=D(A);Bt(N,()=>a(i),()=>({diffFile:e.diffFile,side:H.old,lineNumber:a(o)?.lineNumber||0,onClose:c})),T(A),T(m),C(h,m)},E=h=>{var m=Ag();G(m,"colspan",2),K(()=>V(m,`background-color: var(${Kt})`)),C(h,m)};Q(w,h=>{a(l)&&a(i)?h(b):h(E,-1)})}var x=J(w);{var S=h=>{var m=Lg();G(m,"colspan",2);var A=D(m),N=D(A);Bt(N,()=>a(i)??ht,()=>({diffFile:e.diffFile,side:H.new,lineNumber:a(s)?.lineNumber||0,onClose:c})),T(A),T(m),K(()=>V(m,`border-left-color: var(${_n}); border-left-style: solid `)),C(h,m)},k=h=>{var m=kg();G(m,"colspan",2),K(()=>V(m,`
					background-color: var(${Kt});
					border-left-color: var(${_n});
					border-left-style: solid;
				`)),C(h,m)};Q(x,h=>{a(d)&&a(i)?h(S):h(k,-1)})}T(y),K(()=>G(y,"data-line",`${e.lineNumber}-widget`)),C(v,y)};Q(p,v=>{a(u)&&v(g)})}C(t,f),fe()}var Sg=new Set(["$$slots","$$events","$$legacy"]),Ng=j("<!> <!> <!> <!>",1),Cg=j('<div class="split-diff-view split-diff-view-warp w-full"><div class="diff-table-wrapper w-full"><style data-select-style=""></style> <table class="diff-table w-full table-fixed border-collapse border-spacing-0"><colgroup><col class="diff-table-old-num-col"/><col class="diff-table-old-content-col"/><col class="diff-table-new-num-col"/><col class="diff-table-new-content-col"/></colgroup><thead class="hidden"><tr><th scope="col">old line number</th><th scope="col">old line content</th><th scope="col">new line number</th><th scope="col">new line content</th></tr></thead><tbody class="diff-table-body leading-[1.6]"><!><!></tbody></table></div></div>');function Ul(t,e){de(e,!0);let n=he(e,Sg),i=()=>cs(e.diffFile),r=ce(Ee(i())),o={current:void 0},s=ce(void 0),l=I(()=>Math.max(e.diffFile.splitLineLength,e.diffFile.fileLineLength).toString()),d=I(Xr()),u=I(()=>({fontSize:`${a(d)||14}px`,fontFamily:"Menlo, Consolas, monospace"})),c={current:()=>{}};ye(()=>{c.current();let N=()=>ne(r,i(),!0);N(),c.current=e.diffFile.subscribe(N)}),We(()=>c.current());let f=N=>{let $=a(s);if($)if(N){let P=N===H.old?H.new:H.old;$.textContent=`#diff-root${e.diffFile.getId()} [data-side="${H[P]}"] {user-select: none} 
#diff-root${e.diffFile.getId()} [data-state="extend"] {user-select: none} 
#diff-root${e.diffFile.getId()} [data-state="hunk"] {user-select: none} 
#diff-root${e.diffFile.getId()} [data-state="widget"] {user-select: none}`}else $.textContent=""},p=N=>{let $=N.target;if($&&$ instanceof HTMLElement&&$.nodeName==="BUTTON"){In();return}let P=so($);if(!(P&&P!==`diff-root${e.diffFile.getId()}`))for(;$&&$ instanceof HTMLElement;){let X=$.getAttribute("data-state"),z=$.getAttribute("data-side");if(z&&o.current!==H[z]&&(o.current=H[z],f(H[z]),In()),X)if(X==="extend"||X==="hunk"||X==="widget"){o.current!==void 0&&(o.current=void 0,f(void 0),In());return}else return;$=$.parentElement}},g=I(oo({text:()=>a(l),font:()=>a(u)})),v=I(()=>Math.max(40,a(g)+25));var y=Cg(),w=D(y),b=D(w);lt(b,()=>N=>ne(s,N,!0));var E=J(b,2),x=D(E),S=D(x),k=J(S,2);er(),T(x);var h=J(x,2),m=D(h);di(m,17,()=>a(r),li,(N,$)=>{var P=Ng(),X=te(P);Xs(X,{get index(){return a($).index},get lineNumber(){return a($).lineNumber},get diffFile(){return e.diffFile}});var z=J(X,2);Bl(z,{get index(){return a($).index},get lineNumber(){return a($).lineNumber},get diffFile(){return e.diffFile}});var q=J(z,2);jl(q,{get index(){return a($).index},get lineNumber(){return a($).lineNumber},get diffFile(){return e.diffFile}});var Y=J(q,2);Rl(Y,{get index(){return a($).index},get lineNumber(){return a($).lineNumber},get diffFile(){return e.diffFile}}),C(N,P)});var A=J(m);Xs(A,{get index(){return e.diffFile.splitLineLength},get lineNumber(){return e.diffFile.splitLineLength},get diffFile(){return e.diffFile}}),T(h),T(E),T(w),T(y),K((N,$,P)=>{V(w,N),G(S,"width",$),G(k,"width",P)},[()=>`
			${Te}: ${Math.round(a(v))}px;
			font-family: Menlo, Consolas, monospace;
			font-size: var(${nt});
		`,()=>Math.round(a(v)),()=>Math.round(a(v))]),we("mousedown",h,p),C(t,y),fe()}ot(["mousedown"]);var $g=new Set(["$$slots","$$events","$$legacy"]),Tg=j("<td><!> <span> </span></td> <td><!></td>",1),Dg=j("<td><span>&ensp;</span></td>"),Fg=j("<tr><!></tr>");function Gl(t,e){de(e,!0);let n=he(e,$g),i=I(kn()),r=I(ro()),o=I(io()),s=I(no()),l=I(()=>e.side===H.old?e.diffFile.getSplitLeftLine(e.index):e.diffFile.getSplitRightLine(e.index)),d=I(()=>!!a(l)?.diff),u=I(()=>Zi(a(l)?.diff)),c=I(()=>a(l)?.isHidden),f=I(()=>!!a(l)?.lineNumber),p=()=>e.side===H.old?e.diffFile.getOldSyntaxLine(a(l)?.lineNumber||0):e.diffFile.getNewSyntaxLine(a(l)?.lineNumber||0),g=()=>e.side===H.old?e.diffFile.getOldPlainLine(a(l)?.lineNumber||0):e.diffFile.getNewPlainLine(a(l)?.lineNumber||0),v=ce(Ee(p())),y=ce(Ee(g())),w=()=>{ne(v,p(),!0),ne(y,g(),!0)},b={current:()=>{}};ye(()=>{b.current(),w(),b.current=e.diffFile.subscribe(w)}),We(()=>b.current());let E=(A,N)=>{a(i).side=N,a(i).lineNumber=A},x=()=>a(l)?.diff?.type===Re.Add,S=()=>a(l)?.diff?.type===Re.Delete;var k=me(),h=te(k);{var m=A=>{var N=Fg(),$=D(N);{var P=z=>{var q=Tg(),Y=te(q),ve=D(Y);{var U=ee=>{{let ae=I(()=>a(l)?.lineNumber||0);Ri(ee,{get index(){return e.index},get lineNumber(){return a(ae)},get side(){return e.side},get diffFile(){return e.diffFile},get onWidgetClick(){return a(s)},className:"absolute left-[100%] z-[1] translate-x-[-50%]",onOpenAddWidget:E})}};Q(ve,ee=>{a(d)&&a(r)&&ee(U)})}var B=J(ve,2),R=Le(B,!0);T(Y);var O=J(Y,2),M=D(O);{let ee=I(()=>a(l)?.value||""),ae=I(()=>a(l)?.diff),ie=I(()=>!!a(o));ci(M,{enableWrap:!1,get diffFile(){return e.diffFile},get rawLine(){return a(ee)},get diffLine(){return a(ae)},get plainLine(){return a(y)},get syntaxLine(){return a(v)},get enableHighlight(){return a(ie)}})}T(O),K((ee,ae)=>{Se(Y,1,`diff-line-${H[e.side]}-num sticky left-0 z-[1] w-[1%] min-w-[40px] select-none pl-[10px] pr-[10px] text-right align-top`),V(Y,ee),G(B,"data-line-num",a(l)?.lineNumber),V(B,` opacity: ${a(u)?void 0:.5} `),$e(R,a(l)?.lineNumber),Se(O,1,`diff-line-${H[e.side]}-content pr-[10px] align-top`),V(O,ae)},[()=>`
					background-color: ${qo(x(),S(),a(d))};
					color: var(${a(d)?ct:hr});
					width: var(${Te});
					min-width: var(${Te});
					max-width: var(${Te})
				`,()=>` background-color: ${Jo(x(),S(),a(d))} `]),C(z,q)},X=z=>{var q=Dg();G(q,"colspan",2),K(()=>{Se(q,1,`diff-line-${H[e.side]}-placeholder select-none`),V(q,`background-color: var(${Kt}) `)}),C(z,q)};Q($,z=>{a(f)?z(P):z(X,-1)})}T(N),K(()=>{G(N,"data-line",e.lineNumber),G(N,"data-state",a(d)||!a(f)?"diff":"plain"),G(N,"data-side",H[e.side]),Se(N,1,"diff-line"+(a(f)?" group":""))}),C(A,N)};Q(h,A=>{a(c)||A(m)})}C(t,k),fe()}var Oi=({selector:t,enable:e})=>{let n=I(Ws()),i=I(Vs()),r=I(fi()),o=ce(0),s={current:()=>{}},l=()=>{if(a(r)&&e()){let c=Ys(a(i)).querySelector(`#diff-root${a(n)}`)?.querySelector(t());if(!c)return;let f=c,p=()=>{let y=c?.getBoundingClientRect();ne(o,y?.width??0,!0)};p();let g=()=>{f?.__observeCallback?.delete(p),f?.__observeCallback?.size===0&&(f.__observeInstance?.disconnect(),f.removeAttribute("data-observe"),delete f.__observeCallback,delete f.__observeInstance)};if(f.__observeCallback){f.__observeCallback.add(p),s.current=()=>g();return}f.__observeCallback=new Set,f.__observeCallback.add(p);let v=new ResizeObserver(()=>f?.__observeCallback?.forEach(y=>y()));f.__observeInstance=v,v.observe(f),f.setAttribute("data-observe","height"),s.current=()=>g()}};return ye(()=>(l(),()=>s.current?.())),()=>a(o)};var Pi=({selector:t,wrapper:e,side:n,enable:i})=>{let r=I(Ws()),o=I(Vs()),s=I(fi()),l={current:()=>{}},d=()=>{if(a(s)&&i()){let u=()=>{},f=Ys(a(o)).querySelector(`#diff-root${a(r)}`),p=Array.from(f?.querySelectorAll(t())||[]),g=e()?Array.from(f?.querySelectorAll(e())||[]):p;if(p.length===2&&g.length===2){let v=p[0],y=p[1],w=g[0],b=g[1],E=v.getAttribute("data-side")===n()?v:y,x=E,S=()=>{v.style.height="auto",y.style.height="auto";let m=v.getBoundingClientRect(),A=y.getBoundingClientRect(),N=Math.max(m.height,A.height);w.style.height=N+"px",b.style.height=N+"px",w.setAttribute("data-sync-height",String(N)),b.setAttribute("data-sync-height",String(N))};S();let k=()=>{x.__observeCallback?.delete(S),x.__observeCallback?.size===0&&(x.__observeInstance?.disconnect(),E.removeAttribute("data-observe"),delete x.__observeCallback,delete x.__observeInstance)};if(x.__observeCallback){x.__observeCallback.add(S),u=k;return}x.__observeCallback=new Set,x.__observeCallback.add(S);let h=new ResizeObserver(()=>x.__observeCallback?.forEach(m=>m()));x.__observeInstance=h,h.observe(E),E.setAttribute("data-observe","height"),u=k}l.current=u}};ye(()=>(d(),()=>l.current?.()))};var Mg=new Set(["$$slots","$$events","$$legacy"]),Hg=j('<td><div class="diff-line-extend-wrapper sticky left-0 z-[1]"><!></div></td>'),Bg=j("<td><div></div></td>"),Rg=j('<tr data-state="extend" class="diff-line diff-line-extend"><!></tr>');function zl(t,e){de(e,!0);let n=he(e,Mg),i=ce(null),r=I(eo()),o=I(to()),s=I(()=>`div[data-line="${e.lineNumber}-extend-content"]`),l=I(()=>`tr[data-line="${e.lineNumber}-extend"]`),d=I(()=>e.side===H.old?".old-diff-table-wrapper":".new-diff-table-wrapper"),u=I(()=>e.diffFile.getSplitLeftLine(e.index)),c=I(()=>e.diffFile.getSplitRightLine(e.index)),f=I(()=>e.diffFile.getExpandEnabled()),p=I(()=>a(r)?.oldFile?.[a(u)?.lineNumber||""]),g=I(()=>a(r)?.newFile?.[a(c)?.lineNumber||""]),v=I(()=>e.side===H.old?a(u):a(c)),y=I(()=>a(v)?.isHidden),w=I(()=>e.side===H.old?a(p):a(g)),b=I(()=>e.side===H.old?a(u)?.lineNumber:a(c)?.lineNumber),E=I(()=>!!((a(p)||a(g))&&(!a(y)||a(f))&&a(o))),x=I(()=>(e.side===H.old?!!a(p):!!a(g))&&a(E)),S=I(()=>H[a(w)?e.side:e.side===H.new?H.old:H.new]);Pi({selector:()=>a(s),wrapper:()=>a(l),side:()=>a(S),enable:()=>!!(a(E)&&a(i))});let k=I(Oi({selector:()=>a(d),enable:()=>!!(a(x)&&a(i))}));var h=me(),m=te(h);{var A=N=>{var $=Rg(),P=D($);{var X=q=>{var Y=Hg();G(Y,"colspan",2);var ve=D(Y),U=D(ve);{var B=R=>{var O=me(),M=te(O);Bt(M,()=>a(o)??ht,()=>({diffFile:e.diffFile,side:e.side,lineNumber:a(b)||0,data:a(w)?.data,onUpdate:e.diffFile.notifyAll})),C(R,O)};Q(U,R=>{a(k)>0&&R(B)})}T(ve),T(Y),K(()=>{Se(Y,1,`diff-line-extend-${H[e.side]}-content p-0`),G(ve,"data-line",`${e.lineNumber}-extend-content`),G(ve,"data-side",H[e.side]),V(ve,` width: ${a(k)}px `)}),C(q,Y)},z=q=>{var Y=Bg();G(Y,"colspan",2);var ve=Le(Y);K(()=>{Se(Y,1,`diff-line-extend-${H[e.side]}-placeholder select-none p-0`),V(Y,` background-color: var(${Kt})`),G(ve,"data-line",`${e.lineNumber}-extend-content`),G(ve,"data-side",H[e.side])}),C(q,Y)};Q(P,q=>{a(o)&&a(w)?q(X):q(z,-1)})}T($),lt($,()=>q=>ne(i,q,!0)),K(()=>{G($,"data-line",`${e.lineNumber}-extend`),G($,"data-side",H[e.side])}),C(N,$)};Q(m,N=>{a(E)&&N(A)})}C(t,h),fe()}var Og=new Set(["$$slots","$$events","$$legacy"]),Pg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),jg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),Ug=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),Gg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),zg=j('<div class="min-h-[28px]">&ensp;</div>'),Wg=j('<td class="diff-line-hunk-action sticky left-0 w-[1%] min-w-[40px] select-none p-[1px]"><!></td> <td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td>',1),Vg=j('<td class="diff-line-hunk-placeholder select-none"><div class="min-h-[28px]">&ensp;</div></td>'),Qg=j('<tr data-state="hunk" class="diff-line diff-line-hunk"><!></tr>');function Wl(t,e){de(e,!0);let n=he(e,Og),i=ce(null),r=I(()=>e.diffFile.getSplitHunkLine(e.index)),o=I(()=>e.diffFile.getExpandEnabled()),s=I(()=>a(o)&&a(r)?.splitInfo),l=I(()=>`tr[data-line="${e.lineNumber}-hunk"]`),d=I(()=>e.side===H.old),u=()=>{let h=a(r);return h&&h.splitInfo&&h.splitInfo.endHiddenIndex-h.splitInfo.startHiddenIndex<je},c=ce(Ee(u())),f=()=>{let h=a(r);return h&&h.splitInfo&&h.splitInfo.startHiddenIndex<h.splitInfo.endHiddenIndex},p=ce(Ee(f())),g=I(()=>{let h=a(r);return h&&h.isFirst}),v=I(()=>{let h=a(r);return h&&e.diffFile._getIsPureDiffRender()&&!h.splitInfo}),y=I(()=>{let h=a(r);return h&&h.isLast}),w={current:()=>{}};ye(()=>{w.current();let h=()=>{ne(p,f(),!0),ne(c,u(),!0)};h(),w.current=e.diffFile.subscribe(h)}),We(()=>w.current());let b=I(()=>H[H.old]),E=I(()=>e.side===H.new&&(!!a(p)||a(v)));Pi({selector:()=>a(l),wrapper:()=>a(l),side:()=>a(b),enable:()=>!!(a(E)&&a(i))});var x=me(),S=te(x);{var k=h=>{var m=Qg(),A=D(m);{var N=P=>{var X=Wg(),z=te(X),q=D(z);{var Y=O=>{var M=me(),ee=te(M);{var ae=oe=>{var ue=Pg(),pe=D(ue);Ct(pe,{className:"fill-current"}),T(ue),we("click",ue,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(oe,ue)},ie=oe=>{var ue=jg(),pe=D(ue);$t(pe,{className:"fill-current"}),T(ue),we("click",ue,()=>e.diffFile.onSplitHunkExpand("down",e.index)),C(oe,ue)},re=oe=>{var ue=Ug(),pe=D(ue);Sn(pe,{className:"fill-current"}),T(ue),we("click",ue,()=>e.diffFile.onSplitHunkExpand("all",e.index)),C(oe,ue)},Z=oe=>{var ue=Gg(),pe=te(ue),Me=D(pe);$t(Me,{className:"fill-current"}),T(pe);var xe=J(pe,2),ke=D(xe);Ct(ke,{className:"fill-current"}),T(xe),we("click",pe,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",xe,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(oe,ue)};Q(ee,oe=>{a(g)?oe(ae):a(y)?oe(ie,1):a(c)?oe(re,2):oe(Z,-1)})}C(O,M)},ve=O=>{var M=zg();C(O,M)};Q(q,O=>{a(s)?O(Y):O(ve,-1)})}T(z);var U=J(z,2),B=D(U),R=Le(B,!0);T(U),K(()=>{V(z,`
					background-color: var(${Wn});
					color: var(${ct});
					width: var(${Te});
					min-width: var(${Te});
				...
				`),V(U,`background-color: var(${fn})`),V(B,`
						color: var(${zn})
					`),$e(R,a(r)?.splitInfo?.plainText||a(r)?.text)}),C(P,X)},$=P=>{var X=Vg();G(X,"colspan",2),K(()=>V(X,`background-color: var(${fn})`)),C(P,X)};Q(A,P=>{a(d)?P(N):P($,-1)})}T(m),lt(m,()=>P=>ne(i,P,!0)),K(()=>{G(m,"data-line",`${e.lineNumber}-hunk`),G(m,"data-side",H[e.side]),V(m,`background-color: var(${fn})`)}),C(h,m)};Q(S,h=>{(a(p)||a(v))&&h(k)})}C(t,x),fe()}ot(["click"]);var Yg=new Set(["$$slots","$$events","$$legacy"]),Jg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),qg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),Kg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),Xg=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),Zg=j('<div class="min-h-[28px]">&ensp;</div>'),ev=j('<tr data-state="hunk" class="diff-line diff-line-hunk"><td class="diff-line-hunk-action sticky left-0 w-[1%] min-w-[40px] select-none p-[1px]"><!></td><td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td></tr>');function Vl(t,e){de(e,!0);let n=he(e,Yg),i=ce(null),r=I(()=>e.diffFile.getSplitHunkLine(e.index)),o=I(()=>e.diffFile.getExpandEnabled()),s=I(()=>a(o)&&a(r)?.splitInfo),l=I(()=>`tr[data-line="${e.lineNumber}-hunk"]`),d=()=>{let k=a(r);return k&&k.splitInfo&&k.splitInfo.endHiddenIndex-k.splitInfo.startHiddenIndex<je},u=ce(Ee(d())),c=()=>{let k=a(r);return k&&k.splitInfo&&k.splitInfo.startHiddenIndex<k.splitInfo.endHiddenIndex},f=ce(Ee(c())),p=I(()=>{let k=a(r);return k&&k.isFirst}),g=I(()=>{let k=a(r);return k&&e.diffFile._getIsPureDiffRender()&&!k.splitInfo}),v=I(()=>{let k=a(r);return k&&k.isLast}),y=I(()=>H[H.old]),w=I(()=>e.side===H.new&&(!!a(f)||a(g))),b={current:()=>{}};ye(()=>{b.current();let k=()=>{ne(f,c(),!0),ne(u,d(),!0)};k(),b.current=e.diffFile.subscribe(k)}),We(()=>b.current()),Pi({selector:()=>a(l),wrapper:()=>a(l),side:()=>a(y),enable:()=>!!(a(w)&&a(i))});var E=me(),x=te(E);{var S=k=>{var h=ev(),m=D(h),A=D(m);{var N=q=>{var Y=me(),ve=te(Y);{var U=M=>{var ee=Jg(),ae=D(ee);Ct(ae,{className:"fill-current"}),T(ee),we("click",ee,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(M,ee)},B=M=>{var ee=qg(),ae=D(ee);$t(ae,{className:"fill-current"}),T(ee),we("click",ee,()=>e.diffFile.onSplitHunkExpand("down",e.index)),C(M,ee)},R=M=>{var ee=Kg(),ae=D(ee);Sn(ae,{className:"fill-current"}),T(ee),we("click",ee,()=>e.diffFile.onSplitHunkExpand("all",e.index)),C(M,ee)},O=M=>{var ee=Xg(),ae=te(ee),ie=D(ae);$t(ie,{className:"fill-current"}),T(ae);var re=J(ae,2),Z=D(re);Ct(Z,{className:"fill-current"}),T(re),we("click",ae,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",re,()=>e.diffFile.onSplitHunkExpand("up",e.index)),C(M,ee)};Q(ve,M=>{a(p)?M(U):a(v)?M(B,1):a(u)?M(R,2):M(O,-1)})}C(q,Y)},$=q=>{var Y=Zg();C(q,Y)};Q(A,q=>{a(s)?q(N):q($,-1)})}T(m);var P=J(m),X=D(P),z=Le(X,!0);T(P),T(h),lt(h,()=>q=>ne(i,q,!0)),K(()=>{G(h,"data-line",`${e.lineNumber}-hunk`),G(h,"data-side",H[e.side]),V(h,`background-color: var(${fn})`),V(m,`
				background-color: var(${Wn});
				color: var(${ct});
				width: var(${Te});
				min-width: var(${Te});
			...
			`),V(P,`background-color: var(${fn})`),V(X,`
					color: var(${zn})
				`),$e(z,a(r)?.splitInfo?.plainText||a(r)?.text)}),C(k,h)};Q(x,k=>{(a(f)||a(g))&&k(S)})}C(t,E),fe()}ot(["click"]);var tv=new Set(["$$slots","$$events","$$legacy"]);function Zs(t,e){de(e,!0);let n=he(e,tv),i=I(Qs());var r=me(),o=te(r);{var s=d=>{Wl(d,{get index(){return e.index},get side(){return e.side},get diffFile(){return e.diffFile},get lineNumber(){return e.lineNumber}})},l=d=>{Vl(d,{get index(){return e.index},get side(){return e.side},get diffFile(){return e.diffFile},get lineNumber(){return e.lineNumber}})};Q(o,d=>{a(i)===jt.SplitGitHub||a(i)===jt.Split?d(s):d(l,-1)})}C(t,r),fe()}var nv=new Set(["$$slots","$$events","$$legacy"]),iv=j('<td><div class="diff-line-widget-wrapper sticky left-0 z-[1]"><!></div></td>'),rv=j("<td><div></div></td>"),ov=j('<tr data-state="widget" class="diff-line diff-line-widget"><!></tr>');function Ql(t,e){de(e,!0);let n=he(e,nv),i=ce(null),r=I(Zr()),o=I(kn()),s=I(()=>e.diffFile.getSplitLeftLine(e.index)),l=I(()=>e.diffFile.getSplitRightLine(e.index)),d=I(()=>!!a(s)?.lineNumber&&a(o)?.side===H.old&&a(o)?.lineNumber===a(s)?.lineNumber),u=I(()=>!!a(l)?.lineNumber&&a(o)?.side===H.new&&a(o)?.lineNumber===a(l)?.lineNumber),c=I(()=>e.side===H.old?a(s):a(l)),f=I(()=>a(c)?.isHidden),p=I(()=>`div[data-line="${e.lineNumber}-widget-content"]`),g=I(()=>`tr[data-line="${e.lineNumber}-widget"]`),v=I(()=>e.side===H.old?".old-diff-table-wrapper":".new-diff-table-wrapper"),y=I(()=>e.side===H.old?a(d):a(u)),w=I(()=>H[a(y)?e.side:e.side===H.old?H.new:H.old]),b=I(()=>(!!a(d)||!!a(u))&&!a(f)&&!!a(r)),E=I(()=>a(y)&&!!a(b)),x=()=>{a(o).side=void 0,a(o).lineNumber=void 0};Pi({selector:()=>a(p),wrapper:()=>a(g),side:()=>a(w),enable:()=>!!(a(b)&&a(i))});let S=I(Oi({selector:()=>a(v),enable:()=>!!(a(E)&&a(i))}));var k=me(),h=te(k);{var m=A=>{var N=ov(),$=D(N);{var P=z=>{var q=iv();G(q,"colspan",2);var Y=D(q),ve=D(Y);{var U=B=>{var R=me(),O=te(R);Bt(O,()=>a(r),()=>({diffFile:e.diffFile,side:e.side,lineNumber:a(c)?.lineNumber||0,onClose:x})),C(B,R)};Q(ve,B=>{a(S)>0&&B(U)})}T(Y),T(q),K(()=>{Se(q,1,`diff-line-widget-${H[e.side]}-content p-0`),G(Y,"data-line",`${e.lineNumber}-widget-content`),G(Y,"data-side",H[e.side]),V(Y,` width: ${a(S)}px `)}),C(z,q)},X=z=>{var q=rv();G(q,"colspan",2);var Y=Le(q);K(()=>{Se(q,1,`diff-line-widget-${H[e.side]}-placeholder select-none p-0`),V(q,`background-color: var(${Kt})`),G(Y,"data-line",`${e.lineNumber}-widget-content`),G(Y,"data-side",H[e.side])}),C(z,q)};Q($,z=>{a(y)?z(P):z(X,-1)})}T(N),lt(N,()=>z=>ne(i,z,!0)),K(()=>{G(N,"data-line",`${e.lineNumber}-widget`),G(N,"data-side",H[e.side])}),C(A,N)};Q(h,A=>{a(b)&&A(m)})}C(t,k),fe()}var sv=new Set(["$$slots","$$events","$$legacy"]),av=j("<!> <!> <!> <!>",1),lv=j('<table><colgroup><col/><col/></colgroup><thead class="hidden"><tr><th scope="col"> </th><th scope="col"> </th></tr></thead><tbody class="diff-table-body leading-[1.6]"><!><!></tbody></table>');function ea(t,e){de(e,!0);let n=he(e,sv),i=I(()=>e.side===H.new?"new-diff-table":"old-diff-table"),r=()=>cs(e.diffFile),o=ce(Ee(r())),s={current:()=>{}},l=e.selectState;ye(()=>{s.current();let h=()=>ne(o,r(),!0);h(),s.current=e.diffFile.subscribe(h)}),We(()=>s.current());let d=h=>{let m=h.target;if(m&&m?.nodeName==="BUTTON"){In();return}let A=so(m);if(!(A&&A!==`diff-root${e.diffFile.getId()}`))for(;m&&m instanceof HTMLElement;){let N=m.getAttribute("data-state");if(N){N==="extend"||N==="hunk"||N==="widget"?l.current!==void 0&&(l.current=void 0,e.onSelect?.(void 0),In()):l.current!==e.side&&(l.current=n.side,e.onSelect?.(e.side),In());return}m=m.parentElement}};var u=lv(),c=D(u),f=D(c),p=J(f);T(c);var g=J(c),v=D(g),y=D(v),w=Le(y),b=J(y),E=Le(b);T(v),T(g);var x=J(g),S=D(x);di(S,17,()=>a(o),li,(h,m)=>{var A=av(),N=te(A);Zs(N,{get index(){return a(m).index},get side(){return e.side},get lineNumber(){return a(m).lineNumber},get diffFile(){return e.diffFile}});var $=J(N,2);Gl($,{get index(){return a(m).index},get side(){return e.side},get lineNumber(){return a(m).lineNumber},get diffFile(){return e.diffFile}});var P=J($,2);Ql(P,{get index(){return a(m).index},get side(){return e.side},get lineNumber(){return a(m).lineNumber},get diffFile(){return e.diffFile}});var X=J(P,2);zl(X,{get index(){return a(m).index},get side(){return e.side},get lineNumber(){return a(m).lineNumber},get diffFile(){return e.diffFile}}),C(h,A)});var k=J(S);Zs(k,{get side(){return e.side},get index(){return e.diffFile.splitLineLength},get lineNumber(){return e.diffFile.splitLineLength},get diffFile(){return e.diffFile}}),T(x),T(u),K(()=>{Se(u,1,`${a(i)} w-full border-collapse border-spacing-0`),G(u,"data-mode",H[e.side]),Se(f,1,`diff-table-${H[e.side]}-num-col`),Se(p,1,`diff-table-${H[e.side]}-content-col`),$e(w,`${H[e.side]??""} line number`),$e(E,`${H[e.side]??""} line content`)}),we("mousedown",x,d),C(t,u),fe()}ot(["mousedown"]);var dv=new Set(["$$slots","$$events","$$legacy"]),fv=j('<div class="split-diff-view split-diff-view-normal flex w-full basis-[50%]"><style data-select-style=""></style> <div class="old-diff-table-wrapper diff-table-scroll-container w-full overflow-x-auto overflow-y-hidden"><!></div> <div class="diff-split-line w-[1.5px]"></div> <div class="new-diff-table-wrapper diff-table-scroll-container w-full overflow-x-auto overflow-y-hidden"><!></div></div>');function Yl(t,e){de(e,!0);let n=he(e,dv),i=I(fi()),r=ce(void 0),o=ce(void 0),s=ce(null),l=I(()=>Math.max(e.diffFile.fileLineLength,e.diffFile.splitLineLength).toString()),d={current:()=>{}},u={current:void 0};ye(()=>{if(d.current(),!a(i))return;let A=a(r),N=a(o);!A||!N||(d.current=xu(A,N))}),We(()=>d.current());let f=A=>{let N=a(s);N&&(A?N.textContent=`#${w()} [data-state="extend"] {user-select: none} 
#${w()} [data-state="hunk"] {user-select: none} 
#${w()} [data-state="widget"] {user-select: none}`:N.textContent="")},p=I(Xr()),g=I(()=>({fontSize:`${a(p)||14}px`,fontFamily:"Menlo, Consolas, monospace"})),v=I(oo({text:()=>a(l),font:()=>a(g)})),y=I(()=>Math.max(40,a(v)+25)),w=()=>`diff-split-view-${e.diffFile.getId()}`;var b=fv(),E=D(b);lt(E,()=>A=>ne(s,A,!0));var x=J(E,2),S=D(x);ea(S,{get side(){return H.old},get diffFile(){return e.diffFile},onSelect:f,get selectState(){return u}}),T(x),lt(x,()=>A=>{ne(r,A,!0)});var k=J(x,2),h=J(k,2),m=D(h);ea(m,{get side(){return H.new},get diffFile(){return e.diffFile},onSelect:f,get selectState(){return u}}),T(h),lt(h,()=>A=>{ne(o,A,!0)}),T(b),K((A,N)=>{V(x,A),V(k,`background-color: var(${_n})`),V(h,N)},[()=>`
    ...
    `,()=>`
			...
			font-family: Menlo, Consolas, monospace;
			font-size: var(${nt});
		`]),C(t,b),fe()}var cv=new Set(["$$slots","$$events","$$legacy"]);function Jl(t,e){de(e,!0);let n=he(e,cv),i=I(Ln());var r=me(),o=te(r);{var s=d=>{Ul(d,{get diffFile(){return e.diffFile}})},l=d=>{Yl(d,{get diffFile(){return e.diffFile}})};Q(o,d=>{a(i)?d(s):d(l,-1)})}C(t,r),fe()}var uv=new Set(["$$slots","$$events","$$legacy"]),pv=j('<div class="diff-add-widget-wrapper invisible absolute left-[100%] translate-x-[-50%] select-none transition-transform hover:scale-110 group-hover:visible"><button class="diff-add-widget z-[1] flex h-full w-full origin-center cursor-pointer items-center justify-center rounded-md text-[1.2em]">+</button></div>');function Zo(t,e){de(e,!0);let n=he(e,uv);var i=pv(),r=Le(i);K(()=>{G(i,"data-add-widget",H[e.side]),V(i,`
		width: calc(var(${nt}) * 1.4);
		height: calc(var(${nt}) * 1.4);
		top: calc(var(${nt}) * 0.1);
	`),V(r,`
        ...
        `),G(ie,"data-line-new-num",B().lineNumber),$e(re,B().lineNumber),V(Z,` background-color: var(${Cl}) `)}),C(U,R)};var X=vv(),z=te(X);{var q=U=>{$(U,()=>({index:e.lineNumber,enableWrap:a(r),diffFile:e.diffFile,rawLine:a(i)?.value||"",diffLine:a(i)?.diff,plainLine:a(v),syntaxLine:a(p),enableHighlight:a(l),enableAddWidget:a(d),lineNumber:a(i).oldLineNumber||0,onOpenAddWidget:w,onAddWidgetClick:a(s)}))};Q(z,U=>{a(i).oldLineNumber&&U(q)})}var Y=J(z,2);{var ve=U=>{P(U,()=>({index:e.lineNumber,enableWrap:a(r),diffFile:e.diffFile,rawLine:a(i)?.value||"",diffLine:a(i)?.diff,plainLine:a(v),syntaxLine:a(p),enableHighlight:a(l),enableAddWidget:a(d),lineNumber:a(i).newLineNumber||0,onOpenAddWidget:w,onAddWidgetClick:a(s)}))};Q(Y,U=>{a(i).newLineNumber&&U(ve)})}C(N,X)},A=N=>{var $=_v(),P=D($),X=D(P);{var z=M=>{{let ee=I(()=>a(i)?.newLineNumber||0);Zo(M,{get index(){return e.index},get diffFile(){return e.diffFile},get lineNumber(){return a(ee)},get side(){return H.new},onOpenAddWidget:w,get onWidgetClick(){return a(s)}})}};Q(X,M=>{a(d)&&a(i)?.diff&&M(z)})}var q=J(X,2),Y=D(q),ve=Le(Y,!0),U=J(Y,4),B=Le(U,!0);T(q),T(P);var R=J(P),O=D(R);{let M=I(()=>!!a(r)),ee=I(()=>!!a(l)),ae=I(()=>a(i)?.value||""),ie=I(()=>a(i)?.diff);ci(O,{get enableWrap(){return a(M)},get diffFile(){return e.diffFile},get enableHighlight(){return a(ee)},get rawLine(){return a(ae)},get diffLine(){return a(ie)},get plainLine(){return a(v)},get syntaxLine(){return a(p)}})}T(R),T($),K(()=>{G($,"data-line",e.lineNumber),G($,"data-state",a(i)?.diff?"diff":"plain"),V(P,`
				...
				`),G(Y,"data-line-old-num",a(i)?.oldLineNumber||0),$e(ve,a(i)?.oldLineNumber||0),G(U,"data-line-new-num",a(i)?.newLineNumber||0),$e(B,a(i)?.newLineNumber||0),V(R,`
					background-color: ${a(i)?.diff?`var(${Fl})`:`var(${Js})`}
				`)}),C(N,$)};Q(h,N=>{a(c)?N(m):N(A,-1)})}C(S,k)};Q(E,S=>{a(u)||S(x)})}C(t,b),fe()}var bv=new Set(["$$slots","$$events","$$legacy"]),wv=j('<tr data-state="extend" class="diff-line diff-line-extend"><td class="diff-line-extend-content p-0 align-top"><div class="diff-line-extend-wrapper sticky left-0 z-[1]"><!> <!></div></td></tr>');function Kl(t,e){de(e,!0);let n=he(e,bv),i=I(eo()),r=I(Ln()),o=I(to()),s=I(()=>e.diffFile.getUnifiedLine(e.index)),l=I(()=>a(i)?.oldFile?.[a(s)?.oldLineNumber||-1]),d=I(()=>a(i)?.newFile?.[a(s)?.newLineNumber||-1]),u=I(()=>a(s).isHidden),c=I(()=>!!((a(l)||a(d))&&a(u)&&a(o))),f=I(Oi({selector:()=>".unified-diff-table-wrapper",enable:()=>a(c)}));var p=me(),g=te(p);{var v=y=>{var w=wv(),b=D(w);G(b,"colspan",2);var E=D(b),x=D(E);{var S=m=>{var A=me(),N=te(A);Bt(N,()=>a(o),()=>({diffFile:e.diffFile,side:H.old,data:a(l)?.data,lineNumber:a(s)?.oldLineNumber||0,onUpdate:()=>e.diffFile.notifyAll()})),C(m,A)};Q(x,m=>{(a(r)||a(f)>0)&&a(l)&&a(o)&&m(S)})}var k=J(x,2);{var h=m=>{var A=me(),N=te(A);Bt(N,()=>a(o),()=>({diffFile:e.diffFile,side:H.new,data:a(d)?.data,lineNumber:a(s)?.newLineNumber||0,onUpdate:()=>e.diffFile.notifyAll()})),C(m,A)};Q(k,m=>{(a(r)||a(f)>0)&&a(d)&&a(o)&&m(h)})}T(E),T(b),T(w),K(()=>{G(w,"data-line",`${e.lineNumber}-extend`),V(E,`width: ${a(f)}px `)}),C(y,w)};Q(g,y=>{a(c)&&y(v)})}C(t,p),fe()}var xv=new Set(["$$slots","$$events","$$legacy"]),yv=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),Ev=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),Av=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),Lv=j('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),kv=j('<div class="min-h-[28px]">&ensp;</div>'),Iv=j('<tr data-state="hunk" class="diff-line diff-line-hunk"><td class="diff-line-hunk-action sticky left-0 w-[1%] min-w-[100px] select-none"><!></td><td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td></tr>');function ta(t,e){de(e,!0);let n=he(e,xv),i=I(()=>e.diffFile.getUnifiedHunkLine(e.index)),r=I(()=>e.diffFile.getExpandEnabled()),o=I(()=>a(r)&&a(i)&&a(i).unifiedInfo),s=I(Ln()),l=()=>a(i)&&a(i).unifiedInfo&&a(i).unifiedInfo.startHiddenIndex<a(i).unifiedInfo.endHiddenIndex,d=ce(Ee(l())),u=()=>a(i)&&a(i).unifiedInfo&&a(i).unifiedInfo.endHiddenIndex-a(i).unifiedInfo.startHiddenIndex<je,c=ce(Ee(u())),f=I(()=>a(i)&&a(i).isFirst),p=I(()=>a(i)&&a(i).isLast),g=I(()=>a(i)&&e.diffFile._getIsPureDiffRender()&&!a(i).unifiedInfo),v={current:()=>{}};ye(()=>{v?.current?.();let E=()=>{ne(d,l(),!0),ne(c,u(),!0)};E(),v.current=e.diffFile.subscribe(E)}),We(()=>v.current());var y=me(),w=te(y);{var b=E=>{var x=Iv(),S=D(x),k=D(S);{var h=P=>{var X=me(),z=te(X);{var q=B=>{var R=yv(),O=D(R);Ct(O,{className:"fill-current"}),T(R),we("click",R,()=>e.diffFile.onUnifiedHunkExpand("up",e.index)),C(B,R)},Y=B=>{var R=Ev(),O=D(R);$t(O,{className:"fill-current"}),T(R),we("click",R,()=>e.diffFile.onUnifiedHunkExpand("down",e.index)),C(B,R)},ve=B=>{var R=Av(),O=D(R);Sn(O,{className:"fill-current"}),T(R),we("click",R,()=>e.diffFile.onUnifiedHunkExpand("all",e.index)),C(B,R)},U=B=>{var R=Lv(),O=te(R),M=D(O);$t(M,{className:"fill-current"}),T(O);var ee=J(O,2),ae=D(ee);Ct(ae,{className:"fill-current"}),T(ee),we("click",O,()=>e.diffFile.onUnifiedHunkExpand("down",e.index)),we("click",ee,()=>e.diffFile.onUnifiedHunkExpand("up",e.index)),C(B,R)};Q(z,B=>{a(f)?B(q):a(p)?B(Y,1):a(c)?B(ve,2):B(U,-1)})}C(P,X)},m=P=>{var X=kv();C(P,X)};Q(k,P=>{a(o)?P(h):P(m,-1)})}T(S);var A=J(S),N=D(A),$=Le(N,!0);T(A),T(x),K(()=>{G(x,"data-line",`${e.lineNumber}-hunk`),V(S,`
				background-color: var(${Wn});
				color: var(${ct});
				width: calc(calc(var(${Te}) + 5px) * 2);
				max-width: calc(calc(var(${Te}) + 5px) * 2);
			...
			`),V(A,` background-color: var(${fn}) `),V(N,`
					...
					color: var(${zn});
				`),$e($,a(i)?.unifiedInfo?.plainText||a(i)?.text)}),C(E,x)};Q(w,E=>{(a(d)||a(g))&&E(b)})}C(t,y),fe()}ot(["click"]);var Sv=new Set(["$$slots","$$events","$$legacy"]),Nv=j('<tr data-state="widget" class="diff-line diff-line-widget"><td class="diff-line-widget-content p-0"><div class="diff-line-widget-wrapper sticky left-0 z-[1]"><!> <!></div></td></tr>');function Xl(t,e){de(e,!0);let n=he(e,Sv),i=I(kn()),r=I(Ln()),o=I(Zr()),s=I(()=>e.diffFile.getUnifiedLine(e.index)),l=I(()=>a(s)?.oldLineNumber&&a(i)?.side===H.old&&a(i)?.lineNumber===a(s)?.oldLineNumber),d=I(()=>a(s)?.newLineNumber&&a(i)?.side===H.new&&a(i)?.lineNumber===a(s)?.newLineNumber),u=I(()=>a(s)?.isHidden),c=I(()=>!!((a(l)||a(d))&&!a(u)&&a(o))),f=()=>{a(i).side=void 0,a(i).lineNumber=void 0},p=I(Oi({selector:()=>".unified-diff-table-wrapper",enable:()=>a(c)}));var g=me(),v=te(g);{var y=w=>{var b=Nv(),E=D(b);G(E,"colspan",2);var x=D(E),S=D(x);{var k=A=>{var N=me(),$=te(N);Bt($,()=>a(o),()=>({diffFile:e.diffFile,side:H.old,lineNumber:a(s)?.oldLineNumber||0,onClose:f})),C(A,N)};Q(S,A=>{(a(r)||a(p)>0)&&a(l)&&A(k)})}var h=J(S,2);{var m=A=>{var N=me(),$=te(N);Bt($,()=>a(o)??ht,()=>({diffFile:e.diffFile,side:H.new,lineNumber:a(s)?.newLineNumber||0,onClose:f})),C(A,N)};Q(h,A=>{(a(r)||a(p)>0)&&a(d)&&A(m)})}T(x),T(E),T(b),K(()=>{G(b,"data-line",`${e.lineNumber}-widget`),V(x,`width: ${a(p)}px`)}),C(w,b)};Q(v,w=>{a(c)&&w(y)})}C(t,g),fe()}var Cv=new Set(["$$slots","$$events","$$legacy"]),$v=j("<!> <!> <!> <!>",1),Tv=j('<div><style data-select-style=""></style> <div class="unified-diff-table-wrapper diff-table-scroll-container w-full overflow-x-auto overflow-y-hidden"><table><colgroup><col class="unified-diff-table-num-col"/><col class="unified-diff-table-content-col"/></colgroup><thead class="hidden"><tr><th scope="col">line number</th><th scope="col">line content</th></tr></thead><tbody class="diff-table-body leading-[1.6]"><!><!></tbody></table></div></div>');function Zl(t,e){de(e,!0);let n=he(e,Cv),i=ce(Ee(Sa(e.diffFile))),r=ce(Ee(e.diffFile.unifiedLineLength.toString())),o=ce(null),s=I(Xr()),l=I(Ln()),d={current:()=>{}},u={current:void 0},c=()=>{let h=e.diffFile;ne(i,Sa(h),!0),ne(r,h.unifiedLineLength.toString(),!0)};ye(()=>{d.current?.(),c(),d.current=e.diffFile.subscribe(c)}),We(()=>d.current());let f=h=>{let m=h.target;if(!a(o))return;if(m&&m?.nodeName==="BUTTON"){In();return}let A=so(m);if(!(A&&A!==`diff-root${e.diffFile.getId()}`))for(;m&&m instanceof HTMLElement;){let N=m.getAttribute("data-state");if(N){N==="extend"||N==="hunk"||N==="widget"?u.current!==!1&&(u.current=!1,a(o).innerHTML="",In()):u.current!==!0&&(u.current=!0,a(o).innerHTML=`#${A} [data-state="extend"] {user-select: none} 
#${A} [data-state="hunk"] {user-select: none} 
#${A} [data-state="widget"] {user-select: none}`,In());return}m=m.parentElement}},p=I(()=>({fontSize:a(s)+"px",fontFamily:"Menlo, Consolas, monospace"})),g=I(oo({text:()=>a(r),font:()=>a(p)})),v=I(()=>Math.max(40,a(g)+10));var y=Tv(),w=D(y);lt(w,()=>h=>ne(o,h,!0));var b=J(w,2),E=D(b),x=J(D(E),2),S=D(x);di(S,17,()=>a(i),li,(h,m)=>{var A=$v(),N=te(A);ta(N,{get index(){return a(m).index},get lineNumber(){return a(m).lineNumber},get diffFile(){return e.diffFile}});var $=J(N,2);ql($,{get index(){return a(m).index},get lineNumber(){return a(m).lineNumber},get diffFile(){return e.diffFile}});var P=J($,2);Xl(P,{get index(){return a(m).index},get lineNumber(){return a(m).lineNumber},get diffFile(){return e.diffFile}});var X=J(P,2);Kl(X,{get index(){return a(m).index},get lineNumber(){return a(m).lineNumber},get diffFile(){return e.diffFile}}),C(h,A)});var k=J(S);ta(k,{get index(){return e.diffFile.unifiedLineLength},get lineNumber(){return e.diffFile.unifiedLineLength},get diffFile(){return e.diffFile}}),T(x),T(E),T(b),T(y),K(h=>{Se(y,1,`unified-diff-view ${a(l)?"unified-diff-view-wrap":"unified-diff-view-normal"} w-full`),V(b,h),Se(E,1,`unified-diff-table w-full border-collapse border-spacing-0 ${a(l)?"table-fixed":""}`)},[()=>`${Te}: ${Math.round(a(v))}px; font-family: Menlo, Consolas, monospace; font-size: var(${nt})`]),we("mousedown",x,f),C(t,y),fe()}ot(["mousedown"]);var Dv=new Set(["$$slots","$$events","$$legacy"]),Fv=j('<div class="diff-tailwindcss-wrapper" data-component="git-diff-view"><div class="diff-style-root"><div><!></div></div></div>');function na(t,e){de(e,!0);let n=he(e,Dv),i={current:null},o=I(()=>{if(i.current?.clear?.(),e.diffFile){let h=Xi.createInstance({});return h._mergeFullBundle(e.diffFile._getFullBundle()),i.current=h,h}else if(e.data){let h=e.data,m=new Xi(h.oldFile?.fileName||"",h.oldFile?.content||"",h.newFile?.fileName||"",h.newFile?.content||"",h.hunks||[],h.oldFile?.fileLang||"",h.newFile?.fileLang||"");return i.current=m,m}return null});ye(()=>{e.onDiffFileCreated?.(a(o))});let l=I(()=>a(o)?.getId?.()),d=Ee({side:e.initialWidgetState?.side,lineNumber:e.initialWidgetState?.lineNumber}),u=ce(null),c=I(()=>e.diffViewHighlight??!0),f=I(()=>e.diffViewTheme);ye(()=>{d.side=e.initialWidgetState?.side,d.lineNumber=e.initialWidgetState?.lineNumber}),ye(()=>{(e.data||e.diffFile)&&(d.side=void 0,d.lineNumber=void 0)});let p={current:()=>{}},g=I(fi());ye(()=>{p?.current?.(),!(!a(g)||!a(o)||!e.diffFile)&&(e.diffFile._addClonedInstance(a(o)),p.current=()=>e.diffFile?._delClonedInstance(a(o)))}),We(()=>p.current()),ye(()=>{!a(o)||!a(g)||(a(o).initTheme(a(f)),a(o).initRaw(),a(o).buildSplitDiffLines(),a(o).buildUnifiedDiffLines())}),ye(()=>{if(!(!a(o)||!a(g))&&(a(f),a(c))){let h=e.registerHighlighter;h?(h.name!==a(o)._getHighlighterName()||h.type!==a(o)._getHighlighterType()||h.type!=="class")&&(a(o).initSyntax({registerHighlighter:h}),a(o).notifyAll()):(!a(o)._getIsCloned()&&a(o)._getHighlighterName()!==vr.name||a(o)._getHighlighterType()!=="class")&&(a(o).initSyntax(),a(o).notifyAll())}});let b={current:()=>{}};ye(()=>{if(b?.current?.(),!a(g)||!a(o)||!a(u))return;a(f);let h=()=>{a(u)?.setAttribute("data-theme",a(o)._getTheme()||"light"),a(u)?.setAttribute("data-highlighter",a(o)._getHighlighterName())};h(),b.current=a(o).subscribe(h)}),We(()=>b.current()),Kc(n),Zc(n),tu(n),cu(n),pu(n),mu(n),vu(n),bu(n),du(d),au(n),iu(()=>a(o)?.getId()||""),ou(()=>a(u));var x=me(),S=te(x);{var k=h=>{var m=Fv(),A=D(m),N=D(A),$=D(N);{var P=z=>{Jl(z,{get diffFile(){return a(o)}})},X=z=>{Zl(z,{get diffFile(){return a(o)}})};Q($,z=>{!e.diffViewMode||e.diffViewMode&jt.Split?z(P):z(X,-1)})}T(N),T(A),T(m),lt(m,()=>z=>ne(u,z,!0)),K((z,q)=>{G(m,"data-theme",z),G(m,"data-highlighter",q),V(A,`${nt}:${e.diffViewFontSize||14}px`),G(N,"id",a(g)?`diff-root${a(l)}`:void 0),Se(N,1,"diff-view-wrapper"+(e.class?` ${e.class}`:"")),V(N,e.style)},[()=>a(o)?._getTheme()||"light",()=>a(o)?._getHighlighterName()]),C(h,m)};Q(S,h=>{a(o)&&h(k)})}C(t,x),fe()}fs.name="@git-diff-view/svelte";function Cu(t){let e=/[.*+?^${}()|[\]\\]/g;return t.replace(e,"\\$&")}function $u(t,e){if(t.length!==e.length)return!1;for(let n=0;n<t.length;n++)if(t[n]!==e[n])return!1;return!0}function Tu(t){if(!t)return!1;let e=Date.now()-1440*60*1e3;return t*1e3>e}function Li(){let t=L;t.currentSubjectData=null,t.currentItemId=null,t.currentWcode=null,t.currentTags=null,t.currentSeries=null,t.currentCommitMessage=null,t.currentFieldUpdates=null,t.currentTagUpdates=null,t.currentSeriesUpdate=null}var Du={Album:["中文名","别名","艺术家","作曲","编曲","作词","厂牌","发售日期","价格","版本特性","播放时长","录音","碟片数量","链接"],Anime:["中文名","别名","上映年度","片长","官方网站","链接","其他","Copyright"],Book:["中文名","别名","作者","插图","出版社","价格","其他出版社","连载杂志","发售日","页数","ISBN","链接","其他"],BookSeries:["中文名","别名","出版社","连载杂志","开始","结束","册数","话数","原作","链接","其他"],Crt:["简体中文名","别名","性别","生日","血型","身高","体重","BWH","引用来源"],Game:["中文名","别名","平台","游戏类型","游戏引擎","游玩人数","发行日期","售价","开发","发行","剧本","程序","website","链接"],Manga:["中文名","别名","作者","作画","脚本","原作","出版社","价格","其他出版社","连载杂志","发售日","册数","页数","话数","ISBN","链接","其他"],Movie:["中文名","别名","上映年度","片长","官方网站","链接","其他","Copyright"],Novel:["中文名","别名","作者","插图","出版社","价格","连载杂志","发售日","册数","页数","话数","ISBN","链接","其他"],OVA:["中文名","别名","话数","发售日","官方网站","开始","结束","链接","其他"],PhotoBook:["中文名","别名","作者","摄影","出版社","价格","其他出版社","连载杂志","发售日","页数","ISBN","链接","其他"],TV:["中文名","别名","集数","季数","放送星期","开始","结束","主演","导演","音乐","原作","制作","类型","国家/地区","语言","每集长","在线播放平台","电视网","电视台","频道","视频制式","音频制式","首播国家","首播地区","台湾名称","港澳名称","马新名称","官方网站","链接","imdb_id","tvdb_id"],TVAnime:["中文名","别名","话数","放送开始","放送星期","官方网站","在线播放平台","播放电视台","其他电视台","播放结束","导演","音乐","链接","其他","Copyright"],doujinBook:["作者","原作","CP","语言","页数","尺寸","价格","发售日"],doujinGame:["别名","开发者","原作","平台","游戏类型","游戏引擎","游玩人数","语言","价格","发售日"],doujinMusic:["艺术家","原作","语言","版本特性","碟片数量","播放时长","价格","发售日"],realMovie:["中文名","别名","上映日","片长","类型","国家/地区","语言","官方网站","链接","imdb_id","tmdb_id","tvdb_id"]},Fu={Album:"Album","animanga/Anime":"Anime","animanga/Book":"Book","animanga/BookSeries":"BookSeries",Crt:"Crt",Game:"Game","animanga/Manga":"Manga","animanga/Movie":"Movie","animanga/Novel":"Novel","animanga/OVA":"OVA","Book/PhotoBook":"PhotoBook","real/Television":"TV","animanga/TVAnime":"TVAnime","doujin/Book":"doujinBook","doujin/Game":"doujinGame","doujin/Album":"doujinMusic","real/Movie":"realMovie"};function ed(){return L.theme==="dark"?"dark":L.theme==="light"?"light":window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function Mu(){return L.entityType||"subject"}function td(){if(!L.currentSubjectData)return!1;let t=Mu(),n=document.getElementById("static-wcode-input").value.replace(/\r\n/g,`
`).replace(/\r/g,`
`).trim(),r=(L.currentSubjectData.infobox||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).trim(),o=n!==r;if(t==="subject"){let l=document.getElementById("static-tags-input").value.split(" ").filter(g=>g),d=document.getElementById("static-series-checkbox").checked,u=L.currentSubjectData.metaTags||[],c=L.currentSubjectData.series||!1,f=!$u(l,u);return o||f||d!==c}return o}function ji(){let t=document.querySelector("#static-buttons-container button#process-confirm-update");if(!t)return;td()?(t.textContent="确认更新",t.disabled=!1):(t.textContent="确认更新（无实质修改）",t.disabled=!1)}function ao(t,e,n,i){let r=Object.keys(t||{}),o=[];return r.length&&o.push(`更新${r.join("、")}`),(i==="subject"||!i)&&(e?.add.length&&o.push(`添加标签${e.add.join("、")}`),e?.remove.length&&o.push(`删除标签${e.remove.join("、")}`),n?.hasUpdate&&o.push(n.newValue?"标记为系列":"取消系列标记")),o.filter(s=>s).join("；")||"更新条目信息"}function lo(t,e,n){try{let i=(t||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`),r=(e||"").replace(/\r\n/g,`
`).replace(/\r/g,`
`),l=hf("编辑前",i,"编辑后",r,"text","text",{context:1});l.init(),l.buildSplitDiffLines();let d=document.getElementById(n);if(!d)return;let u=d._diffViewInstance;u&&Vo(u),d.innerHTML="";let c=Kr(na,{target:d,props:{diffFile:l,diffViewMode:L.diffViewMode==="unified"?jt.Unified:jt.Split,diffViewFontSize:13,diffViewTheme:ed(),diffViewHighlight:!0,diffViewWrap:!0}});d._diffViewInstance=c,n==="static-content-diff-container"&&setTimeout(()=>{let p=document.getElementById("static-wcode-input");p&&(p.style.height="")},0);let f=document.getElementById("diff-error");f&&(f.style.display="none")}catch(i){console.error("Diff generation error:",i);let r=document.getElementById("diff-error");r&&(r.textContent=`差异显示错误: ${i.message}`,r.style.display="block")}}function nd(){let t=L.currentSubjectData;if(!t)return;let e=Mu(),n=t.infobox||"",i=document.getElementById("static-wcode-input")?.value;if(i!==void 0&&lo(n,i,"static-content-diff-container"),e==="subject"){let r=t.metaTags||[],o=document.getElementById("static-tags-input")?.value.split(" ").filter(s=>s);o!==void 0&&es(r,o,"static-tags-diff-container")}}function es(t,e,n){let i=t.join(`
`),r=e.join(`
`);lo(i,r,n)}function Hu(t,e){let n={};return Object.keys(t).forEach(i=>{if(!["id","tags","series","type","infobox"].includes(i.toLowerCase())){let r=t[i];r!==void 0&&(n[i]=r)}}),n}function Bu(t){let e=Object.keys(t).find(i=>i.toLowerCase()==="infobox");if(!e)return null;let n=t[e]?.replaceAll("\\n",`
`);return!n||!n.trim()?null:n}function Ru(t,e){if(L.entityType!=="subject")return{add:[],remove:[]};let i=(t.tags||"").split(" ").filter(s=>s),r=[],o=[];return i.forEach(s=>{s.startsWith("-")?o.push(s.slice(1)):r.push(s)}),{add:r,remove:o}}function Ou(t,e){if(L.entityType!=="subject")return{hasUpdate:!1};if(t.series===void 0||t.series===null||t.series==="")return{hasUpdate:!1};let n=t.series.trim().toLowerCase(),i=n==="true"||n==="1"||n==="yes";return{hasUpdate:i!==e,newValue:i}}function Mv(t){let e=t.match(/{{Infobox\s+(.+?)$/m);return e&&Fu[e[1]]||null}function Hv(t,e,n){for(let i=1;i<t.length;i++){let r=t[i].match(/^\|([^|=]+?)\s*=/);if(r&&e.indexOf(r[1])>n)return i}return t.length-1}function Pu(t,e){let n=Mv(t),i=n?Du[n]:null,r=t,o=[];if(Object.entries(e).forEach(([s,l])=>{l=l.replaceAll("\\n",`
`);let d=new RegExp(`\\|${Cu(s)}\\s*=.*`,"i");d.test(r)?r=r.replace(d,`|${s}= ${l}`):o.push({field:s,value:l,fieldIdx:i?i.indexOf(s):-1})}),o.length>0){i&&o.sort((l,d)=>l.fieldIdx===-1&&d.fieldIdx===-1?0:l.fieldIdx===-1?1:d.fieldIdx===-1?-1:l.fieldIdx-d.fieldIdx);let s=r.split(`
`);for(let l=o.length-1;l>=0;l--){let d=o[l];i&&d.fieldIdx>=0?s.splice(Hv(s,i,d.fieldIdx),0,`|${d.field}= ${d.value}`):s.splice(-1,0,`|${d.field}= ${d.value}`)}r=s.join(`
`)}return r}function ju(t,e){let n=new Set(t);return e.add.forEach(i=>n.add(i)),e.remove.forEach(i=>n.delete(i)),[...n]}var Gu=hd(Uu());function zu(t,e){try{L.csvData=Bv(t),L.currentIndex=0,L.retryCount={},L.previousItem=null,L.csvPersistDenied=!1;let n=la();localStorage.setItem("bgmCurrentIndex","0"),Vn(),en(e+"加载成功"+(n?"":"（内存模式：刷新页面后需重新加载）"))}catch(n){en("CSV解析错误: "+n.message),console.error(n)}finally{Zt(),document.querySelectorAll("#static-buttons-container button").forEach(n=>{n.disabled=!1})}}function Wu(t){let n=t.target.files?.[0];if(!n)return;document.querySelectorAll("#static-buttons-container button").forEach(r=>{r.disabled=!0}),zi("正在解析CSV文件...");let i=new FileReader;i.onload=function(r){let o=r.target.result;zu(o,"CSV文件")},i.readAsText(n)}function Vu(t){document.querySelectorAll("#static-buttons-container button").forEach(e=>{e.disabled=!0}),zi("正在解析粘贴的CSV..."),zu(t,"粘贴的CSV")}function Bv(t){let e=Gu.default.parse(t,{header:!0,skipEmptyLines:!0,transform:s=>s.trim()});if(e.errors.length){let s=e.errors[0];throw new Error(`第${s.row!==void 0?s.row+1:"?"}行: ${s.message}`)}let n=e.meta.fields;if(!n||n.length===0)throw new Error("CSV文件为空或格式错误");let i=n.find(s=>/^(person_id|character_id|id)$/i.test(s));if(!i)throw new Error('CSV必须包含"id"、"person_id"或"character_id"列');L.entityType="subject",/^person_id$/i.test(i)?L.entityType="person":/^character_id$/i.test(i)&&(L.entityType="character");let r=n.filter(s=>s!==i),o=[];for(let s of e.data){let l=s[i]?.trim();if(!l)continue;let d={id:l};for(let u of r){let c=s[u];c!==void 0&&(d[u]=c.trim())}o.push(d)}if(o.length===0)throw new Error("未找到有效的数据行");return o}function Vn(){L.currentView="setup",L.processing=!1,L.paused=!0,Li(),Zt();let t=document.getElementById("core-content"),e=document.getElementById("static-buttons-container");document.getElementById("edit-regions").style.display="none",md(),t&&(t.innerHTML=`
            <div>
        ...
        `);let n=document.getElementById("setup-access-token");n&&n.addEventListener("input",f=>{L.accessToken=f.target.value,GM_setValue("bgmAccessToken",L.accessToken)});let i=document.getElementById("setup-formhash");i&&i.addEventListener("input",f=>{L.formhash=f.target.value,GM_setValue("bgmFormhash",L.formhash)});let r=document.getElementById("setup-fetch-formhash");r&&r.addEventListener("click",()=>{i&&(r.disabled=!0,r.innerHTML='<i class="fas fa-spinner fa-pulse"></i> 获取中...',GM.xmlHttpRequest({method:"GET",url:"https://bgm.tv/subject/1/edit_detail",onload:f=>{try{let p=f.responseText.match(/<input[^>]*name="formhash"[^>]*value="([^"]+)"/);p&&p[1]?(L.formhash=p[1],GM_setValue("bgmFormhash",L.formhash),i.value=p[1]):alert("无法从页面提取 formhash，请确保已登录 Bangumi")}catch{alert("解析编辑页面失败")}finally{r.disabled=!1,r.innerHTML='<i class="fas fa-magic"></i> 自动获取'}},onerror:()=>{alert("网络请求失败，请手动获取 formhash"),r.disabled=!1,r.innerHTML='<i class="fas fa-magic"></i> 自动获取'}}))}),document.querySelectorAll('input[name="submit-method"]').forEach(f=>{f.addEventListener("change",p=>{L.submitMethod=p.target.value,GM_setValue("bgmSubmitMethod",L.submitMethod);let g=document.getElementById("patch-method-options"),v=document.getElementById("post-method-options");g&&g.classList.toggle("hidden",L.submitMethod!=="patch"),v&&v.classList.toggle("hidden",L.submitMethod!=="post")})}),document.querySelectorAll('input[name="diff-view-mode"]').forEach(f=>{f.addEventListener("change",p=>{L.diffViewMode=p.target.value,localStorage.setItem("bgmDiffViewMode",L.diffViewMode)})});let l=document.getElementById("setup-csv-file");l&&(l.addEventListener("change",Wu),l.addEventListener("change",()=>{let f=l.files?.[0]?.name||"",p=document.getElementById("setup-csv-file-name");p&&(p.textContent=f)}));let d=document.getElementById("setup-csv-btn");d&&l&&d.addEventListener("click",f=>{f.preventDefault(),l.click()});let u=document.getElementById("setup-paste-csv-btn");u&&u.addEventListener("click",async()=>{try{let f=await navigator.clipboard.readText();if(!f||!f.trim()){en("剪贴板内容不是有效的CSV");return}let p=document.getElementById("setup-csv-file-name");p&&(p.textContent="已从剪贴板粘贴"),Vu(f)}catch(f){en("读取剪贴板失败: "+f.message)}});let c=document.getElementById("sync-status");if(c)if(GM_getValue("bgmGistToken","")){let p=GM_getValue("bgmGistId","");c.textContent=p?"已同步 (Gist: "+p.slice(0,8)+"…)":"已授权 GitHub"}else c.textContent="未同步"}function Qu(t){L.currentView="processing";let{currentItem:e,wikiData:n,historyData:i}=t;L.currentSubjectData=n,L.currentItemId=e.id;let r=L.entityType||"subject";L.currentWcode=null,L.currentTags=null,L.currentSeries=null,L.currentCommitMessage=null;let o=document.getElementById("core-content"),s=document.getElementById("static-buttons-container"),l=document.getElementById("edit-regions");l&&(l.style.display="block"),po(),Gi(L.currentIndex,L.totalItems);let d=n.name||"未知名称",u=n.infobox||"",c=r==="subject"?n.metaTags||[]:[],f=r==="subject"&&n.series||!1,p=Hu(e,u),g=Bu(e),v=Ru(e,c),y=Ou(e,f);L.currentFieldUpdates=p,L.currentTagUpdates=v,L.currentSeriesUpdate=y;let w={subject:"条目",character:"角色",person:"人物"},b=document.getElementById("static-last-update"),E=i[0]?.createdAt,x=E?new Date(E*1e3):null,S=i[0]?.creator?.username||"",k=i[0]?.commitMessage||"",h=Tu(E);if(x&&b){let{editPagePath:R}=Ui(r,e.id);b.innerHTML=`
        ...
        `,m.style.display="block"}else m&&(m.style.display="none");let A=document.getElementById("static-commit-input"),N=document.getElementById("static-lock-commit"),$=ao(p,v,y,r);A.value=L.isCommitMessageLocked?L.lockedCommitMessage:$,N.innerHTML=`<i class="fas ${L.isCommitMessageLocked?"fa-lock":"fa-lock-open"}"></i>`,N.title=L.isCommitMessageLocked?"解锁编辑摘要":"固定编辑摘要";let P=document.getElementById("static-wcode-input"),X=document.getElementById("static-content-diff-container"),z=Pu(g??u,p);P.value=z,lo(u,z,"static-content-diff-container"),X&&(X.style.display="block");let q=document.getElementById("static-tags-area"),Y=document.getElementById("static-tags-diff-wrapper");if(r==="subject"){let R=document.getElementById("static-tags-input"),O=ju(c,v);R.value=O.join(" "),es(c,O,"static-tags-diff-container"),q&&(q.style.display="block"),Y&&(Y.style.display="block")}else q&&(q.style.display="none"),Y&&(Y.style.display="none");let ve=document.getElementById("static-series-area");if(r==="subject"){let R=document.getElementById("static-series-checkbox"),O=y.hasUpdate?y.newValue:f;R.checked=O,L.currentSeries=O,ve&&(ve.style.display="block")}else ve&&(ve.style.display="none");let U=Ui(r,e.id).editPagePath.replace("/edit",""),B=w[r]||"条目";o&&(o.innerHTML=`
            <div>
                <div class="item-info">
        ...
        `)}function qu(){L.currentView="completed";let t=document.getElementById("core-content"),e=document.getElementById("static-buttons-container"),n=document.getElementById("edit-regions");n&&(n.style.display="none"),po(),Gi(L.totalItems,L.totalItems),t&&(t.innerHTML=`
            <div>
...
`),f=new FormData;if(f.append("formhash",L.formhash),f.append("editSummary",s),u==="subject")f.append("subject_title",L.currentSubjectData?.name||""),f.append("platform",L.currentSubjectData?.platform||""),f.append("subject_infobox",c),f.append("subject_summary",L.currentSubjectData?.summary||""),f.append("subject_meta_tags",n.join(" ")),f.append("series",i?"1":"0"),f.append("submit","提交");else if(u==="person"){f.append("crt_name",L.currentSubjectData?.name||""),f.append("crt_infobox",c),f.append("crt_summary",L.currentSubjectData?.summary||"");let v=L.currentSubjectData?.profession;if(v)for(let[y,w]of Object.entries(v))w&&f.append(`prsn_pro[${y}]`,"1");f.append("picfile",""),f.append("submit","改好了")}else f.append("crt_name",L.currentSubjectData?.name||""),f.append("crt_infobox",c),f.append("crt_summary",L.currentSubjectData?.summary||""),f.append("picfile",""),f.append("submit","改好了");let p=new URLSearchParams;f.forEach((v,y)=>{p.append(y,v)});let g=u==="subject"?`https://bgm.tv/subject/${t}/new_revision`:`https://bgm.tv/${u}/${t}/edit`;GM.xmlHttpRequest({method:"POST",url:g,data:p.toString(),headers:{"Content-Type":"application/x-www-form-urlencoded"},onload:function(v){Zt(),v.finalUrl===g?d(new Error("更新失败，可能是formhash无效或权限不足")):l()},onerror:function(v){Zt(),d(new Error(`网络错误: ${v.message}`))},onabort:function(){Zt(),d(new Error("请求已中止"))},ontimeout:function(){Zt(),d(new Error("请求超时"))}})}}var Zu="Ov23lifi6y3LGaJ8A53e",ia="wikiBatch-sync.json",ep="wikiBatch 跨设备同步数据";function Wv(){return{version:1,csvData:localStorage.getItem("bgmCsvData")||"null",currentIndex:parseInt(localStorage.getItem("bgmCurrentIndex")||"0"),retryCount:GM_getValue("bgmRetryCount")||"{}",previousItem:localStorage.getItem("bgmPreviousItem"),entityType:localStorage.getItem("bgmEntityType")||"subject",totalItems:parseInt(localStorage.getItem("bgmTotalItems")||"0")}}function Vv(t){try{localStorage.setItem("bgmCsvData",t.csvData),localStorage.setItem("bgmCurrentIndex",t.currentIndex.toString()),localStorage.setItem("bgmEntityType",t.entityType),localStorage.setItem("bgmTotalItems",t.totalItems.toString())}catch{throw new Error("同步数据过大，超出本地存储配额")}GM_setValue("bgmRetryCount",t.retryCount),t.previousItem?localStorage.setItem("bgmPreviousItem",t.previousItem):localStorage.removeItem("bgmPreviousItem")}async function Qv(){return(await Nn("https://github.com/login/device/code",{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({client_id:Zu,scope:"gist"})})).json()}async function Yv(t,e){return new Promise((n,i)=>{let r=e,o=async()=>{let l=await(await Nn("https://github.com/login/oauth/access_token",{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({client_id:Zu,device_code:t,grant_type:"urn:ietf:params:oauth:grant-type:device_code"})})).json();l.access_token?n(l.access_token):l.error==="authorization_pending"?setTimeout(o,r*1e3):l.error==="slow_down"?(r+=5,setTimeout(o,r*1e3)):i(new Error(l.error_description||l.error||"授权失败"))};o()})}async function tp(t){t.textContent="正在获取设备码...";let e;try{e=await Qv()}catch{t.textContent="网络错误，无法连接 GitHub";return}t.innerHTML=`请在打开的页面中输入码: <strong>${e.user_code}</strong>`,GM_openInTab(e.verification_uri);try{let n=await Yv(e.device_code,e.interval);GM_setValue("bgmGistToken",n),t.textContent="授权成功"}catch(n){t.textContent=n.message}}function np(){return GM_getValue("bgmGistId")||null}function sd(t){GM_setValue("bgmGistId",t)}function ra(){return GM_getValue("bgmGistToken")||null}async function Jv(t){let e=ra();if(!e)throw new Error("未授权");return(await(await Nn("https://api.github.com/gists",{method:"POST",headers:{Accept:"application/vnd.github+json",Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({description:ep,public:!1,files:{[ia]:{content:t}}})})).json()).id}async function qv(t,e){let n=ra();if(!n)throw new Error("未授权");await Nn(`https://api.github.com/gists/${t}`,{method:"PATCH",headers:{Accept:"application/vnd.github+json",Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({files:{[ia]:{content:e}}})})}async function ip(){let t=ra();return t&&(await(await Nn("https://api.github.com/gists?per_page=100",{headers:{Accept:"application/vnd.github+json",Authorization:`Bearer ${t}`}})).json()).find(r=>r.description===ep&&r.files?.[ia])?.id||null}async function Kv(t){let e=ra();if(!e)throw new Error("未授权");let r=(await(await Nn(`https://api.github.com/gists/${t}`,{headers:{Accept:"application/vnd.github+json",Authorization:`Bearer ${e}`}})).json()).files?.[ia];if(!r)throw new Error("Gist 中未找到同步数据");if(console.log("[wikiBatch] gist read:",{size:r.size,truncated:r.truncated,hasContent:typeof r.content=="string"}),r.truncated&&r.raw_url){console.log("[wikiBatch] gist content truncated, fetching raw_url...");let o=await Nn(r.raw_url,{headers:{Authorization:`Bearer ${e}`}});if(!o.ok)throw new Error(`读取原始文件失败: HTTP ${o.status}`);let s=await o.text();return console.log("[wikiBatch] gist raw content length:",s.length),s}return r.content}async function rp(){let t=Wv(),e=JSON.stringify(t),n=np();n||(n=await ip(),n&&sd(n)),n?await qv(n,e):(n=await Jv(e),sd(n))}async function op(){let t=np();if(!t){if(t=await ip(),!t)throw new Error("未找到同步 Gist，请先在另一设备上传");sd(t)}let e=await Kv(t);console.log("[wikiBatch] parsed content length:",e.length);let n;try{n=JSON.parse(e)}catch(i){throw console.error("[wikiBatch] JSON.parse failed, content head:",e.slice(0,200)),console.error("[wikiBatch] JSON.parse failed, content tail:",e.slice(-200)),new Error("同步数据解析失败",{cause:i})}Vv(n)}function sp(){GM_deleteValue("bgmGistToken"),GM_deleteValue("bgmGistId")}function ap(t){switch(t){case"setup-start-processing":Ku();break;case"setup-reset-progress":L.currentIndex=0,L.retryCount={},L.previousItem=null,localStorage.setItem("bgmCurrentIndex","0"),Vn();break;case"sync-auth-btn":Xv();break;case"sync-upload-btn":Zv();break;case"sync-download-btn":e_();break;case"sync-clear-btn":sp(),Vn();break}}async function Xv(){let t=document.getElementById("sync-status");if(!t)return;let e=document.getElementById("sync-auth-btn");e&&(e.disabled=!0),await tp(t),e&&(e.disabled=!1),Vn()}async function Zv(){let t=document.getElementById("sync-status");if(t){Cn(),t.textContent="正在上传...";try{await rp(),t.textContent="上传成功: "+new Date().toLocaleString()}catch(e){t.textContent="上传失败: "+e.message}}}async function e_(){let t=document.getElementById("sync-status");if(t){t.textContent="正在下载...";try{await op(),L.csvData=JSON.parse(localStorage.getItem("bgmCsvData")||"null"),L.currentIndex=parseInt(localStorage.getItem("bgmCurrentIndex")||"0"),L.entityType=localStorage.getItem("bgmEntityType")||"subject",L.totalItems=parseInt(localStorage.getItem("bgmTotalItems")||"0"),L.retryCount=JSON.parse(GM_getValue("bgmRetryCount","{}")),L.previousItem=JSON.parse(localStorage.getItem("bgmPreviousItem")||"null"),t.textContent="下载成功: "+new Date().toLocaleString(),Vn()}catch(e){t.textContent="下载失败: "+e.message}}}function lp(t){if(!L.csvData)return;let e=L.csvData[L.currentIndex],n=L.currentSubjectData,i=e?.id||L.currentItemId||"",r=n?.name||"未知名称",o=L.entityType||"subject";function s(){return{id:i,name:r,type:o}}switch(t){case"process-confirm-update":{let l=document.getElementById("static-wcode-input").value,d=o==="subject"?document.getElementById("static-tags-input").value.split(" ").filter(p=>p):[],u=o==="subject"?document.getElementById("static-series-checkbox").checked:!1,c=document.getElementById("static-commit-input").value||ao(L.currentFieldUpdates,L.currentTagUpdates,L.currentSeriesUpdate,o);if(!td()){en("没有检测到实质修改，已跳过更新"),L.previousItem=s(),L.currentIndex++,Li(),Cn(),ui();return}document.querySelectorAll("#static-buttons-container button").forEach(p=>{p.disabled=!0}),zi("正在提交更新..."),Xu(i,l,d,u,r,e,c,()=>{L.previousItem=s(),L.currentIndex++,Li(),Cn(),ui()},p=>{Zt(),document.querySelectorAll("#static-buttons-container button").forEach(g=>{g.disabled=!1}),Ju(p.message)});break}case"process-skip-update":L.previousItem=s(),L.currentIndex++,Li(),Cn(),ui();break;case"process-confirm-continue":L.previousItem=s(),L.currentIndex++,Li(),Cn(),ui();break;case"process-skip-error":L.currentIndex++,Li(),Cn(),ui();break;case"process-retry-error":{let l=L.retryCount[i]||0;en(`正在重试（${l}次）...`),ui();break}case"process-skip-update-fail":L.previousItem=s(),L.currentIndex++,Li(),Cn(),ui();break;case"process-retry-update":{let l=L.retryCount[i]||0;en(`正在重试（${l}次）...`),ui(!0);break}}}function dp(t){t==="completed-back-to-setup"&&(Vn(),t_())}function t_(){let t=document.getElementById("bgm-tool-progress");t&&(t.style.display="none")}var fp="data:image/png;base64,";var mp=7,gp=40,oa=Math.floor(Math.random()*mp),sa="bgm-tool-container",n_="bgm-float-button",fo=null;function ad(){if(fo)return;fo=[];let t=Array.from(document.body.children);for(let e of t){let n=e.id;n===sa||n===n_||e.tagName!=="SCRIPT"&&(fo.push({el:e,origDisplay:e.style.display||""}),e.style.display="none")}}function i_(){if(fo){for(let{el:t,origDisplay:e}of fo)t.style.display=e;fo=null}}function r_(){oa=(oa+1)%mp;let t=document.getElementById("bgm-tool-logo-sprite");t&&(t.style.backgroundPosition=`${-oa*gp}px 0`)}function ld(t){let e=document.getElementById("bgm-tool-container");if(!e)return;t==="dark"||t==="system"&&window.matchMedia("(prefers-color-scheme: dark)").matches?e.setAttribute("data-theme","dark"):e.removeAttribute("data-theme")}function cp(){return window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function up(t){return t==="dark"?"light":"dark"}function o_(){if(L.theme==="system")L.theme=up(cp()),localStorage.setItem("bgmTheme",L.theme);else{let t=up(L.theme);t===cp()?(L.theme="system",localStorage.removeItem("bgmTheme")):(L.theme=t,localStorage.setItem("bgmTheme",L.theme))}ld(L.theme),vp(),L.currentView==="processing"&&nd()}function vp(){let t=document.getElementById("bgm-tool-theme");if(!t)return;let e=ed();t.innerHTML=e==="dark"?'<i class="fas fa-moon"></i>':'<i class="fas fa-sun"></i>',t.title="主题: "+(e==="dark"?"深色":"浅色")}function pp(){let t=document.getElementById("bgm-float-button");return t||(t=document.createElement("div"),t.id="bgm-float-button",t.innerHTML='<i class="fas fa-tools"></i>',document.body.appendChild(t),t.addEventListener("click",()=>{let e=document.getElementById(sa);e&&(e.style.display="flex",ad(),t&&(t.style.display="none"))})),t}function _p(){let t=pp();if(t.style.display="none",document.getElementById(sa)){document.getElementById(sa).style.display="flex",ad();return}let e=document.createElement("div");e.id="bgm-tool-container",e.innerHTML=`
    ...
    `,document.body.appendChild(e),ad(),s_();let n=document.getElementById("bgm-tool-close");n&&n.addEventListener("click",()=>{e.style.display="none",i_();let s=pp();s.style.display="flex",gd(),Cn()});let i=document.getElementById("bgm-tool-settings");i&&i.addEventListener("click",()=>{Vn()});let r=document.getElementById("bgm-tool-theme");r&&r.addEventListener("click",o_);let o=document.getElementById("bgm-tool-header-logo");o&&o.addEventListener("click",r_),ld(L.theme),vp(),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{L.theme==="system"&&(ld("system"),L.currentView==="processing"&&nd())}),a_(),Vn()}function hp(t){t.addEventListener("click",e=>{let n=e.target.closest("button");if(!n)return;let i=n.id;switch(L.currentView){case"setup":ap(i);break;case"processing":lp(i);break;case"completed":dp(i);break}})}function s_(){let t=document.getElementById("static-buttons-container");t&&hp(t);let e=document.getElementById("core-content");e&&hp(e)}function a_(){document.getElementById("static-commit-input").addEventListener("input",o=>{L.currentView==="processing"&&L.currentSubjectData&&(L.currentCommitMessage=o.target.value,ji())});let e=document.getElementById("static-lock-commit");e.addEventListener("click",()=>{if(L.currentView!=="processing"||!L.currentSubjectData)return;L.isCommitMessageLocked=!L.isCommitMessageLocked;let o=document.getElementById("static-commit-input");L.isCommitMessageLocked?(L.lockedCommitMessage=o.value,e.innerHTML='<i class="fas fa-lock"></i>',e.title="解锁编辑摘要"):(e.innerHTML='<i class="fas fa-lock-open"></i>',e.title="固定编辑摘要",L.currentCommitMessage=ao(L.currentFieldUpdates,L.currentTagUpdates,L.currentSeriesUpdate,L.entityType),o.value=L.currentCommitMessage),Cn(),ji()}),document.getElementById("static-wcode-input").addEventListener("input",o=>{L.currentView==="processing"&&L.currentSubjectData&&(L.currentWcode=o.target.value,lo(L.currentSubjectData.infobox||"",o.target.value,"static-content-diff-container"),ji())}),document.getElementById("static-tags-input").addEventListener("input",o=>{L.currentView==="processing"&&L.currentSubjectData&&(L.currentTags=o.target.value,es(L.currentSubjectData.metaTags||[],o.target.value.split(" ").filter(s=>s),"static-tags-diff-container"),ji())}),document.getElementById("static-series-checkbox").addEventListener("change",o=>{L.currentView==="processing"&&L.currentSubjectData&&(L.currentSeries=o.target.checked,ji())})}var bp=`/* stylelint-disable no-descending-specificity */
...
`;var wp=`.diff-tailwindcss-wrapper .\\!container {
	width: 100% !important;
}
...
`;GM_addStyle(bp);GM_addStyle(wp);var dd=document.createElement("link");dd.rel="stylesheet";dd.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css";document.head.appendChild(dd);_p();})();
