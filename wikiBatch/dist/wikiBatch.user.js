...
`)+`
`}function Na(t,e,n,i,r,o,a){if(typeof a=="function"&&(a={callback:a}),a?.callback){let{callback:l}=a;Ca(t,e,n,i,r,o,Object.assign(Object.assign({},a),{callback:d=>{l(d?us(d,a.headerOptions):void 0)}}))}else{let l=Ca(t,e,n,i,r,o,a);return l?us(l,a?.headerOptions):void 0}}function rh(t){let e=t.endsWith(`
`),n=t.split(`
`).map(i=>i+`
