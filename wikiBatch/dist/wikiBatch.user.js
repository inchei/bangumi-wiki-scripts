...
`)+`
`}function Na(t,e,n,i,r,o,a){if(typeof a=="function"&&(a={callback:a}),a?.callback){let{callback:l}=a;Ca(t,e,n,i,r,o,Object.assign(Object.assign({},a),{callback:d=>{l(d?cs(d,a.headerOptions):void 0)}}))}else{let l=Ca(t,e,n,i,r,o,a);return l?cs(l,a?.headerOptions):void 0}}function nh(t){let e=t.endsWith(`
`),n=t.split(`
`).map(i=>i+`
`);return e?n.pop():n.push(n.pop().slice(0,-1)),n}ls.name="@git-diff-view/file";function af(t,e,n,i,r,o,a,l){let d=Na(t,n,e,i,"","",a);return new Xi(t,e,n,i,[d],r,o,l)}var $r;(function(t){t[t.CRLF=1]="CRLF",t[t.CR=2]="CR",t[t.LF=3]="LF",t[t.NEWLINE=4]="NEWLINE",t[t.NORMAL=5]="NORMAL",t[t.NULL=6]="NULL"})($r||($r={}));var Pt;(function(t){t[t.SplitGitHub=1]="SplitGitHub",t[t.SplitGitLab=2]="SplitGitLab",t[t.Split=3]="Split",t[t.Unified=4]="Unified"})(Pt||(Pt={}));typeof window<"u"&&((window.__svelte??={}).v??=new Set).add("5");var Xn={};var Ue=Symbol("uninitialized"),tn=Symbol("filename");var us="http://www.w3.org/1999/xhtml",So="http://www.w3.org/2000/svg",$a="http://www.w3.org/1998/Math/MathML";var lf=globalThis.process?.env?.NODE_ENV,H=lf&&!lf.toLowerCase().startsWith("prod");var vi=Array.isArray,df=Array.prototype.indexOf,Ni=Array.prototype.includes,Dr=Array.from,Da=Object.keys,jt=Object.defineProperty,cn=Object.getOwnPropertyDescriptor,Ta=Object.getOwnPropertyDescriptors,Fa=Object.prototype,ff=Array.prototype,Tr=Object.getPrototypeOf,Ma=Object.isExtensible;var ht=()=>{};function ps(t){for(var e=0;e<t.length;e++)t[e]()}function hs(){var t,e,n=new Promise((i,r)=>{t=i,e=r});return{promise:n,resolve:t,reject:e}}var Yt=Symbol("$state"),ms=Symbol("legacy props"),cf=Symbol(""),gs=Symbol("proxy path"),vs=Symbol("attributes"),Co=Symbol("class"),No=Symbol("style"),$o=Symbol("text");var Ha=Symbol("hmr anchor"),_i=new class extends Error{name="StaleReactionError";message="The reaction that called `getAbortSignal()` was re-run or destroyed"},Ba=!!globalThis.document?.contentType&&globalThis.document.contentType.includes("xml");var Fr=3,un=8;function uf(t){if(H){let e=new Error(`invariant_violation
...
https://svelte.dev/e/lifecycle_outside_component`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/lifecycle_outside_component")}function hf(){if(H){let t=new Error("async_derived_orphan\nCannot create a `$derived(...)` with an `await` expression outside of an effect tree\nhttps://svelte.dev/e/async_derived_orphan");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/async_derived_orphan")}function mf(){if(H){let t=new Error(`derived_references_self
...
https://svelte.dev/e/each_key_duplicate`);throw i.name="Svelte error",i}else throw new Error("https://svelte.dev/e/each_key_duplicate")}function gf(t,e,n){if(H){let i=new Error(`each_key_volatile
...
https://svelte.dev/e/each_key_volatile`);throw i.name="Svelte error",i}else throw new Error("https://svelte.dev/e/each_key_volatile")}function vf(t){if(H){let e=new Error(`effect_in_teardown
\`${t}\` cannot be used inside an effect cleanup function
https://svelte.dev/e/effect_in_teardown`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/effect_in_teardown")}function _f(){if(H){let t=new Error("effect_in_unowned_derived\nEffect cannot be created inside a `$derived` value that was not itself created inside an effect\nhttps://svelte.dev/e/effect_in_unowned_derived");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/effect_in_unowned_derived")}function bf(t){if(H){let e=new Error(`effect_orphan
\`${t}\` can only be used inside an effect (e.g. during component initialisation)
https://svelte.dev/e/effect_orphan`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/effect_orphan")}function wf(){if(H){let t=new Error(`effect_update_depth_exceeded
Maximum update depth exceeded. This typically indicates that an effect reads and writes the same piece of state
https://svelte.dev/e/effect_update_depth_exceeded`);throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/effect_update_depth_exceeded")}function xf(){if(H){let t=new Error(`hydration_failed
Failed to hydrate the application
https://svelte.dev/e/hydration_failed`);throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/hydration_failed")}function yf(){if(H){let t=new Error("invalid_snippet\nCould not `{@render}` snippet due to the expression being `null` or `undefined`. Consider using optional chaining `{@render snippet?.()}`\nhttps://svelte.dev/e/invalid_snippet");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/invalid_snippet")}function Ef(t){if(H){let e=new Error(`props_rest_readonly
Rest element properties of \`$props()\` such as \`${t}\` are readonly
https://svelte.dev/e/props_rest_readonly`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/props_rest_readonly")}function Af(t){if(H){let e=new Error(`rune_outside_svelte
The \`${t}\` rune is only available inside \`.svelte\` and \`.svelte.js/ts\` files
https://svelte.dev/e/rune_outside_svelte`);throw e.name="Svelte error",e}else throw new Error("https://svelte.dev/e/rune_outside_svelte")}function Lf(){if(H){let t=new Error("set_context_after_init\n`setContext` must be called when a component first initializes, not in a subsequent effect or after an `await` expression\nhttps://svelte.dev/e/set_context_after_init");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/set_context_after_init")}function kf(){if(H){let t=new Error("state_descriptors_fixed\nProperty descriptors defined on `$state` objects must contain `value` and always be `enumerable`, `configurable` and `writable`.\nhttps://svelte.dev/e/state_descriptors_fixed");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/state_descriptors_fixed")}function If(){if(H){let t=new Error("state_prototype_fixed\nCannot set prototype of `$state` object\nhttps://svelte.dev/e/state_prototype_fixed");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/state_prototype_fixed")}function Sf(){if(H){let t=new Error("state_unsafe_mutation\nUpdating state inside `$derived(...)`, `$inspect(...)` or a template expression is forbidden. If the value should not be reactive, declare it without `$state`\nhttps://svelte.dev/e/state_unsafe_mutation");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/state_unsafe_mutation")}function Cf(){if(H){let t=new Error("svelte_boundary_reset_onerror\nA `<svelte:boundary>` `reset` function cannot be called while an error is still being handled\nhttps://svelte.dev/e/svelte_boundary_reset_onerror");throw t.name="Svelte error",t}else throw new Error("https://svelte.dev/e/svelte_boundary_reset_onerror")}var Zn="font-weight: bold",ei="font-weight: normal";function Nf(t){H?console.warn(`%c[svelte] await_reactivity_loss
%cDetected reactivity loss when reading \`${t}\`. This happens when state is read in an async function after an earlier \`await\`
https://svelte.dev/e/await_reactivity_loss`,Zn,ei):console.warn("https://svelte.dev/e/await_reactivity_loss")}function $f(t,e){H?console.warn(`%c[svelte] await_waterfall
...
https://svelte.dev/e/await_waterfall`,Zn,ei):console.warn("https://svelte.dev/e/await_waterfall")}function Df(){H?console.warn(`%c[svelte] derived_inert
%cReading a derived belonging to a now-destroyed effect may result in stale values
https://svelte.dev/e/derived_inert`,Zn,ei):console.warn("https://svelte.dev/e/derived_inert")}function Tf(t,e,n){H?console.warn(`%c[svelte] hydration_attribute_changed
...
https://svelte.dev/e/hydration_attribute_changed`,Zn,ei):console.warn("https://svelte.dev/e/hydration_attribute_changed")}function Ff(t){H?console.warn(`%c[svelte] hydration_html_changed
...
https://svelte.dev/e/hydration_mismatch`,Zn,ei):console.warn("https://svelte.dev/e/hydration_mismatch")}function Mf(){H?console.warn(`%c[svelte] lifecycle_double_unmount
%cTried to unmount a component that was not mounted
https://svelte.dev/e/lifecycle_double_unmount`,Zn,ei):console.warn("https://svelte.dev/e/lifecycle_double_unmount")}function _s(t){H?console.warn(`%c[svelte] state_proxy_equality_mismatch
%cReactive \`$state(...)\` proxies and the values they proxy have different identities. Because of this, comparisons with \`${t}\` will produce unexpected results
https://svelte.dev/e/state_proxy_equality_mismatch`,Zn,ei):console.warn("https://svelte.dev/e/state_proxy_equality_mismatch")}function Hf(){H?console.warn(`%c[svelte] state_proxy_unmount
%cTried to unmount a state proxy, rather than a component
https://svelte.dev/e/state_proxy_unmount`,Zn,ei):console.warn("https://svelte.dev/e/state_proxy_unmount")}function Bf(){H?console.warn("%c[svelte] svelte_boundary_reset_noop\n%cA `<svelte:boundary>` `reset` function only resets the boundary the first time it is called\nhttps://svelte.dev/e/svelte_boundary_reset_noop",Zn,ei):console.warn("https://svelte.dev/e/svelte_boundary_reset_noop")}var le=!1;function mt(t){le=t}var _e;function Me(t){if(t===null)throw $i(),Xn;return _e=t}function At(){return Me(Lt(_e))}function N(t){if(le){if(Lt(_e)!==null)throw $i(),Xn;_e=t}}function er(t=1){if(le){for(var e=t,n=_e;e--;)n=Lt(n);_e=n}}function ti(t=!0){for(var e=0,n=_e;;){if(n.nodeType===un){var i=n.data;if(i==="]"){if(e===0)return n;e-=1}else(i==="["||i==="[!"||i[0]==="["&&!isNaN(Number(i.slice(1))))&&(e+=1)}var r=Lt(n);t&&n.remove(),n=r}}function To(t){if(!t||t.nodeType!==un)throw $i(),Xn;return t.data}function bs(t){return t===this.v}function Oa(t,e){return t!=t?e==e:t!==e||t!==null&&typeof t=="object"||typeof t=="function"}function ws(t){return!Oa(t,this.v)}var gt=!1,bi=!1,Fn=!1;function Rf(){bi=!0}var Fo=null;function Ut(t,e){return t.label=e,ys(t.v,e),t}function ys(t,e){return t?.[gs]?.(e),t}function Mn(t){let e=new Error,n=oh();return n.length===0?null:(n.unshift(`
`),jt(e,"stack",{value:n.join(`
`)}),jt(e,"name",{value:t}),e)}function oh(){let t=Error.stackTraceLimit;Error.stackTraceLimit=1/0;let e=new Error().stack;if(Error.stackTraceLimit=t,!e)return[];let n=e.split(`
`),i=[];for(let r=0;r<n.length;r++){let o=n[r],a=o.replaceAll("\\","/");if(o.trim()!=="Error"){if(o.includes("validate_each_keys"))return[];a.includes("svelte/src/internal")||a.includes("node_modules/.vite")||i.push(o)}}return i}function Pf(t,e){if(!H)throw new Error("invariant(...) was not guarded by if (DEV)");t||uf(e)}var Ae=null;function wi(t){Ae=t}var Hn=null;function Rr(t){Hn=t}var pn=null;function Es(t){pn=t}function Ve(t){return jf("getContext").get(t)}function Ye(t,e){let n=jf("setContext");if(gt){var i=ae.f,r=!me&&(i&32)!==0&&!Ae.i;r||Lf()}return n.set(t,e),e}function de(t,e=!1,n){Ae={p:Ae,i:!1,c:null,e:null,s:t,x:null,r:ae,l:bi&&!e?{s:null,u:null,$:[]}:null},H&&(Ae.function=n,pn=n)}function fe(t){var e=Ae,n=e.e;if(n!==null){e.e=null;for(var i of n)Pa(i)}return t!==void 0&&(e.x=t),e.i=!0,Ae=e.p,H&&(pn=Ae?.function??null),t??{}}function ni(){return!bi||Ae!==null&&Ae.l===null}function jf(t){return Ae===null&&Mr(t),Ae.c??=new Map(sh(Ae)||void 0)}function sh(t){let e=t.p;for(;e!==null;){let n=e.c;if(n!==null)return n;e=e.p}return null}var tr=[];function Uf(){var t=tr;tr=[],ps(t)}function kt(t){if(tr.length===0&&!nr){var e=tr;queueMicrotask(()=>{e===tr&&Uf()})}tr.push(t)}function Gf(){for(;tr.length>0;)Uf()}var ja=new WeakMap;function As(t){var e=ae;if(e===null)return me.f|=8388608,t;if(H&&t instanceof Error&&!ja.has(t)&&ja.set(t,ah(t,e)),(e.f&32768)===0&&(e.f&4)===0)throw H&&!e.parent&&t instanceof Error&&zf(t),t;Rn(t,e)}function Rn(t,e){if(!(e!==null&&(e.f&16384)!==0)){for(;e!==null;){if((e.f&128)!==0){if((e.f&32768)===0)throw t;try{e.b.error(t);return}catch(n){t=n}}e=e.parent}throw H&&t instanceof Error&&zf(t),t}}function ah(t,e){let n=cn(t,"message");if(!(n&&!n.configurable)){for(var i=Ho?"  ":"	",r=`
...
`)}}}function zf(t){let e=ja.get(t);e&&(jt(t,"message",{value:e.message}),jt(t,"stack",{value:e.stack}))}var lh=-7169;function Be(t,e){t.f=t.f&lh|e}function Or(t){(t.f&512)!==0||t.deps===null?Be(t,1024):Be(t,4096)}function Wf(t){if(t!==null)for(let e of t)(e.f&2)===0||(e.f&65536)===0||(e.f^=65536,Wf(e.deps))}function Ls(t,e,n){(t.f&2048)!==0?e.add(t):(t.f&4096)!==0&&n.add(t),Wf(t.deps),Be(t,1024)}var Qf=!1;function ii(t){var e=me,n=ae;wt(null),xt(null);try{return t()}finally{wt(e),xt(n)}}function Yf(t){let e=0,n=Qt(0),i;return H&&Ut(n,"createSubscriber version"),()=>{Di()&&(s(n),Jt(()=>(e===0&&(i=Ze(()=>t(()=>sr(n)))),e+=1,()=>{kt(()=>{e-=1,e===0&&(i?.(),i=void 0,sr(n))})})))}}var ch=589824;function Ga(t,e,n,i){new Ua(t,e,n,i)}var Ua=class{parent;is_pending=!1;transform_error;#e;#t=le?_e:null;#n;#l;#o;#s=null;#i=null;#a=null;#r=null;#h=0;#f=0;#c=!1;#u=new Set;#g=new Set;#d=null;#b=Yf(()=>(this.#d=Qt(this.#h),H&&Ut(this.#d,"$effect.pending()"),()=>{this.#d=null}));constructor(e,n,i,r){this.#e=e,this.#n=n,this.#l=o=>{var a=ae;a.b=this,a.f|=128,i(o)},this.parent=ae.b,this.transform_error=r??this.parent?.transform_error??(o=>o),this.#o=sn(()=>{if(le){let o=this.#t;At();let a=o.data==="[!";if(o.data.startsWith("[?")){let d=JSON.parse(o.data.slice("[?".length));this.#w(d)}else a?this.#y():this.#v()}else this.#x()},ch),le&&(this.#e=_e)}#v(){try{this.#s=dt(()=>this.#l(this.#e))}catch(e){this.error(e)}}#w(e){let n=this.#n.failed;n&&(this.#a=dt(()=>{n(this.#e,()=>e,()=>()=>{})}))}#y(){let e=this.#n.pending;e&&(this.is_pending=!0,this.#i=dt(()=>e(this.#e)),kt(()=>{var n=this.#r=document.createDocumentFragment(),i=yt();n.append(i),this.#s=this.#_(()=>dt(()=>this.#l(i))),this.#f===0&&(this.#e.before(n),this.#r=null,ri(this.#i,()=>{this.#i=null}),this.#p(be))}))}#x(){try{if(this.is_pending=this.has_pending_snippet(),this.#f=0,this.#h=0,this.#s=dt(()=>{this.#l(this.#e)}),this.#f>0){var e=this.#r=document.createDocumentFragment();Pr(this.#s,e);let n=this.#n.pending;this.#i=dt(()=>n(this.#e))}else this.#p(be)}catch(n){this.error(n)}}#p(e){this.is_pending=!1,e.transfer_effects(this.#u,this.#g)}defer_effect(e){Ls(e,this.#u,this.#g)}is_rendered(){return!this.is_pending&&(!this.parent||this.parent.is_rendered())}has_pending_snippet(){return!!this.#n.pending}#_(e){var n=ae,i=me,r=Ae;xt(this.#o),wt(this.#o),wi(this.#o.ctx);try{return hn.ensure(),e()}catch(o){return As(o),null}finally{xt(n),wt(i),wi(r)}}#m(e,n){if(!this.has_pending_snippet()){this.parent&&this.parent.#m(e,n);return}this.#f+=e,this.#f===0&&(this.#p(n),this.#i&&ri(this.#i,()=>{this.#i=null}),this.#r&&(this.#e.before(this.#r),this.#r=null))}update_pending_count(e,n){this.#m(e,n),this.#h+=e,!(!this.#d||this.#c)&&(this.#c=!0,kt(()=>{this.#c=!1,this.#d&&On(this.#d,this.#h)}))}get_effect_pending(){return this.#b(),s(this.#d)}error(e){if(!this.#n.onerror&&!this.#n.failed)throw e;be?.is_fork?(this.#s&&be.skip_effect(this.#s),this.#i&&be.skip_effect(this.#i),this.#a&&be.skip_effect(this.#a),be.oncommit(()=>{this.#E(e)})):this.#E(e)}#E(e){this.#s&&(tt(this.#s),this.#s=null),this.#i&&(tt(this.#i),this.#i=null),this.#a&&(tt(this.#a),this.#a=null),le&&(Me(this.#t),er(),Me(ti()));var n=this.#n.onerror;let i=this.#n.failed;var r=!1,o=!1;let a=()=>{if(r){Bf();return}r=!0,o&&Cf(),this.#a!==null&&ri(this.#a,()=>{this.#a=null}),this.#_(()=>{this.#x()})},l=d=>{try{o=!0,n?.(d,a),o=!1}catch(u){Rn(u,this.#o&&this.#o.parent)}i&&(this.#a=this.#_(()=>{try{return dt(()=>{var u=ae;u.b=this,u.f|=128,i(this.#e,()=>d,()=>a)})}catch(u){return Rn(u,this.#o.parent),null}}))};kt(()=>{var d;try{d=this.transform_error(e)}catch(u){Rn(u,this.#o&&this.#o.parent);return}d!==null&&typeof d=="object"&&typeof d.then=="function"?d.then(l,u=>Rn(u,this.#o&&this.#o.parent)):l(d)})}};function ks(t,e,n,i){let r=ni()?Ur:Gr;var o=t.filter(m=>!m.settled),a=e.map(r);if(H&&a.forEach((m,g)=>{m.label=e[g].toString().replace("() => ","").replaceAll("$.eager(() => ","$state.eager(").replace(/\$\.get\((.+?)\)/g,(x,w)=>w)}),n.length===0&&o.length===0){i(a);return}var l=ae,d=qf(),u=o.length===1?o[0].promise:o.length>1?Promise.all(o.map(m=>m.promise)):null;function c(m){if((l.f&16384)===0){d();try{i([...a,...m])}catch(g){Rn(g,l)}jr()}}var f=za();if(n.length===0){u.then(()=>c([])).finally(f);return}function p(){Promise.all(n.map(m=>Qa(m))).then(c).catch(m=>Rn(m,l)).finally(f)}u?u.then(()=>{d(),p(),jr()}):p()}function qf(){var t=ae,e=me,n=Ae,i=be;if(H)var r=Hn;return function(a=!0){xt(t),wt(e),wi(n),a&&(t.f&16384)===0&&(i?.activate(),i?.apply()),H&&(Wa(null),Rr(r))}}function jr(t=!0){xt(null),wt(null),wi(null),t&&be?.deactivate(),H&&(Wa(null),Rr(null))}function za(){var t=ae,e=t.b,n=be,i=!!e?.is_rendered();return e?.update_pending_count(1,n),n.increment(i,t),()=>{e?.update_pending_count(-1,n),n.decrement(i,t)}}var an=null;function Wa(t){an=t}var Ro=new Set;function Ur(t){var e=2050;ae!==null&&(ae.f|=524288);let n={ctx:Ae,deps:null,effects:null,equals:bs,f:e,fn:t,reactions:null,rv:0,v:Ue,wv:0,parent:ae,ac:null};return H&&Fn&&(n.created=Mn("created at")),n}var zr=Symbol("obsolete");function Qa(t,e,n){let i=ae;i===null&&hf();var r=void 0,o=Qt(Ue);H&&(o.label=e??t.toString());var a=!me,l=new Set;return Zf(()=>{var d=ae;H&&(an={effect:d,effect_deps:new Set,warned:!1});var u=hs();r=u.promise;try{Promise.resolve(t()).then(u.resolve,m=>{m!==_i&&u.reject(m)}).finally(jr)}catch(m){u.reject(m),jr()}if(H){if(an){if(d.deps!==null)for(let m=0;m<qt;m+=1)an.effect_deps.add(d.deps[m]);if(It!==null)for(let m=0;m<It.length;m+=1)an.effect_deps.add(It[m])}an=null}var c=be;if(a){if((d.f&32768)!==0)var f=za();if(i.b?.is_rendered())c.async_deriveds.get(d)?.reject(zr);else for(let m of l.values())m.reject(zr);l.add(u),c.async_deriveds.set(d,u)}let p=(m,g=void 0)=>{H&&(an=null),f?.(),l.delete(u),g!==zr&&(c.activate(),g?(o.f|=8388608,On(o,g)):((o.f&8388608)!==0&&(o.f^=8388608),H&&n!==void 0&&!o.equals(m)&&(Ro.add(o),setTimeout(()=>{Ro.has(o)&&(d.f&16384)===0&&($f(o.label,n),Ro.delete(o))})),On(o,m)),c.deactivate())};u.promise.then(p,m=>p(null,m||"unknown"))}),zt(()=>{for(let d of l)d.reject(zr)}),H&&(o.f|=4194304),new Promise(d=>{function u(c){function f(){c===r?d(o):u(r)}c.then(f,f)}u(r)})}function I(t){let e=Ur(t);return gt||Cs(e),e}function Gr(t){let e=Ur(t);return e.equals=ws,e}function Kf(t){var e=t.effects;if(e!==null){t.effects=null;for(var n=0;n<e.length;n+=1)tt(e[n])}}var Va=[];function Oo(t){var e,n=ae,i=t.parent;if(!wn&&i!==null&&t.v!==Ue&&(i.f&24576)!==0)return Df(),t.v;if(xt(i),H){let r=ar;Is(new Set);try{Ni.call(Va,t)&&mf(),Va.push(t),t.f&=-65537,Kf(t),e=Ss(t)}finally{xt(n),Is(r),Va.pop()}}else try{t.f&=-65537,Kf(t),e=Ss(t)}finally{xt(n)}return e}function Ya(t){var e=Oo(t);if(!t.equals(e)&&(t.wv=Wr(),(!be?.is_fork||t.deps===null)&&(be!==null?(be.capture(t,e,!0),Ti?.capture(t,e,!0)):t.v=e,t.deps===null))){Be(t,1024);return}wn||(St!==null?(Di()||be?.is_fork)&&St.set(t,e):Or(t))}function Xf(t){if(t.effects!==null)for(let e of t.effects)(e.teardown||e.ac)&&(e.teardown?.(),e.ac!==null&&ii(()=>{e.ac.abort(_i),e.ac=null}),e.fn!==null&&(e.teardown=ht),lr(e,0),Po(e))}function Ja(t){if(t.effects!==null)for(let e of t.effects)e.teardown&&e.fn!==null&&oi(e)}var Ns=null,Qr=null,be=null,Ti=null,St=null,Xa=null,nr=!1,qa=!1,dr=null,jo=null,ec=0,Ka=new Set,hh=1,hn=class t{id=hh++;#e=!1;linked=!0;#t=null;#n=null;async_deriveds=new Map;current=new Map;previous=new Map;#l=new Set;#o=new Set;#s=0;#i=new Map;#a=null;#r=[];#h=[];#f=new Set;#c=new Set;#u=new Map;#g=new Set;is_fork=!1;#d=!1;constructor(){Qr===null?Ns=Qr=this:(Qr.#n=this,this.#t=Qr),Qr=this}#b(){if(this.is_fork)return!0;for(let i of this.#i.keys()){for(var e=i,n=!1;e.parent!==null;){if(this.#u.has(e)){n=!0;break}e=e.parent}if(!n)return!0}return!1}skip_effect(e){this.#u.has(e)||this.#u.set(e,{d:[],m:[]}),this.#g.delete(e)}unskip_effect(e,n=i=>this.schedule(i)){var i=this.#u.get(e);if(i){this.#u.delete(e);for(var r of i.d)Be(r,2048),n(r);for(r of i.m)Be(r,4096),n(r)}this.#g.add(e)}#v(){if(this.#e=!0,ec++>1e3&&(this.#m(),mh()),H)for(let d of this.current.keys())Ka.add(d);for(let d of this.#f)this.#c.delete(d),Be(d,2048),this.schedule(d);for(let d of this.#c)Be(d,4096),this.schedule(d);let e=this.#r;this.#r=[],this.apply();var n=dr=[],i=[],r=jo=[];for(let d of e)try{this.#w(d,n,i)}catch(u){throw rc(d),this.#b()||this.discard(),u}if(be=null,r.length>0){var o=t.ensure();for(let d of r)o.schedule(d)}if(dr=null,jo=null,this.#b()){this.#p(i),this.#p(n);for(let[d,u]of this.#u)ic(d,u);r.length>0&&be.#v();return}let a=this.#y();if(a){this.#p(i),this.#p(n),a.#x(this);return}this.#f.clear(),this.#c.clear();for(let d of this.#l)d(this);this.#l.clear(),Ti=this,tc(i),tc(n),Ti=null,this.#a?.resolve();var l=be;if(this.#s===0&&(this.#r.length===0||l!==null)&&(this.#m(),gt&&(this.#_(),be=l)),this.#r.length>0)if(l!==null){let d=l;d.#r.push(...this.#r.filter(u=>!d.#r.includes(u)))}else l=this;l!==null&&l.#v()}#w(e,n,i){e.f^=1024;for(var r=e.first;r!==null;){var o=r.f,a=(o&96)!==0,l=a&&(o&1024)!==0,d=l||(o&8192)!==0||this.#u.has(r);if(!d&&r.fn!==null){a?r.f^=1024:(o&4)!==0?n.push(r):gt&&(o&16777224)!==0?i.push(r):Fi(r)&&((o&16)!==0&&this.#c.add(r),oi(r));var u=r.first;if(u!==null){r=u;continue}}for(;r!==null;){var c=r.next;if(c!==null){r=c;break}r=r.parent}}}#y(){for(var e=this.#t;e!==null;){if(!e.is_fork){for(let[n,[,i]]of this.current)if(e.current.has(n)&&!i)return e}e=e.#t}return null}#x(e){for(let[i,r]of e.current)!this.previous.has(i)&&e.previous.has(i)&&this.previous.set(i,e.previous.get(i)),this.current.set(i,r);for(let[i,r]of e.async_deriveds){let o=this.async_deriveds.get(i);o&&r.promise.then(o.resolve).catch(o.reject)}e.async_deriveds.clear(),this.transfer_effects(e.#f,e.#c);let n=i=>{var r=i.reactions;if(r!==null&&!((i.f&2)!==0&&(i.f&6144)===0))for(let l of r){var o=l.f;if((o&2)!==0)n(l);else{var a=l;o&4194320&&!this.async_deriveds.has(a)&&(this.#c.delete(a),Be(a,2048),this.schedule(a))}}};for(let i of this.current.keys())n(i);this.oncommit(()=>e.discard()),e.#m(),be=this,this.#v()}#p(e){for(var n=0;n<e.length;n+=1)Ls(e[n],this.#f,this.#c)}capture(e,n,i=!1){e.v!==Ue&&!this.previous.has(e)&&this.previous.set(e,e.v),(e.f&8388608)===0&&(this.current.set(e,[n,i]),St?.set(e,n)),this.is_fork||(e.v=n)}activate(){be=this}deactivate(){be=null,St=null}flush(){try{H&&Ka.clear(),qa=!0,be=this,this.#v()}finally{if(ec=0,Xa=null,dr=null,jo=null,qa=!1,be=null,St=null,Ei.clear(),H)for(let e of Ka)e.updated=null}}discard(){for(let e of this.#o)e(this);this.#o.clear();for(let e of this.async_deriveds.values())e.reject(zr);this.#m(),this.#a?.resolve()}register_created_effect(e){this.#h.push(e)}#_(){for(let f=Ns;f!==null;f=f.#n){var e=f.id<this.id,n=[];for(let[p,[m,g]]of this.current){if(f.current.has(p)){var i=f.current.get(p)[0];if(e&&m!==i)f.current.set(p,[m,g]);else continue}n.push(p)}if(e)for(let[p,m]of this.async_deriveds){let g=f.async_deriveds.get(p);g&&m.promise.then(g.resolve).catch(g.reject)}var r=[...f.current.keys()].filter(p=>!f.current.get(p)[1]);if(!(!f.#e||r.length===0)){var o=r.filter(p=>!this.current.has(p));if(o.length===0)e&&f.discard();else if(n.length>0){if(H&&!f.#d&&Pf(f.#r.length===0,"Batch has scheduled roots"),e)for(let p of this.#g)f.unskip_effect(p,m=>{(m.f&4194320)!==0?f.schedule(m):f.#p([m])});f.activate();var a=new Set,l=new Map;for(var d of n)nc(d,o,a,l);l=new Map;var u=[...f.current].filter(([p,m])=>{let g=this.current.get(p);return g?g[0]!==m[0]||g[1]!==m[1]:!0}).map(([p])=>p);if(u.length>0)for(let p of this.#h)(p.f&155648)===0&&Za(p,u,l)&&((p.f&4194320)!==0?(Be(p,2048),f.schedule(p)):f.#f.add(p));if(f.#r.length>0&&!f.#d){f.apply();for(var c of f.#r)f.#w(c,[],[]);f.#r=[]}f.deactivate()}}}}increment(e,n){if(this.#s+=1,e){let i=this.#i.get(n)??0;this.#i.set(n,i+1)}}decrement(e,n){if(this.#s-=1,e){let i=this.#i.get(n)??0;i===1?this.#i.delete(n):this.#i.set(n,i-1)}this.#d||(this.#d=!0,kt(()=>{this.#d=!1,this.linked&&this.flush()}))}transfer_effects(e,n){for(let i of e)this.#f.add(i);for(let i of n)this.#c.add(i);e.clear(),n.clear()}oncommit(e){this.#l.add(e)}ondiscard(e){this.#o.add(e)}settled(){return(this.#a??=hs()).promise}static ensure(){if(be===null){let e=be=new t;!qa&&!nr&&kt(()=>{e.#e||e.flush()})}return be}apply(){if(!gt||!this.is_fork&&this.#t===null&&this.#n===null){St=null;return}St=new Map;for(let[n,[i]]of this.current)St.set(n,i);for(let n=Ns;n!==null;n=n.#n)if(!(n===this||n.is_fork)){var e=!1;if(n.id<this.id){for(let[i,[,r]]of n.current)if(!r&&this.current.has(i)){e=!0;break}}if(!e)for(let[i,r]of n.previous)St.has(i)||St.set(i,r)}}schedule(e){if(Xa=e,e.b?.is_pending&&(e.f&16777228)!==0&&(e.f&32768)===0){e.b.defer_effect(e);return}for(var n=e;n.parent!==null;){n=n.parent;var i=n.f;if(dr!==null&&n===ae&&(gt||(me===null||(me.f&2)===0)&&!Qf))return;if((i&96)!==0){if((i&1024)===0)return;n.f^=1024}}this.#r.push(n)}#m(){if(this.linked){var e=this.#t,n=this.#n;e===null?Ns=n:e.#n=n,n===null?Qr=e:n.#t=e,this.linked=!1}}};function Vr(t){var e=nr;nr=!0;try{var n;for(t&&(be!==null&&!be.is_fork&&be.flush(),n=t());;){if(Gf(),be===null)return n;be.flush()}}finally{nr=e}}function mh(){if(H){var t=new Map;for(let n of be.current.keys())for(let[i,r]of n.updated??[]){var e=t.get(i);e||(e={error:r.error,count:0},t.set(i,e)),e.count+=r.count}for(let n of t.values())n.error&&console.error(n.error)}try{wf()}catch(n){H&&jt(n,"stack",{value:""}),Rn(n,Xa)}}var xn=null;function tc(t){var e=t.length;if(e!==0){for(var n=0;n<e;){var i=t[n++];if((i.f&24576)===0&&Fi(i)&&(xn=new Set,oi(i),i.deps===null&&i.first===null&&i.nodes===null&&i.teardown===null&&i.ac===null&&el(i),xn?.size>0)){Ei.clear();for(let r of xn){if((r.f&24576)!==0)continue;let o=[r],a=r.parent;for(;a!==null;)xn.has(a)&&(xn.delete(a),o.push(a)),a=a.parent;for(let l=o.length-1;l>=0;l--){let d=o[l];(d.f&24576)===0&&oi(d)}}xn.clear()}}xn=null}}function nc(t,e,n,i){if(!n.has(t)&&(n.add(t),t.reactions!==null))for(let r of t.reactions){let o=r.f;(o&2)!==0?nc(r,e,n,i):(o&4194320)!==0&&(o&2048)===0&&Za(r,e,i)&&(Be(r,2048),Uo(r))}}function Za(t,e,n){let i=n.get(t);if(i!==void 0)return i;if(t.deps!==null)for(let r of t.deps){if(Ni.call(e,r))return!0;if((r.f&2)!==0&&Za(r,e,n))return n.set(r,!0),!0}return n.set(t,!1),!1}function Uo(t){be.schedule(t)}function ic(t,e){if(!((t.f&32)!==0&&(t.f&1024)!==0)){(t.f&2048)!==0?e.d.push(t):(t.f&4096)!==0&&e.m.push(t),Be(t,1024);for(var n=t.first;n!==null;)ic(n,e),n=n.next}}function rc(t){Be(t,1024);for(var e=t.first;e!==null;)rc(e),e=e.next}var ar=new Set,Ei=new Map;function Is(t){ar=t}var tl=!1;function sc(){tl=!0}function Qt(t,e){var n={f:0,v:t,reactions:null,equals:bs,rv:0,wv:0};return H&&Fn&&(n.created=e??Mn("created at"),n.updated=null,n.set_during_effect=!1,n.trace=null),n}function ce(t,e){let n=Qt(t,e);return Cs(n),n}function ir(t,e=!1,n=!0){let i=Qt(t);return e||(i.equals=ws),bi&&n&&Ae!==null&&Ae.l!==null&&(Ae.l.s??=[]).push(i),i}function oe(t,e,n=!1){me!==null&&(!Kt||(me.f&131072)!==0)&&ni()&&(me.f&4325394)!==0&&(Pn===null||!Pn.has(t))&&Sf();let i=n?Le(e):e;return H&&ys(i,t.label),On(t,i,jo)}function On(t,e,n=null){if(!t.equals(e)){Ei.set(t,wn?e:t.v);var i=hn.ensure();if(i.capture(t,e),H){if(Fn||ae!==null){t.updated??=new Map;let r=(t.updated.get("")?.count??0)+1;if(t.updated.set("",{error:null,count:r}),Fn||r>5){let o=Mn("updated at");if(o!==null){let a=t.updated.get(o.stack);a||(a={error:o,count:0},t.updated.set(o.stack,a)),a.count++}}}ae!==null&&(t.set_during_effect=!0)}if((t.f&2)!==0){let r=t;(t.f&2048)!==0&&Oo(r),St===null&&Or(r)}t.wv=Wr(),ac(t,2048,n),ni()&&ae!==null&&(ae.f&1024)!==0&&(ae.f&96)===0&&(mn===null?lc([t]):mn.push(t)),!i.is_fork&&ar.size>0&&!tl&&Ds()}return e}function Ds(){tl=!1;for(let t of ar){(t.f&1024)!==0&&Be(t,4096);let e;try{e=Fi(t)}catch{e=!0}e&&oi(t)}ar.clear()}function sr(t){oe(t,t.v+1)}function ac(t,e,n){var i=t.reactions;if(i!==null)for(var r=ni(),o=i.length,a=0;a<o;a++){var l=i[a],d=l.f;if(!(!r&&l===ae)){var u=(d&2048)===0;if(u&&Be(l,e),(d&131072)!==0)ar.add(l);else if((d&2)!==0){var c=l;St?.delete(c),(d&65536)===0&&(d&512&&(ae===null||(ae.f&2097152)===0)&&(l.f|=65536),ac(c,4096,n))}else if(u){var f=l;(d&16)!==0&&xn!==null&&xn.add(f),n!==null?n.push(f):Uo(f)}}}}var vh=/^[a-zA-Z_$][a-zA-Z_$0-9]*$/;function Le(t){if(typeof t!="object"||t===null||Yt in t)return t;let e=Tr(t);if(e!==Fa&&e!==ff)return t;var n=new Map,i=vi(t),r=ce(0),o=H&&Fn?Mn("created at"):null,a=Mi,l=f=>{if(Mi===a)return f();var p=me,m=Mi;wt(null),nl(a);var g=f();return wt(p),nl(m),g};i&&(n.set("length",ce(t.length,o)),H&&(t=bh(t)));var d="";let u=!1;function c(f){if(!u){u=!0,d=f,Ut(r,`${d} version`);for(let[p,m]of n)Ut(m,cr(d,p));u=!1}}return new Proxy(t,{defineProperty(f,p,m){(!("value"in m)||m.configurable===!1||m.enumerable===!1||m.writable===!1)&&kf();var g=n.get(p);return g===void 0?l(()=>{var x=ce(m.value,o);return n.set(p,x),H&&typeof p=="string"&&Ut(x,cr(d,p)),x}):oe(g,m.value,!0),!0},deleteProperty(f,p){var m=n.get(p);if(m===void 0){if(p in f){let g=l(()=>ce(Ue,o));n.set(p,g),sr(r),H&&Ut(g,cr(d,p))}}else oe(m,Ue),sr(r);return!0},get(f,p,m){if(p===Yt)return t;if(H&&p===gs)return c;var g=n.get(p),x=p in f;if(g===void 0&&(!x||cn(f,p)?.writable)&&(g=l(()=>{var _=Le(x?f[p]:Ue),L=ce(_,o);return H&&Ut(L,cr(d,p)),L}),n.set(p,g)),g!==void 0){var w=s(g);return w===Ue?void 0:w}return Reflect.get(f,p,m)},getOwnPropertyDescriptor(f,p){var m=Reflect.getOwnPropertyDescriptor(f,p);if(m&&"value"in m){var g=n.get(p);g&&(m.value=s(g))}else if(m===void 0){var x=n.get(p),w=x?.v;if(x!==void 0&&w!==Ue)return{enumerable:!0,configurable:!0,value:w,writable:!0}}return m},has(f,p){if(p===Yt)return!0;var m=n.get(p),g=m!==void 0&&m.v!==Ue||Reflect.has(f,p);if(m!==void 0||ae!==null&&(!g||cn(f,p)?.writable)){m===void 0&&(m=l(()=>{var w=g?Le(f[p]):Ue,_=ce(w,o);return H&&Ut(_,cr(d,p)),_}),n.set(p,m));var x=s(m);if(x===Ue)return!1}return g},set(f,p,m,g){var x=n.get(p),w=p in f;if(i&&p==="length")for(var _=m;_<x.v;_+=1){var L=n.get(_+"");L!==void 0?oe(L,Ue):_ in f&&(L=l(()=>ce(Ue,o)),n.set(_+"",L),H&&Ut(L,cr(d,_)))}if(x===void 0)(!w||cn(f,p)?.writable)&&(x=l(()=>ce(void 0,o)),H&&Ut(x,cr(d,p)),oe(x,Le(m)),n.set(p,x));else{w=x.v!==Ue;var y=l(()=>Le(m));oe(x,y)}var C=Reflect.getOwnPropertyDescriptor(f,p);if(C?.set&&C.set.call(g,m),!w){if(i&&typeof p=="string"){var S=n.get("length"),E=Number(p);Number.isInteger(E)&&E>=S.v&&oe(S,E+1)}sr(r)}return!0},ownKeys(f){s(r);var p=Reflect.ownKeys(f).filter(x=>{var w=n.get(x);return w===void 0||w.v!==Ue});for(var[m,g]of n)g.v!==Ue&&!(m in f)&&p.push(m);return p},setPrototypeOf(){If()}})}function cr(t,e){return typeof e=="symbol"?`${t}[Symbol(${e.description??""})]`:vh.test(e)?`${t}.${e}`:/^\d+$/.test(e)?`${t}[${e}]`:`${t}['${e}']`}function Ts(t){try{if(t!==null&&typeof t=="object"&&Yt in t)return t[Yt]}catch{}return t}var _h=new Set(["copyWithin","fill","pop","push","reverse","shift","sort","splice","unshift"]);function bh(t){return new Proxy(t,{get(e,n,i){var r=Reflect.get(e,n,i);return _h.has(n)?function(...o){sc();var a=r.apply(this,o);return Ds(),a}:r}})}function dc(){let t=Array.prototype,e=Array.__svelte_cleanup;e&&e();let{indexOf:n,lastIndexOf:i,includes:r}=t;t.indexOf=function(o,a){let l=n.call(this,o,a);if(l===-1){for(let d=a??0;d<this.length;d+=1)if(Ts(this[d])===o){_s("array.indexOf(...)");break}}return l},t.lastIndexOf=function(o,a){let l=i.call(this,o,a??this.length-1);if(l===-1){for(let d=0;d<=(a??this.length-1);d+=1)if(Ts(this[d])===o){_s("array.lastIndexOf(...)");break}}return l},t.includes=function(o,a){let l=r.call(this,o,a);if(!l){for(let d=0;d<this.length;d+=1)if(Ts(this[d])===o){_s("array.includes(...)");break}}return l},Array.__svelte_cleanup=()=>{t.indexOf=n,t.lastIndexOf=i,t.includes=r}}var il,fc,Ho,cc,uc;function Fs(){if(il===void 0){il=window,fc=document,Ho=/Firefox/.test(navigator.userAgent);var t=Element.prototype,e=Node.prototype,n=Text.prototype;cc=cn(e,"firstChild").get,uc=cn(e,"nextSibling").get,Ma(t)&&(t[Co]=void 0,t[vs]=null,t[No]=void 0,t.__e=void 0),Ma(n)&&(n[$o]=void 0),H&&(t.__svelte_meta=null,dc())}}function yt(t=""){return document.createTextNode(t)}function Qe(t){return cc.call(t)}function Lt(t){return uc.call(t)}function $(t,e){if(!le)return Qe(t);var n=Qe(_e);if(n===null)n=_e.appendChild(yt());else if(e&&n.nodeType!==Fr){var i=yt();return n?.before(i),Me(i),i}return e&&Hs(n),Me(n),n}function ne(t,e=!1){if(!le){var n=Qe(t);return n instanceof Comment&&n.data===""?Lt(n):n}if(e){if(_e?.nodeType!==Fr){var i=yt();return _e?.before(i),Me(i),i}Hs(_e)}return _e}function K(t,e=1,n=!1){let i=le?_e:t;for(var r;e--;)r=i,i=Lt(i);if(!le)return i;if(n){if(i?.nodeType!==Fr){var o=yt();return i===null?r?.after(o):i.before(o),Me(o),o}Hs(i)}return Me(i),i}function Bo(t){t.textContent=""}function Ms(){if(!gt||xn!==null)return!1;var t=ae.f;return(t&32768)!==0}function si(t,e,n){return e==null||e===us?n?document.createElement(t,{is:n}):document.createElement(t):n?document.createElementNS(e,t,{is:n}):document.createElementNS(e,t)}function Hs(t){if(t.nodeValue.length<65536)return;let e=t.nextSibling;for(;e!==null&&e.nodeType===Fr;)e.remove(),t.nodeValue+=e.nodeValue,e=t.nextSibling}function hc(t){ae===null&&(me===null&&bf(t),_f()),wn&&vf(t)}function xh(t,e){var n=e.last;n===null?e.last=e.first=t:(n.next=t,t.prev=n,e.last=t)}function jn(t,e){var n=ae;if(H)for(;n!==null&&(n.f&131072)!==0;)n=n.parent;n!==null&&(n.f&8192)!==0&&(t|=8192);var i={ctx:Ae,deps:null,nodes:null,f:t|2048|512,first:null,fn:e,last:null,next:null,parent:n,b:n&&n.b,prev:null,teardown:null,wv:0,ac:null};H&&(i.component_function=pn),be?.register_created_effect(i);var r=i;if((t&4)!==0)dr!==null?dr.push(i):hn.ensure().schedule(i);else if(e!==null){try{oi(i)}catch(a){throw tt(i),a}r.deps===null&&r.teardown===null&&r.nodes===null&&r.first===r.last&&(r.f&524288)===0&&(r=r.first,(t&16)!==0&&(t&65536)!==0&&r!==null&&(r.f|=65536))}if(r!==null&&(r.parent=n,n!==null&&xh(r,n),me!==null&&(me.f&2)!==0&&(t&64)===0)){var o=me;(o.effects??=[]).push(r)}return i}function Di(){return me!==null&&!Kt}function zt(t){let e=jn(8,null);return Be(e,1024),e.teardown=t,e}function ye(t){hc("$effect"),H&&jt(t,"name",{value:"$effect"});var e=ae.f,n=!me&&(e&32)!==0&&Ae!==null&&!Ae.i;if(n){var i=Ae;(i.e??=[]).push(t)}else return Pa(t)}function Pa(t){return jn(1048580,t)}function ol(t){hn.ensure();let e=jn(524352,t);return()=>{tt(e)}}function mc(t){hn.ensure();let e=jn(524352,t);return(n={})=>new Promise(i=>{n.outro?ri(e,()=>{tt(e),i(void 0)}):(tt(e),i(void 0))})}function yn(t){return jn(4,t)}function Zf(t){return jn(4718592,t)}function Jt(t,e=0){return jn(8|e,t)}function X(t,e=[],n=[],i=[]){ks(i,e,n,r=>{jn(8,()=>{t(...r.map(s))})})}function sn(t,e=0){var n=jn(16|e,t);return H&&(n.dev_stack=Hn),n}function sl(t,e=0){var n=jn(16777216|e,t);return H&&(n.dev_stack=Hn),n}function dt(t){return jn(524320,t)}function al(t){var e=t.teardown;if(e!==null){let n=wn,i=me;rl(!0),wt(null);try{e.call(null)}finally{rl(n),wt(i)}}}function Po(t,e=!1){var n=t.first;for(t.first=t.last=null;n!==null;){let r=n.ac;r!==null&&ii(()=>{r.abort(_i)});var i=n.next;(n.f&64)!==0?n.parent=null:tt(n,e),n=i}}function gc(t){for(var e=t.first;e!==null;){var n=e.next;(e.f&32)===0&&tt(e),e=n}}function tt(t,e=!0){var n=!1;(e||(t.f&262144)!==0)&&t.nodes!==null&&t.nodes.end!==null&&(ll(t.nodes.start,t.nodes.end),n=!0),t.f|=33554432,Po(t,e&&!n),lr(t,0);var i=t.nodes&&t.nodes.t;if(i!==null)for(let o of i)o.stop();al(t),t.f^=33554432,t.f|=16384;var r=t.parent;r!==null&&r.first!==null&&el(t),H&&(t.component_function=null),t.next=t.prev=t.teardown=t.ctx=t.deps=t.fn=t.nodes=t.ac=t.b=null}function ll(t,e){for(;t!==null;){var n=t===e?null:Lt(t);t.remove(),t=n}}function el(t){var e=t.parent,n=t.prev,i=t.next;n!==null&&(n.next=i),i!==null&&(i.prev=n),e!==null&&(e.first===t&&(e.first=i),e.last===t&&(e.last=n))}function ri(t,e,n=!0){var i=[];vc(t,i,!0);var r=()=>{n&&tt(t),e&&e()},o=i.length;if(o>0){var a=()=>--o||r();for(var l of i)l.out(a)}else r()}function vc(t,e,n){if((t.f&8192)===0){t.f^=8192;var i=t.nodes&&t.nodes.t;if(i!==null)for(let l of i)(l.is_global||n)&&e.push(l);for(var r=t.first;r!==null;){var o=r.next;if((r.f&64)===0){var a=(r.f&65536)!==0||(r.f&32)!==0&&(t.f&16)!==0;vc(r,e,a?n:!1)}r=o}}}function Jr(t){_c(t,!0)}function _c(t,e){if((t.f&8192)!==0){t.f^=8192,(t.f&1024)===0&&(Be(t,2048),hn.ensure().schedule(t));for(var n=t.first;n!==null;){var i=n.next,r=(n.f&65536)!==0||(n.f&32)!==0;_c(n,r?e:!1),n=i}var o=t.nodes&&t.nodes.t;if(o!==null)for(let a of o)(a.is_global||e)&&a.in()}}function Pr(t,e){if(t.nodes)for(var n=t.nodes.start,i=t.nodes.end;n!==null;){var r=n===i?null:Lt(n);e.append(n),n=r}}var bc=null;var Bs=!1,wn=!1;function rl(t){wn=t}var me=null,Kt=!1;function wt(t){me=t}var ae=null;function xt(t){ae=t}var Pn=null;function Cs(t){me!==null&&(!gt||(me.f&2)!==0)&&(Pn??=new Set).add(t)}var It=null,qt=0,mn=null;function lc(t){mn=t}var wc=1,ur=0,Mi=ur;function nl(t){Mi=t}function Wr(){return++wc}function Fi(t){var e=t.f;if((e&2048)!==0)return!0;if(e&2&&(t.f&=-65537),(e&4096)!==0){for(var n=t.deps,i=n.length,r=0;r<i;r++){var o=n[r];if(Fi(o)&&Ya(o),o.wv>t.wv)return!0}(e&512)!==0&&St===null&&Be(t,1024)}return!1}function xc(t,e,n=!0){var i=t.reactions;if(i!==null&&!(!gt&&Pn!==null&&Pn.has(t)))for(var r=0;r<i.length;r++){var o=i[r];(o.f&2)!==0?xc(o,e,!1):e===o&&(n?Be(o,2048):(o.f&1024)!==0&&Be(o,4096),Uo(o))}}function Ss(t){var e=It,n=qt,i=mn,r=me,o=Pn,a=Ae,l=Kt,d=Mi,u=t.f;It=null,qt=0,mn=null,me=(u&96)===0?t:null,Pn=null,wi(t.ctx),Kt=!1,Mi=++ur,t.ac!==null&&(ii(()=>{t.ac.abort(_i)}),t.ac=null);try{t.f|=2097152;var c=t.fn,f=c();t.f|=32768;var p=t.deps,m=be?.is_fork;if(It!==null){var g;if(m||lr(t,qt),p!==null&&qt>0)for(p.length=qt+It.length,g=0;g<It.length;g++)p[qt+g]=It[g];else t.deps=p=It;if(Di()&&(t.f&512)!==0)for(g=qt;g<p.length;g++)(p[g].reactions??=[]).push(t)}else!m&&p!==null&&qt<p.length&&(lr(t,qt),p.length=qt);if(ni()&&mn!==null&&!Kt&&p!==null&&(t.f&6146)===0)for(g=0;g<mn.length;g++)xc(mn[g],t);if(r!==null&&r!==t){if(ur++,r.deps!==null)for(let x=0;x<n;x+=1)r.deps[x].rv=ur;if(e!==null)for(let x of e)x.rv=ur;mn!==null&&(i===null?i=mn:i.push(...mn))}return(t.f&8388608)!==0&&(t.f^=8388608),f}catch(x){return As(x)}finally{t.f^=2097152,It=e,qt=n,mn=i,me=r,Pn=o,wi(a),Kt=l,Mi=d}}function yh(t,e){let n=e.reactions;if(n!==null){var i=df.call(n,t);if(i!==-1){var r=n.length-1;r===0?n=e.reactions=null:(n[i]=n[r],n.pop())}}if(n===null&&(e.f&2)!==0&&(It===null||!Ni.call(It,e))){var o=e;(o.f&512)!==0&&(o.f^=512,o.f&=-65537),o.v!==Ue&&Or(o),o.ac!==null&&ii(()=>{o.ac.abort(_i),o.ac=null,Be(o,2048)}),Xf(o),lr(o,0)}}function lr(t,e){var n=t.deps;if(n!==null)for(var i=e;i<n.length;i++)yh(t,n[i])}function oi(t){var e=t.f;if((e&16384)===0){Be(t,1024);var n=ae,i=Bs;if(ae=t,Bs=(e&96)===0,H){var r=pn;Es(t.component_function);var o=Hn;Rr(t.dev_stack??Hn)}try{(e&16777232)!==0?gc(t):Po(t),al(t);var a=Ss(t);if(t.teardown=typeof a=="function"?a:null,t.wv=wc,H&&Fn&&(t.f&2048)!==0&&t.deps!==null)for(var l of t.deps)l.set_during_effect&&(l.wv=Wr(),l.set_during_effect=!1)}finally{Bs=i,ae=n,H&&(Es(r),Rr(o))}}}function s(t){var e=t.f,n=(e&2)!==0;if(bc?.add(t),me!==null&&!Kt){var i=ae!==null&&(ae.f&16384)!==0;if(!i&&(Pn===null||!Pn.has(t))){var r=me.deps;if((me.f&2097152)!==0)t.rv<ur&&(t.rv=ur,It===null&&r!==null&&r[qt]===t?qt++:It===null?It=[t]:It.push(t));else{me.deps??=[],Ni.call(me.deps,t)||me.deps.push(t);var o=t.reactions;o===null?t.reactions=[me]:Ni.call(o,me)||o.push(me)}}}if(H){if(!Kt&&an&&be===null&&Ti===null&&!an.warned&&(an.effect.f&2097152)===0&&!an.effect_deps.has(t)){an.warned=!0,Nf(t.label);var a=Mn("traced at");a&&console.warn(a)}if(Ro.delete(t),Fn&&!Kt&&Fo!==null&&me!==null&&Fo.reaction===me){if(t.trace)t.trace();else if(a=Mn("traced at"),a){var l=Fo.entries.get(t);l===void 0&&(l={traces:[]},Fo.entries.set(t,l));var d=l.traces[l.traces.length-1];a.stack!==d?.stack&&l.traces.push(a)}}}if(wn&&Ei.has(t))return Ei.get(t);if(n){var u=t;if(wn){var c=u.v;return((u.f&1024)===0&&u.reactions!==null||Ec(u))&&(c=Oo(u)),Ei.set(u,c),c}var f=(u.f&512)===0&&!Kt&&me!==null&&(Bs||(me.f&512)!==0),p=(u.f&32768)===0;Fi(u)&&(f&&(u.f|=512),Ya(u)),f&&!p&&(Ja(u),yc(u))}if(St?.has(t))return St.get(t);if((t.f&8388608)!==0)throw t.v;return t.v}function yc(t){if(t.f|=512,t.deps!==null)for(let e of t.deps)(e.reactions??=[]).push(t),(e.f&2)!==0&&(e.f&512)===0&&(Ja(e),yc(e))}function Ec(t){if(t.v===Ue)return!0;if(t.deps===null)return!1;for(let e of t.deps)if(Ei.has(e)||(e.f&2)!==0&&Ec(e))return!0;return!1}function Ze(t){var e=Kt;try{return Kt=!0,t()}finally{Kt=e}}var Go=Symbol("events"),dl=new Set,Rs=new Set;function we(t,e,n){(e[Go]??={})[t]=n}function rt(t){for(var e=0;e<t.length;e++)dl.add(t[e]);for(var n of Rs)n(t)}var Ac=null;function fl(t){var e=this,n=e.ownerDocument,i=t.type,r=t.composedPath?.()||[],o=r[0]||t.target;Ac=t;var a=0,l=Ac===t&&t[Go];if(l){var d=r.indexOf(l);if(d!==-1&&(e===document||e===window)){t[Go]=e;return}var u=r.indexOf(e);if(u===-1)return;d<=u&&(a=d)}if(o=r[a]||t.target,o!==e){jt(t,"currentTarget",{configurable:!0,get(){return o||n}});var c=me,f=ae;wt(null),xt(null);try{for(var p,m=[];o!==null&&o!==e;){try{var g=o[Go]?.[i];g!=null&&(!o.disabled||t.target===o)&&g.call(o,t)}catch(x){p?m.push(x):p=x}if(t.cancelBubble)break;a++,o=a<r.length?r[a]:null}if(p){for(let x of m)queueMicrotask(()=>{throw x});throw p}}finally{t[Go]=e,delete t.currentTarget,wt(c),xt(f)}}}var Eh=globalThis?.window?.trustedTypes&&globalThis.window.trustedTypes.createPolicy("svelte-trusted-html",{createHTML:t=>t});function Lc(t){return Eh?.createHTML(t)??t}function Os(t){var e=si("template");return e.innerHTML=Lc(t.replaceAll("<!>","<!---->")),e.content}function Ft(t,e){var n=ae;n.nodes===null&&(n.nodes={start:t,end:e,a:null,t:null})}function O(t,e){var n=(e&1)!==0,i=(e&2)!==0,r,o=!t.startsWith("<!>");return()=>{if(le)return Ft(_e,null),_e;r===void 0&&(r=Os(o?t:"<!>"+t),n||(r=Qe(r)));var a=i||Ho?document.importNode(r,!0):r.cloneNode(!0);if(n){var l=Qe(a),d=a.lastChild;Ft(l,d)}else Ft(a,a);return a}}function Ih(t,e,n="svg"){var i=!t.startsWith("<!>"),r=(e&1)!==0,o=`<${n}>${i?t:"<!>"+t}</${n}>`,a;return()=>{if(le)return Ft(_e,null),_e;if(!a){var l=Os(o),d=Qe(l);if(r)for(a=document.createDocumentFragment();Qe(d);)a.appendChild(Qe(d));else a=Qe(d)}var u=a.cloneNode(!0);if(r){var c=Qe(u),f=u.lastChild;Ft(c,f)}else Ft(u,u);return u}}function Ai(t,e){return Ih(t,e,"svg")}function pe(){if(le)return Ft(_e,null),_e;var t=document.createDocumentFragment(),e=document.createComment(""),n=yt();return t.append(e,n),Ft(e,n),t}function D(t,e){if(le){var n=ae;((n.f&32768)===0||n.nodes.end===null)&&(n.nodes.end=_e),At();return}t!==null&&t.before(e)}var Sh=/\r/g;function Ic(t){t=t.replace(Sh,"");let e=5381,n=t.length;for(;n--;)e=(e<<5)-e^t.charCodeAt(n);return(e>>>0).toString(36)}var Ch=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","disabled","formnovalidate","indeterminate","inert","ismap","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","seamless","selected","webkitdirectory","defer","disablepictureinpicture","disableremoteplayback"];var h0=[...Ch,"formNoValidate","isMap","noModule","playsInline","readOnly","value","volume","defaultValue","defaultChecked","srcObject","noValidate","allowFullscreen","disablePictureInPicture","disableRemotePlayback"];var Nh=["touchstart","touchmove"];function Sc(t){return Nh.includes(t)}var $h=["$state","$state.raw","$derived","$derived.by"],m0=[...$h,"$state.eager","$state.snapshot","$props","$props.id","$bindable","$effect","$effect.pre","$effect.tracking","$effect.root","$effect.pending","$inspect","$inspect().with","$inspect.trace","$host"];function Ps(t){return t?.replace(/\//g,"/\u200B")}var cl=!0;function $e(t,e){var n=e==null?"":typeof e=="object"?`${e}`:e;n!==(t[$o]??=t.nodeValue)&&(t[$o]=n,t.nodeValue=`${n}`)}function qr(t,e){return Cc(t,e)}function pl(t,e){Fs(),e.intro=e.intro??!1;let n=e.target,i=le,r=_e;try{for(var o=Qe(n);o&&(o.nodeType!==un||o.data!=="[");)o=Lt(o);if(!o)throw Xn;mt(!0),Me(o);let a=Cc(t,{...e,anchor:o});return mt(!1),a}catch(a){if(a instanceof Error&&a.message.split(`
`).some(l=>l.startsWith("https://svelte.dev/e/")))throw a;return a!==Xn&&console.warn("Failed to hydrate: ",a),e.recover===!1&&xf(),Fs(),Bo(n),mt(!1),qr(t,e)}finally{mt(i),Me(r)}}var js=new Map;function Cc(t,{target:e,anchor:n,props:i={},events:r,context:o,intro:a=!0,transformError:l}){Fs();var d=void 0,u=mc(()=>{var c=n??e.appendChild(yt());Ga(c,{pending:()=>{}},m=>{de({});var g=Ae;if(o&&(g.c=o),r&&(i.$$events=r),le&&Ft(m,null),cl=a,d=t(m,i)||{},cl=!0,le&&(ae.nodes.end=_e,_e===null||_e.nodeType!==un||_e.data!=="]"))throw $i(),Xn;fe()},l);var f=new Set,p=m=>{for(var g=0;g<m.length;g++){var x=m[g];if(!f.has(x)){f.add(x);var w=Sc(x);for(let y of[e,document]){var _=js.get(y);_===void 0&&(_=new Map,js.set(y,_));var L=_.get(x);L===void 0?(y.addEventListener(x,fl,{passive:w}),_.set(x,1)):_.set(x,L+1)}}}};return p(Dr(dl)),Rs.add(p),()=>{for(var m of f)for(let w of[e,document]){var g=js.get(w),x=g.get(m);--x==0?(w.removeEventListener(m,fl),g.delete(m),g.size===0&&js.delete(w)):g.set(m,x)}Rs.delete(p),c!==n&&c.parentNode?.removeChild(c)}});return ul.set(d,u),d}var ul=new WeakMap;function zo(t,e){let n=ul.get(t);return n?(ul.delete(t),n(e)):(H&&(Yt in t?Hf():Mf()),Promise.resolve())}var ai=class{anchor;#e=new Map;#t=new Map;#n=new Map;#l=new Set;#o=!0;constructor(e,n=!0){this.anchor=e,this.#o=n}#s=e=>{if(this.#e.has(e)){var n=this.#e.get(e),i=this.#t.get(n);if(i)Jr(i),this.#l.delete(n);else{var r=this.#n.get(n);r&&(Jr(r.effect),this.#t.set(n,r.effect),this.#n.delete(n),H&&(r.fragment.lastChild[Ha]=this.anchor),r.fragment.lastChild.remove(),this.anchor.before(r.fragment),i=r.effect)}for(let[o,a]of this.#e){if(this.#e.delete(o),o===e)break;let l=this.#n.get(a);l&&(tt(l.effect),this.#n.delete(a))}for(let[o,a]of this.#t){if(o===n||this.#l.has(o))continue;let l=()=>{if(Array.from(this.#e.values()).includes(o)){var u=document.createDocumentFragment();Pr(a,u),u.append(yt()),this.#n.set(o,{effect:a,fragment:u})}else tt(a);this.#l.delete(o),this.#t.delete(o)};this.#o||!i?(this.#l.add(o),ri(a,l,!1)):l()}}};#i=e=>{this.#e.delete(e);let n=Array.from(this.#e.values());for(let[i,r]of this.#n)n.includes(i)||(tt(r.effect),this.#n.delete(i))};ensure(e,n){var i=be,r=Ms();if(n&&!this.#t.has(e)&&!this.#n.has(e))if(r){var o=document.createDocumentFragment(),a=yt();o.append(a),this.#n.set(e,{effect:dt(()=>n(a)),fragment:o})}else this.#t.set(e,dt(()=>n(this.anchor)));if(this.#e.set(i,e),r){for(let[l,d]of this.#t)l===e?i.unskip_effect(d):i.skip_effect(d);for(let[l,d]of this.#n)l===e?i.unskip_effect(d.effect):i.skip_effect(d.effect);i.oncommit(this.#s),i.ondiscard(this.#i)}else le&&(this.anchor=_e),this.#s(i)}};function Mt(t,e,...n){var i=new ai(t);sn(()=>{let r=e()??null;H&&r==null&&yf(),i.ensure(r,r&&(o=>r(o,...n)))},65536)}if(H){let t=function(e){if(!(e in globalThis)){let n;Object.defineProperty(globalThis,e,{configurable:!0,get:()=>{if(n!==void 0)return n;Af(e)},set:i=>{n=i}})}};t("$state"),t("$effect"),t("$derived"),t("$inspect"),t("$props"),t("$bindable")}function Fh(t){Ae===null&&Mr("onMount"),bi&&Ae.l!==null?Mh(Ae).m.push(t):ye(()=>{let e=Ze(t);if(typeof e=="function")return e})}function ze(t){Ae===null&&Mr("onDestroy"),Fh(()=>()=>Ze(t))}function Mh(t){var e=t.l;return e.u??={a:[],b:[],m:[]}}function Y(t,e,n=!1){var i;le&&(i=_e,At());var r=new ai(t),o=n?65536:0;function a(l,d){if(le){var u=To(i);if(l!==parseInt(u.substring(1))){var c=ti();Me(c),r.anchor=c,mt(!1),r.ensure(l,d),mt(!0);return}}r.ensure(l,d)}sn(()=>{var l=!1;e((d,u=0)=>{l=!0,a(u,d)}),l||a(-1,null)},o)}function di(t,e){return e}function Gh(t,e,n){for(var i=[],r=e.length,o,a=e.length,l=0;l<r;l++){let f=e[l];ri(f,()=>{if(o){if(o.pending.delete(f),o.done.add(f),o.pending.size===0){var p=t.outrogroups;hl(t,Dr(o.done)),p.delete(o),p.size===0&&(t.outrogroups=null)}}else a-=1},!1)}if(a===0){var d=i.length===0&&n!==null;if(d){var u=n,c=u.parentNode;Bo(c),c.append(u),t.items.clear()}hl(t,e,!d)}else o={pending:new Set(e),done:new Set},(t.outrogroups??=new Set).add(o)}function hl(t,e,n=!0){var i;if(t.pending.size>0){i=new Set;for(let a of t.pending.values())for(let l of a)i.add(t.items.get(l).e)}for(var r=0;r<e.length;r++){var o=e[r];if(i?.has(o)){o.f|=33554432;let a=document.createDocumentFragment();Pr(o,a)}else tt(e[r],n)}}var Dc;function fi(t,e,n,i,r,o=null){var a=t,l=new Map,d=(e&4)!==0;if(d){var u=t;a=le?Me(Qe(u)):u.appendChild(yt())}le&&At();var c=null,f=Gr(()=>{var y=n();return vi(y)?y:y==null?[]:Dr(y)});H&&Ut(f,"{#each ...}");var p,m=new Map,g=!0;function x(y){(L.effect.f&16384)===0&&(L.pending.delete(y),L.fallback=c,zh(L,p,a,e,i),c!==null&&(p.length===0?(c.f&33554432)===0?Jr(c):(c.f^=33554432,Qo(c,null,a)):ri(c,()=>{c=null})))}function w(y){L.pending.delete(y)}var _=sn(()=>{p=s(f);var y=p.length;let C=!1;if(le){var S=To(a)==="[!";S!==(y===0)&&(a=ti(),Me(a),mt(!1),C=!0)}for(var E=new Set,h=be,b=Ms(),A=0;A<y;A+=1){le&&_e.nodeType===un&&_e.data==="]"&&(a=_e,C=!0,mt(!1));var T=p[A],M=i(T,A);if(H){var U=i(T,A);M!==U&&gf(String(A),String(M),String(U))}var P=g?null:l.get(M);P?(P.v&&On(P.v,T),P.i&&On(P.i,A),b&&h.unskip_effect(P.e)):(P=Wh(l,g?a:Dc??=yt(),T,M,A,r,e,n),g||(P.e.f|=33554432),l.set(M,P)),E.add(M)}if(y===0&&o&&!c&&(g?c=dt(()=>o(a)):(c=dt(()=>o(Dc??=yt())),c.f|=33554432)),y>E.size&&(H?Qh(p,i):Ra("","","")),le&&y>0&&Me(ti()),!g)if(m.set(h,E),b){for(let[J,ee]of l)E.has(J)||h.skip_effect(ee.e);h.oncommit(x),h.ondiscard(w)}else x(h);C&&mt(!0),s(f)}),L={effect:_,flags:e,items:l,pending:m,outrogroups:null,fallback:c};g=!1,le&&(a=_e)}function Wo(t){for(;t!==null&&(t.f&32)===0;)t=t.next;return t}function zh(t,e,n,i,r){var o=(i&8)!==0,a=e.length,l=t.items,d=Wo(t.effect.first),u,c=null,f,p=[],m=[],g,x,w,_;if(o)for(_=0;_<a;_+=1)g=e[_],x=r(g,_),w=l.get(x).e,(w.f&33554432)===0&&(w.nodes?.a?.measure(),(f??=new Set).add(w));for(_=0;_<a;_+=1){if(g=e[_],x=r(g,_),w=l.get(x).e,t.outrogroups!==null)for(let T of t.outrogroups)T.pending.delete(w),T.done.delete(w);if((w.f&8192)!==0&&(Jr(w),o&&(w.nodes?.a?.unfix(),(f??=new Set).delete(w))),(w.f&33554432)!==0)if(w.f^=33554432,w===d)Qo(w,null,n);else{var L=c?c.next:d;w===t.effect.last&&(t.effect.last=w.prev),w.prev&&(w.prev.next=w.next),w.next&&(w.next.prev=w.prev),Hi(t,c,w),Hi(t,w,L),Qo(w,L,n),c=w,p=[],m=[],d=Wo(c.next);continue}if(w!==d){if(u!==void 0&&u.has(w)){if(p.length<m.length){var y=m[0],C;c=y.prev;var S=p[0],E=p[p.length-1];for(C=0;C<p.length;C+=1)Qo(p[C],y,n);for(C=0;C<m.length;C+=1)u.delete(m[C]);Hi(t,S.prev,E.next),Hi(t,c,S),Hi(t,E,y),d=y,c=E,_-=1,p=[],m=[]}else u.delete(w),Qo(w,d,n),Hi(t,w.prev,w.next),Hi(t,w,c===null?t.effect.first:c.next),Hi(t,c,w),c=w;continue}for(p=[],m=[];d!==null&&d!==w;)(u??=new Set).add(d),m.push(d),d=Wo(d.next);if(d===null)continue}(w.f&33554432)===0&&p.push(w),c=w,d=Wo(w.next)}if(t.outrogroups!==null){for(let T of t.outrogroups)T.pending.size===0&&(hl(t,Dr(T.done)),t.outrogroups?.delete(T));t.outrogroups.size===0&&(t.outrogroups=null)}if(d!==null||u!==void 0){var h=[];if(u!==void 0)for(w of u)(w.f&8192)===0&&h.push(w);for(;d!==null;)(d.f&8192)===0&&d!==t.fallback&&h.push(d),d=Wo(d.next);var b=h.length;if(b>0){var A=(i&4)!==0&&a===0?n:null;if(o){for(_=0;_<b;_+=1)h[_].nodes?.a?.measure();for(_=0;_<b;_+=1)h[_].nodes?.a?.fix()}Gh(t,h,A)}}o&&kt(()=>{if(f!==void 0)for(w of f)w.nodes?.a?.apply()})}function Wh(t,e,n,i,r,o,a,l){var d=(a&1)!==0?(a&16)===0?ir(n,!1,!1):Qt(n):null,u=(a&2)!==0?Qt(r):null;return H&&d&&(d.trace=()=>{l()[u?.v??r]}),{v:d,i:u,e:dt(()=>(o(e,d??n,u??r,l),()=>{t.delete(i)}))}}function Qo(t,e,n){if(t.nodes)for(var i=t.nodes.start,r=t.nodes.end,o=e&&(e.f&33554432)===0?e.nodes.start:n;i!==null;){var a=Lt(i);if(o.before(i),i===r)return;i=a}}function Hi(t,e,n){e===null?t.effect.first=n:e.next=n,n===null?t.effect.last=e:n.prev=e}function Qh(t,e){let n=new Map,i=t.length;for(let r=0;r<i;r++){let o=e(t[r],r);if(n.has(o)){let a=String(n.get(o)),l=String(r),d=String(o);d.startsWith("[object ")&&(d=null),Ra(a,l,d)}n.set(o,r)}}function Vh(t,e,n){if(!e||e===Ic(String(n??"")))return;let i,r=t.__svelte_meta?.loc;r?i=`near ${r.file}:${r.line}:${r.column}`:pn?.[tn]&&(i=`in ${pn[tn]}`),Ff(Ps(i))}function pr(t,e,n=!1,i=!1,r=!1,o=!1){var a=t,l="";if(n){var d=t;le&&(a=Me(Qe(d)))}X(()=>{var u=ae;if(l===(l=e()??"")){le&&At();return}if(n&&!le){u.nodes=null,d.innerHTML=l,l!==""&&Ft(Qe(d),d.lastChild);return}if(u.nodes!==null&&(ll(u.nodes.start,u.nodes.end),u.nodes=null),l!==""){if(le){for(var c=_e.data,f=At(),p=f;f!==null&&(f.nodeType!==un||f.data!=="");)p=f,f=Lt(f);if(f===null)throw $i(),Xn;H&&!o&&Vh(f.parentNode,c,l),Ft(_e,p),a=Me(f);return}var m=i?So:r?$a:void 0,g=si(i?"svg":r?"math":"template",m);g.innerHTML=l;var x=i||r?g:g.content;if(Ft(Qe(x),x.lastChild),i||r)for(;Qe(x);)a.before(Qe(x));else a.before(x)}})}function lt(t,e){var n=void 0,i;sl(()=>{n!==(n=e())&&(i&&(tt(i),i=null),n&&(i=dt(()=>{yn(()=>n(t))})))})}function Mc(t){var e,n,i="";if(typeof t=="string"||typeof t=="number")i+=t;else if(typeof t=="object")if(Array.isArray(t)){var r=t.length;for(e=0;e<r;e++)t[e]&&(n=Mc(t[e]))&&(i&&(i+=" "),i+=n)}else for(n in t)t[n]&&(i&&(i+=" "),i+=n);return i}function Hc(){for(var t,e,n=0,i="",r=arguments.length;n<r;n++)(t=arguments[n])&&(e=Mc(t))&&(i&&(i+=" "),i+=e);return i}function ln(t){return typeof t=="object"?Hc(t):t??""}var Bc=[...` 	
\r\f\xA0\v\uFEFF`];function Oc(t,e,n){var i=t==null?"":""+t;if(e&&(i=i?i+" "+e:e),n){for(var r of Object.keys(n))if(n[r])i=i?i+" "+r:r;else if(i.length)for(var o=r.length,a=0;(a=i.indexOf(r,a))>=0;){var l=a+o;(a===0||Bc.includes(i[a-1]))&&(l===i.length||Bc.includes(i[l]))?i=(a===0?"":i.substring(0,a))+i.substring(l+1):a=l}}return i===""?null:i}function Rc(t,e=!1){var n=e?" !important;":";",i="";for(var r of Object.keys(t)){var o=t[r];o!=null&&o!==""&&(i+=" "+r+": "+o+n)}return i}function ml(t){return t[0]!=="-"||t[1]!=="-"?t.toLowerCase():t}function Pc(t,e){if(e){var n="",i,r;if(Array.isArray(e)?(i=e[0],r=e[1]):i=e,t){t=String(t).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var o=!1,a=0,l=!1,d=[];i&&d.push(...Object.keys(i).map(ml)),r&&d.push(...Object.keys(r).map(ml));var u=0,c=-1;let x=t.length;for(var f=0;f<x;f++){var p=t[f];if(l?p==="/"&&t[f-1]==="*"&&(l=!1):o?o===p&&(o=!1):p==="/"&&t[f+1]==="*"?l=!0:p==='"'||p==="'"?o=p:p==="("?a++:p===")"&&a--,!l&&o===!1&&a===0){if(p===":"&&c===-1)c=f;else if(p===";"||f===x-1){if(c!==-1){var m=ml(t.substring(u,c).trim());if(!d.includes(m)){p!==";"&&f++;var g=t.substring(u,f).trim();n+=" "+g+";"}}u=f+1,c=-1}}}}return i&&(n+=Rc(i)),r&&(n+=Rc(r,!0)),n=n.trim(),n===""?null:n}return t==null?null:String(t)}function Se(t,e,n,i,r,o){var a=t[Co];if(le||a!==n||a===void 0){var l=Oc(n,i,o);(!le||l!==t.getAttribute("class"))&&(l==null?t.removeAttribute("class"):e?t.className=l:t.setAttribute("class",l)),t[Co]=n}else if(o&&r!==o)for(var d in o){var u=!!o[d];(r==null||u!==!!r[d])&&t.classList.toggle(d,u)}return o}function gl(t,e={},n,i){for(var r in n){var o=n[r];e[r]!==o&&(n[r]==null?t.style.removeProperty(r):t.style.setProperty(r,o,i))}}function Q(t,e,n,i){var r=t[No];if(le||r!==e){var o=Pc(e,i);(!le||o!==t.getAttribute("style"))&&(o==null?t.removeAttribute("style"):t.style.cssText=o),t[No]=e}else i&&(Array.isArray(i)?(gl(t,n?.[0],i[0]),gl(t,n?.[1],i[1],"important")):gl(t,n,i));return i}var tm=Symbol("is custom element"),nm=Symbol("is html"),im=Ba?"link":"LINK";function G(t,e,n,i){var r=rm(t);if(le&&(r[e]=t.getAttribute(e),e==="src"||e==="srcset"||e==="href"&&t.nodeName===im)){i||sm(t,e,n??"");return}r[e]!==(r[e]=n)&&(e==="loading"&&(t[cf]=n),n==null?t.removeAttribute(e):typeof n!="string"&&om(t).includes(e)?t[e]=n:t.setAttribute(e,n))}function rm(t){return t[vs]??={[tm]:t.nodeName.includes("-"),[nm]:t.namespaceURI===us}}var jc=new Map;function om(t){var e=t.getAttribute("is")||t.nodeName,n=jc.get(e);if(n)return n;jc.set(e,n=[]);for(var i,r=t,o=Element.prototype;o!==r;){i=Ta(r);for(var a in i)i[a].set&&a!=="innerHTML"&&a!=="textContent"&&a!=="innerText"&&n.push(a);r=Tr(r)}return n}function sm(t,e,n){H&&(e==="srcset"&&am(t,n)||vl(t.getAttribute(e)??"",n)||Tf(e,t.outerHTML.replace(t.innerHTML,t.innerHTML&&"..."),String(n)))}function vl(t,e){return t===e?!0:new URL(t,document.baseURI).href===new URL(e,document.baseURI).href}function Uc(t){return t.split(",").map(e=>e.trim().split(" ").filter(Boolean))}function am(t,e){var n=Uc(t.srcset),i=Uc(e);return i.length===n.length&&i.every(([r,o],a)=>o===n[a][1]&&(vl(n[a][0],r)||vl(r,n[a][0])))}var dm={get(t,e){if(!t.exclude.has(e))return t.props[e]},set(t,e){return H&&Ef(`${t.name}.${String(e)}`),!1},getOwnPropertyDescriptor(t,e){if(!t.exclude.has(e)&&e in t.props)return{enumerable:!0,configurable:!0,value:t.props[e]}},has(t,e){return t.exclude.has(e)?!1:e in t.props},ownKeys(t){return Reflect.ownKeys(t.props).filter(e=>!t.exclude.has(e))}};function ue(t,e,n){return new Proxy(H?{props:t,exclude:e,name:n}:{props:t,exclude:e},dm)}function Gc(t){return new bl(t)}var bl=class{#e;#t;constructor(e){var n=new Map,i=(o,a)=>{var l=ir(a,!1,!1);return n.set(o,l),l};let r=new Proxy({...e.props||{},$$events:{}},{get(o,a){return s(n.get(a)??i(a,Reflect.get(o,a)))},has(o,a){return a===ms?!0:(s(n.get(a)??i(a,Reflect.get(o,a))),Reflect.has(o,a))},set(o,a,l){return oe(n.get(a)??i(a,l),l),Reflect.set(o,a,l)}});this.#t=(e.hydrate?pl:qr)(e.component,{target:e.target,anchor:e.anchor,props:r,context:e.context,intro:e.intro??!1,recover:e.recover,transformError:e.transformError}),!gt&&(!e?.props?.$$host||e.sync===!1)&&Vr(),this.#e=r.$$events;for(let o of Object.keys(this.#t))o==="$set"||o==="$destroy"||o==="$on"||jt(this,o,{get(){return this.#t[o]},set(a){this.#t[o]=a},enumerable:!0});this.#t.$set=o=>{Object.assign(r,o)},this.#t.$destroy=()=>{zo(this.#t)}}$set(e){this.#t.$set(e)}$on(e,n){this.#e[e]=this.#e[e]||[];let i=(...r)=>n.call(this,...r);return this.#e[e].push(i),()=>{this.#e[e]=this.#e[e].filter(r=>r!==i)}}$destroy(){this.#t.$destroy()}};var vm;typeof HTMLElement=="function"&&(vm=class extends HTMLElement{$$ctor;$$s;$$c;$$cn=!1;$$d={};$$r=!1;$$p_d={};$$l={};$$l_u=new Map;$$me;$$shadowRoot=null;constructor(t,e,n){super(),this.$$ctor=t,this.$$s=e,n&&(this.$$shadowRoot=this.attachShadow(n))}addEventListener(t,e,n){if(this.$$l[t]=this.$$l[t]||[],this.$$l[t].push(e),this.$$c){let i=this.$$c.$on(t,e);this.$$l_u.set(e,i)}super.addEventListener(t,e,n)}removeEventListener(t,e,n){if(super.removeEventListener(t,e,n),this.$$c){let i=this.$$l_u.get(e);i&&(i(),this.$$l_u.delete(e))}}async connectedCallback(){if(this.$$cn=!0,!this.$$c){let t=function(i){return r=>{let o=si("slot");i!=="default"&&(o.name=i),D(r,o)}};if(await Promise.resolve(),!this.$$cn||this.$$c)return;let e={},n=_m(this);for(let i of this.$$s)i in n&&(i==="default"&&!this.$$d.children?(this.$$d.children=t(i),e.default=!0):e[i]=t(i));for(let i of this.attributes){let r=this.$$g_p(i.name);r in this.$$d||(this.$$d[r]=wl(r,i.value,this.$$p_d,"toProp"))}for(let i in this.$$p_d)!(i in this.$$d)&&this[i]!==void 0&&(this.$$d[i]=this[i],delete this[i]);this.$$c=Gc({component:this.$$ctor,target:this.$$shadowRoot||this,props:{...this.$$d,$$slots:e,$$host:this}}),this.$$me=ol(()=>{Jt(()=>{this.$$r=!0;for(let i of Da(this.$$c)){if(!this.$$p_d[i]?.reflect)continue;this.$$d[i]=this.$$c[i];let r=wl(i,this.$$d[i],this.$$p_d,"toAttribute");r==null?this.removeAttribute(this.$$p_d[i].attribute||i):this.setAttribute(this.$$p_d[i].attribute||i,r)}this.$$r=!1})});for(let i in this.$$l)for(let r of this.$$l[i]){let o=this.$$c.$on(i,r);this.$$l_u.set(r,o)}this.$$l={}}}attributeChangedCallback(t,e,n){this.$$r||(t=this.$$g_p(t),this.$$d[t]=wl(t,n,this.$$p_d,"toProp"),this.$$c?.$set({[t]:this.$$d[t]}))}disconnectedCallback(){this.$$cn=!1,Promise.resolve().then(()=>{!this.$$cn&&this.$$c&&(this.$$c.$destroy(),this.$$me(),this.$$c=void 0)})}$$g_p(t){return Da(this.$$p_d).find(e=>this.$$p_d[e].attribute===t||!this.$$p_d[e].attribute&&e.toLowerCase()===t)||t}});function wl(t,e,n,i){let r=n[t]?.type;if(e=r==="Boolean"&&typeof e!="boolean"?e!=null:e,!i||!n[t])return e;if(i==="toAttribute")switch(r){case"Object":case"Array":return e==null?null:JSON.stringify(e);case"Boolean":return e?"":null;case"Number":return e??null;default:return e}else switch(r){case"Object":case"Array":return e&&JSON.parse(e);case"Boolean":return e;case"Number":return e!=null?+e:e;default:return e}}function _m(t){let e={};return t.childNodes.forEach(n=>{e[n.slot||"default"]=!0}),e}var nt="--diff-font-size--",De="--diff-aside-width--";var ci=()=>{let t=ce(!1);return ye(()=>{oe(t,!0)}),()=>s(t)};var zc=Symbol("fontSize");function Wc(t){Ye(zc,()=>t.diffViewFontSize||14)}function Kr(){return Ve(zc)}var Qc=Symbol("enableWrap");function Vc(t){Ye(Qc,()=>t.diffViewWrap)}function En(){return Ve(Qc)}var Yc=Symbol("renderWidget");function Jc(t){Ye(Yc,()=>t.renderWidgetLine)}function Xr(){return Ve(Yc)}var qc=Symbol("id");function Kc(t){Ye(qc,t)}function Gs(){return Ve(qc)}var Xc=Symbol("dom");function Zc(t){Ye(Xc,t)}function zs(){return Ve(Xc)}var eu=Symbol("extend");function tu(t){Ye(eu,()=>t.extendData)}function Zr(){return Ve(eu)}var nu=Symbol("widget");function iu(t){Ye(nu,()=>t)}function An(){return Ve(nu)}var ru=Symbol("renderExtendLine");function ou(t){Ye(ru,()=>t.renderExtendLine)}function eo(){return Ve(ru)}var su=Symbol("onAddWidgetClick");function au(t){Ye(su,()=>t.onAddWidgetClick)}function to(){return Ve(su)}var lu=Symbol("enableHighlight");function du(t){Ye(lu,()=>t.diffViewHighlight)}function no(){return Ve(lu)}var fu=Symbol("enableAddWidget");function cu(t){Ye(fu,()=>t.diffViewAddWidget)}function io(){return Ve(fu)}var uu=Symbol("mode");function pu(t){Ye(uu,()=>t.diffViewMode||Pt.Split)}function Ws(){return Ve(uu)}var xl=null,bm=(t,e)=>`${t.fontFamily}-${t.fontStyle}-${t.fontSize}-${e}`,wm=(t,e)=>bm(t,"0".repeat(e.length)),El=class{#e="";#t={};#n(){return xl=xl||document.createElement("canvas").getContext("2d"),xl}measure(e,n){let i=wm(n||{},e);if(this.#t[i])return this.#t[i];let r=this.#n();if(n){let a=`${n.fontFamily}-${n.fontStyle}-${n.fontSize}`;this.#e!==a&&(this.#e=a,r.font=`${n.fontStyle||""} ${n.fontSize||""} ${n.fontFamily||""}`)}else r.font="";return r.measureText(e).width}},yl=null,hu=()=>(yl=yl||new El,yl);var ro=({text:t,font:e})=>{let n=I(ci()),i=parseInt(e().fontSize||"14"),r=6;r+=i>10?(i-10)*.6:0;let o=ce(r*t().length);return ye(()=>{s(n)&&oe(o,hu().measure(t()||"",e()),!0)}),()=>s(o)};var Ln=()=>{window.getSelection()?.removeAllRanges()},mu=(t,e)=>{let n=function(i){i===null||i.target===null||(i.target===t?(e.scrollTop=t.scrollTop,e.scrollLeft=t.scrollLeft):(t.scrollTop=e.scrollTop,t.scrollLeft=e.scrollLeft))};return t.onscroll||(t.onscroll=n),e.onscroll||(e.onscroll=n),()=>{t.onscroll=null,e.onscroll=null}},Qs=t=>{if(t){let e=t.getRootNode();return e instanceof ShadowRoot?e:t.ownerDocument}return document},oo=t=>{if(t){if(typeof t.closest=="function")return t.closest('[data-component="git-diff-view"]')?.querySelector?.(".diff-view-wrapper")?.getAttribute?.("id");{let e=t;for(;e;){if(e.getAttribute&&e.getAttribute("data-component")==="git-diff-view")return e.querySelector(".diff-view-wrapper")?.getAttribute("id");e=e.parentElement}}}};var Al="--diff-add-content--",Ll="--diff-del-content--",gn="--diff-border--",kl="--diff-add-lineNumber--",Il="--diff-del-lineNumber--",Sl="--diff-plain-content--",Vs="--diff-expand-content--",ft="--diff-plain-lineNumber-color--",hr="--diff-expand-lineNumber-color--",Cl="--diff-plain-lineNumber--",xm="--diff-expand-lineNumber--",dn="--diff-hunk-content--",Un="--diff-hunk-content-color--",Gn="--diff-hunk-lineNumber--";var Ys="--diff-add-widget--",Js="--diff-add-widget-color--",Xt="--diff-empty-content--",Vo=(t,e,n)=>t?`var(${Al})`:e?`var(${Ll})`:n?`var(${Sl})`:`var(${Vs})`,Yo=(t,e,n)=>t?`var(${kl})`:e?`var(${Il})`:n?`var(${Cl})`:`var(${xm})`;var ym=new Set(["$$slots","$$events","$$legacy"]),Em=O('<div><button class="diff-add-widget z-[1] flex h-full w-full origin-center cursor-pointer items-center justify-center rounded-md text-[1.2em]">+</button></div>');function Bi(t,e){de(e,!0);let n=ue(e,ym);var i=Em(),r=$(i);N(i),X(()=>{G(i,"data-add-widget",R[e.side]),Se(i,1,"diff-add-widget-wrapper invisible select-none transition-transform hover:scale-110 group-hover:visible"+(e.className?" "+e.className:"")),Q(i,`
    ...
    `)}),we("mousedown",r,o=>{o.stopPropagation(),e.onOpenAddWidget(e.lineNumber,e.side),e.onWidgetClick?.(e.lineNumber,e.side)}),D(t,i),fe()}rt(["mousedown"]);Rf();var Am=Ai('<svg aria-label="No newline at end of file" role="img" viewBox="0 0 16 16" version="1.1" fill="currentColor"><path d="M4.25 7.25a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5h-7.5Z"></path><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0Zm-1.5 0a6.5 6.5 0 1 0-13 0 6.5 6.5 0 0 0 13 0Z"></path></svg>');function Jo(t){var e=Am();D(t,e)}var Lm=new Set(["$$slots","$$events","$$legacy"]),km=O('<span data-no-newline-at-end-of-file-symbol=""><!></span>'),Im=O('<span class="diff-line-content-raw"><span data-template=""></span><!></span>'),gu=O('<span class="diff-line-content-raw"> </span>'),Sm=O('<span class="diff-line-content-raw"><span data-template=""></span></span>');function qo(t,e){de(e,!0);let n=ue(e,Lm);e.diffLine?.changes?.hasLineChange?e.diffLine?.plainTemplate&&typeof Ao=="function"&&Ao({diffLine:e.diffLine,rawLine:e.rawLine,operator:e.operator||"add"}):e.plainLine&&!e.plainLine?.template&&(e.plainLine.template=La(e.plainLine.value));var r=pe(),o=ne(r);{var a=u=>{var c=pe(),f=ne(c);{var p=g=>{var x=Im(),w=$(x);pr(w,()=>e.diffLine.plainTemplate,!0),N(w);var _=K(w);{var L=y=>{var C=km(),S=$(C);Jo(S,{}),N(C),X(()=>{Se(C,1,ln(e.enableWrap?"block !text-red-500":"inline-block align-middle !text-red-500")),Q(C,`
						width: var(${nt});
						height: var(${nt})
					`)}),D(y,C)};Y(_,y=>{e.diffLine.changes.newLineSymbol===$r.NEWLINE&&y(L)})}N(x),D(g,x)},m=g=>{var x=gu(),w=$(x,!0);N(x),X(()=>$e(w,e.rawLine)),D(g,x)};Y(f,g=>{e.diffLine?.plainTemplate?g(p):g(m,-1)})}D(u,c)},l=u=>{var c=Sm(),f=$(c);pr(f,()=>e.plainLine.template,!0),N(f),N(c),D(u,c)},d=u=>{var c=gu(),f=$(c,!0);N(c),X(()=>$e(f,e.rawLine)),D(u,c)};Y(o,u=>{e.diffLine?.changes?.hasLineChange?u(a):e.plainLine?.template?u(l,1):u(d,-1)})}D(t,r),fe()}var Cm=new Set(["$$slots","$$events","$$legacy"]),Nm=O('<span data-no-newline-at-end-of-file-symbol=""><!></span>'),$m=O('<span class="diff-line-syntax-raw"><span data-template=""></span><!></span>'),vu=O("<span> </span>"),_u=O('<span class="diff-line-syntax-raw"></span>'),Dm=O('<span class="diff-line-syntax-raw"><span data-template=""></span></span>');function Nl(t,e){de(e,!0);let n=ue(e,Cm);e.diffLine?.changes?.hasLineChange?e.syntaxLine&&e.diffLine&&!e.diffLine?.syntaxTemplate&&typeof Lo=="function"&&Lo({diffFile:e.diffFile,diffLine:e.diffLine,syntaxLine:e.syntaxLine,operator:e.operator||"add"}):e.syntaxLine&&!e.syntaxLine.template&&(e.syntaxLine.template=Aa(e.syntaxLine));var r=pe(),o=ne(r);{var a=c=>{qo(c,{get rawLine(){return e.rawLine},get diffLine(){return e.diffLine},get operator(){return e.operator},get enableWrap(){return e.enableWrap}})},l=c=>{var f=pe(),p=ne(f);{var m=x=>{var w=$m(),_=$(w);pr(_,()=>e.diffLine.syntaxTemplate,!0),N(_);var L=K(_);{var y=C=>{var S=Nm(),E=$(S);Jo(E,{}),N(S),X(()=>{Se(S,1,ln(e.enableWrap?"block !text-red-500":"inline-block align-middle !text-red-500")),Q(S,`
                width: var(${nt});
                height: var(${nt});
              `)}),D(C,S)};Y(L,C=>{e.diffLine.changes.newLineSymbol===$r.NEWLINE&&C(y)})}N(w),D(x,w)},g=x=>{var w=_u();fi(w,21,()=>e.syntaxLine.nodeList,di,(_,L)=>{let y=()=>s(L).node,C=()=>s(L).wrapper;var S=vu(),E=$(S,!0);N(S),X(h=>{G(S,"data-start",y().startIndex),G(S,"data-end",y().endIndex),Se(S,1,h),Q(S,C()?.properties?.style),$e(E,y().value)},[()=>ln(C()?.properties?.className?.join(" "))]),D(_,S)}),N(w),D(x,w)};Y(p,x=>{e.diffLine?.syntaxTemplate?x(m):x(g,-1)})}D(c,f)},d=c=>{var f=Dm(),p=$(f);pr(p,()=>e.syntaxLine.template,!0),N(p),N(f),D(c,f)},u=c=>{var f=_u();fi(f,21,()=>e.syntaxLine.nodeList,di,(p,m)=>{let g=()=>s(m).node,x=()=>s(m).wrapper;var w=vu(),_=$(w,!0);N(w),X(L=>{G(w,"data-start",g().startIndex),G(w,"data-end",g().endIndex),Se(w,1,L),Q(w,x()?.properties?.style),$e(_,g().value)},[()=>ln(x()?.properties?.className?.join(" "))]),D(p,w)}),N(f),D(c,f)};Y(o,c=>{e.syntaxLine?e.diffLine?.changes?.hasLineChange?c(l,1):e.syntaxLine.template?c(d,2):c(u,-1):c(a)})}D(t,r),fe()}var Tm=new Set(["$$slots","$$events","$$legacy"]),Fm=O('<div class="diff-line-content-item pl-[2.0em]"><span class="diff-line-content-operator ml-[-1.5em] inline-block w-[1.5em] select-none indent-[0.2em]"> </span> <!></div>');function ui(t,e){de(e,!0);let n=ue(e,Tm),i=I(()=>e.diffLine?.type===He.Add),r=I(()=>e.diffLine?.type===He.Delete),o=I(()=>e.syntaxLine&&e.syntaxLine?.nodeList?.length>150);var a=Fm(),l=$(a),d=$(l,!0);N(l);var u=K(l,2);{var c=p=>{{let m=I(()=>s(i)?"add":s(r)?"del":void 0);Nl(p,{get operator(){return s(m)},get rawLine(){return e.rawLine},get diffFile(){return e.diffFile},get diffLine(){return e.diffLine},get syntaxLine(){return e.syntaxLine},get enableWrap(){return e.enableWrap}})}},f=p=>{{let m=I(()=>s(i)?"add":s(r)?"del":void 0);qo(p,{get operator(){return s(m)},get rawLine(){return e.rawLine},get diffLine(){return e.diffLine},get plainLine(){return e.plainLine},get enableWrap(){return e.enableWrap}})}};Y(u,p=>{e.enableHighlight&&e.syntaxLine&&!s(o)?p(c):p(f,-1)})}N(a),X(()=>{Q(a,`
		white-space: ${e.enableWrap?"pre-wrap":"pre"};
		word-break: ${e.enableWrap?"break-all":"initial"}
	`),G(l,"data-operator",s(i)?"+":s(r)?"-":void 0),$e(d,s(i)?"+":s(r)?"-":" ")}),D(t,a),fe()}var Mm=new Set(["$$slots","$$events","$$legacy"]),Hm=O('<td class="diff-line-old-num group relative w-[1%] min-w-[40px] select-none pl-[10px] pr-[10px] text-right align-top"><!> <span> </span></td> <td class="diff-line-old-content group relative pr-[10px] align-top"><!> <!></td>',1),Bm=O('<td class="diff-line-old-placeholder select-none"><span>&ensp;</span></td>'),Rm=O('<td class="diff-line-new-num group relative w-[1%] min-w-[40px] select-none border-l-[1px] pl-[10px] pr-[10px] text-right align-top"><!> <span> </span></td> <td class="diff-line-new-content group relative pr-[10px] align-top"><!> <!></td>',1),Om=O('<td class="diff-line-new-placeholder select-none border-l-[1px]"><span>&ensp;</span></td>'),Pm=O('<tr class="diff-line"><!><!></tr>');function $l(t,e){de(e,!0);let n=ue(e,Mm),i=I(An()),r=I(io()),o=I(no()),a=I(to()),l=I(()=>e.diffFile.getSplitLeftLine(e.index)),d=I(()=>e.diffFile.getSplitRightLine(e.index)),u=()=>e.diffFile.getOldSyntaxLine(s(l)?.lineNumber||0),c=()=>e.diffFile.getNewSyntaxLine(s(d)?.lineNumber||0),f=()=>e.diffFile.getOldPlainLine(s(l)?.lineNumber||0),p=()=>e.diffFile.getNewPlainLine(s(d)?.lineNumber||0),m=ce(Le(u())),g=ce(Le(c())),x=ce(Le(f())),w=ce(Le(p())),_=I(()=>!!s(l)?.diff||!!s(d)?.diff),L=I(()=>Zi(s(l)?.diff)||Zi(s(d)?.diff)),y=I(()=>s(l)?.isHidden&&s(d)?.isHidden),C=()=>s(l)?.diff?.type===He.Delete,S=()=>s(d)?.diff?.type===He.Add,E=()=>{oe(m,u(),!0),oe(g,c(),!0),oe(x,f(),!0),oe(w,p(),!0)},h={current:()=>{}};ye(()=>{h.current(),E(),h.current=e.diffFile.subscribe(E)}),ze(()=>h.current());let b=(U,P)=>{s(i).side=P,s(i).lineNumber=U};var A=pe(),T=ne(A);{var M=U=>{var P=Pm(),J=$(P);{var ee=j=>{var z=Hm(),B=ne(z),he=$(B);{var ie=ge=>{{let ke=I(()=>s(l)?.lineNumber||0);Bi(ge,{get index(){return e.index},get lineNumber(){return s(ke)},get side(){return R.old},get diffFile(){return e.diffFile},get onWidgetClick(){return s(a)},className:"absolute left-[100%] z-[1] translate-x-[-50%]",onOpenAddWidget:b})}};Y(he,ge=>{s(_)&&s(r)&&ge(ie)})}var Z=K(he,2),ve=$(Z,!0);N(Z),N(B);var se=K(B,2),te=$(se);{var xe=ge=>{{let ke=I(()=>s(l)?.lineNumber||0);Bi(ge,{get index(){return e.index},get lineNumber(){return s(ke)},get side(){return R.old},get diffFile(){return e.diffFile},get onWidgetClick(){return s(a)},className:"absolute right-[100%] z-[1] translate-x-[50%]",onOpenAddWidget:b})}};Y(te,ge=>{s(_)&&s(r)&&ge(xe)})}var Ee=K(te,2);{let ge=I(()=>s(l)?.value||""),ke=I(()=>s(l)?.diff),Oe=I(()=>!!s(o));ui(Ee,{enableWrap:!0,get diffFile(){return e.diffFile},get rawLine(){return s(ge)},get diffLine(){return s(ke)},get plainLine(){return s(x)},get syntaxLine(){return s(m)},get enableHighlight(){return s(Oe)}})}N(se),X((ge,ke)=>{Q(B,ge),G(B,"data-side",R[R.old]),G(Z,"data-line-num",s(l)?.lineNumber),Q(Z,`opacity: ${s(L)?void 0:.5} `),$e(ve,s(l)?.lineNumber),Q(se,ke),G(se,"data-side",R[R.old])},[()=>`
					background-color: ${Yo(!1,C(),s(_))};
					color: var(${s(_)?ft:hr})
				`,()=>` background-color: ${Vo(!1,C(),s(_))} `]),D(j,z)},re=j=>{var z=Bm();G(z,"colspan",2),X(()=>Q(z,`background-color: var(${Xt}) `)),D(j,z)};Y(J,j=>{s(l)?.lineNumber?j(ee):j(re,-1)})}var q=K(J);{var F=j=>{var z=Rm(),B=ne(z),he=$(B);{var ie=ge=>{{let ke=I(()=>s(d)?.lineNumber||0);Bi(ge,{get index(){return e.index},get lineNumber(){return s(ke)},get side(){return R.new},get diffFile(){return e.diffFile},get onWidgetClick(){return s(a)},className:"absolute left-[100%] z-[1] translate-x-[-50%]",onOpenAddWidget:b})}};Y(he,ge=>{s(_)&&s(r)&&ge(ie)})}var Z=K(he,2),ve=$(Z,!0);N(Z),N(B);var se=K(B,2),te=$(se);{var xe=ge=>{{let ke=I(()=>s(d)?.lineNumber||0);Bi(ge,{get index(){return e.index},get lineNumber(){return s(ke)},get side(){return R.new},get diffFile(){return e.diffFile},get onWidgetClick(){return s(a)},className:"absolute right-[100%] z-[1] translate-x-[50%]",onOpenAddWidget:b})}};Y(te,ge=>{s(_)&&s(r)&&ge(xe)})}var Ee=K(te,2);{let ge=I(()=>s(d)?.value||""),ke=I(()=>s(d)?.diff),Oe=I(()=>!!s(o));ui(Ee,{enableWrap:!0,get diffFile(){return e.diffFile},get rawLine(){return s(ge)},get diffLine(){return s(ke)},get plainLine(){return s(w)},get syntaxLine(){return s(g)},get enableHighlight(){return s(Oe)}})}N(se),X((ge,ke)=>{Q(B,ge),G(B,"data-side",R[R.new]),G(Z,"data-line-num",s(d)?.lineNumber),Q(Z,` opacity: ${s(L)?void 0:.5} `),$e(ve,s(d)?.lineNumber),Q(se,ke),G(se,"data-side",R[R.new])},[()=>`
					background-color: ${Yo(S(),!1,s(_))};
					color: var(${s(_)?ft:hr});
					border-left-color: var(${gn});
					border-left-style: solid
				`,()=>`background-color: ${Vo(S(),!1,s(_))} `]),D(j,z)},V=j=>{var z=Om();G(z,"colspan",2),X(()=>Q(z,`
					background-color: var(${Xt});
					border-left-color: var(${gn});
					border-left-style: solid;
				`)),D(j,z)};Y(q,j=>{s(d)?.lineNumber?j(F):j(V,-1)})}N(P),X(()=>{G(P,"data-line",e.lineNumber),G(P,"data-state",s(_)?"diff":"plain")}),D(U,P)};Y(T,U=>{s(y)||U(M)})}D(t,A),fe()}var jm=new Set(["$$slots","$$events","$$legacy"]),Um=O('<td class="diff-line-extend-old-content p-0"><div class="diff-line-extend-wrapper"><!></div></td>'),Gm=O('<td class="diff-line-extend-old-placeholder select-none p-0"></td>'),zm=O('<td class="diff-line-extend-new-content border-l-[1px] p-0"><div class="diff-line-extend-wrapper"><!></div></td>'),Wm=O('<td class="diff-line-extend-new-placeholder select-none border-l-[1px] p-0"></td>'),Qm=O('<tr data-state="extend" class="diff-line diff-line-extend"><!><!></tr>');function Dl(t,e){de(e,!0);let n=ue(e,jm),i=I(Zr()),r=I(eo()),o=I(()=>e.diffFile.getSplitLeftLine(e.index)),a=I(()=>e.diffFile.getSplitRightLine(e.index)),l=I(()=>e.diffFile.getExpandEnabled()),d=I(()=>s(i)?.oldFile?.[s(o)?.lineNumber||""]),u=I(()=>s(i)?.newFile?.[s(a)?.lineNumber||""]),c=I(()=>!!((s(d)||s(u))&&(!s(o)?.isHidden&&!s(a)?.isHidden||s(l))&&s(r)));var f=pe(),p=ne(f);{var m=g=>{var x=Qm(),w=$(x);{var _=E=>{var h=Um();G(h,"colspan",2);var b=$(h),A=$(b);Mt(A,()=>s(r),()=>({diffFile:e.diffFile,side:R.old,lineNumber:s(o)?.lineNumber||0,data:s(d)?.data,onUpdate:e.diffFile.notifyAll})),N(b),N(h),D(E,h)},L=E=>{var h=Gm();G(h,"colspan",2),X(()=>Q(h,`background-color: var(${Xt})`)),D(E,h)};Y(w,E=>{s(r)&&s(d)?E(_):E(L,-1)})}var y=K(w);{var C=E=>{var h=zm();G(h,"colspan",2);var b=$(h),A=$(b);Mt(A,()=>s(r),()=>({diffFile:e.diffFile,side:R.new,lineNumber:s(a)?.lineNumber||0,data:s(u)?.data,onUpdate:e.diffFile.notifyAll})),N(b),N(h),X(()=>Q(h,`border-left-color: var(${gn}); border-left-style: solid `)),D(E,h)},S=E=>{var h=Wm();G(h,"colspan",2),X(()=>Q(h,`
					background-color: var(${Xt});
					border-left-color: var(${gn});
					border-left-style: solid;
				`)),D(E,h)};Y(y,E=>{s(r)&&s(u)?E(C):E(S,-1)})}N(x),X(()=>G(x,"data-line",`${e.lineNumber}-extend`)),D(g,x)};Y(p,g=>{s(c)&&g(m)})}D(t,f),fe()}var Vm=new Set(["$$slots","$$events","$$legacy"]),Ym=Ai('<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16"><path d="M7.823 1.677 4.927 4.573A.25.25 0 0 0 5.104 5H7.25v3.236a.75.75 0 1 0 1.5 0V5h2.146a.25.25 0 0 0 .177-.427L8.177 1.677a.25.25 0 0 0-.354 0ZM13.75 11a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5Zm-3.75.75a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75ZM7.75 11a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5ZM4 11.75a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 1-.75-.75ZM1.75 11a.75.75 0 0 0 0 1.5h.5a.75.75 0 0 0 0-1.5h-.5Z"></path></svg>');function Ct(t,e){de(e,!0);let n=ue(e,Vm);var i=Ym();X(()=>Se(i,0,ln(e.className))),D(t,i),fe()}var Jm=new Set(["$$slots","$$events","$$legacy"]),qm=Ai('<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16"><path d="m8.177 14.323 2.896-2.896a.25.25 0 0 0-.177-.427H8.75V7.764a.75.75 0 1 0-1.5 0V11H5.104a.25.25 0 0 0-.177.427l2.896 2.896a.25.25 0 0 0 .354 0ZM2.25 5a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM6 4.25a.75.75 0 0 1-.75.75h-.5a.75.75 0 0 1 0-1.5h.5a.75.75 0 0 1 .75.75ZM8.25 5a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM12 4.25a.75.75 0 0 1-.75.75h-.5a.75.75 0 0 1 0-1.5h.5a.75.75 0 0 1 .75.75Zm2.25.75a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5Z"></path></svg>');function Nt(t,e){de(e,!0);let n=ue(e,Jm);var i=qm();X(()=>Se(i,0,ln(e.className))),D(t,i),fe()}var Km=new Set(["$$slots","$$events","$$legacy"]),Xm=Ai('<svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16"><path d="m8.177.677 2.896 2.896a.25.25 0 0 1-.177.427H8.75v1.25a.75.75 0 0 1-1.5 0V4H5.104a.25.25 0 0 1-.177-.427L7.823.677a.25.25 0 0 1 .354 0ZM7.25 10.75a.75.75 0 0 1 1.5 0V12h2.146a.25.25 0 0 1 .177.427l-2.896 2.896a.25.25 0 0 1-.354 0l-2.896-2.896A.25.25 0 0 1 5.104 12H7.25v-1.25Zm-5-2a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM6 8a.75.75 0 0 1-.75.75h-.5a.75.75 0 0 1 0-1.5h.5A.75.75 0 0 1 6 8Zm2.25.75a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5ZM12 8a.75.75 0 0 1-.75.75h-.5a.75.75 0 0 1 0-1.5h.5A.75.75 0 0 1 12 8Zm2.25.75a.75.75 0 0 0 0-1.5h-.5a.75.75 0 0 0 0 1.5h.5Z"></path></svg>');function kn(t,e){de(e,!0);let n=ue(e,Km);var i=Xm();X(()=>Se(i,0,ln(e.className))),D(t,i),fe()}var Zm=new Set(["$$slots","$$events","$$legacy"]),eg=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),tg=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),ng=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),ig=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),rg=O('<div class="min-h-[28px]">&ensp;</div>'),og=O('<tr data-state="hunk" class="diff-line diff-line-hunk"><td class="diff-line-hunk-action relative w-[1%] min-w-[40px] select-none p-[1px]"><!></td><td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td></tr>');function Tl(t,e){de(e,!0);let n=ue(e,Zm),i=I(()=>e.diffFile.getSplitHunkLine(e.index)),r=I(()=>e.diffFile.getExpandEnabled()),o=I(()=>s(r)&&s(i)?.splitInfo),a=()=>{let _=s(i);return _&&_.splitInfo&&_.splitInfo.endHiddenIndex-_.splitInfo.startHiddenIndex<je},l=ce(Le(a())),d=()=>{let _=s(i);return _&&_.splitInfo&&_.splitInfo.startHiddenIndex<_.splitInfo.endHiddenIndex},u=ce(Le(d())),c=I(()=>{let _=s(i);return _&&_.isFirst}),f=I(()=>{let _=s(i);return _&&e.diffFile._getIsPureDiffRender()&&!_.splitInfo}),p=I(()=>{let _=s(i);return _&&_.isLast}),m={current:()=>{}};ye(()=>{m.current();let _=()=>{oe(u,d(),!0),oe(l,a(),!0)};_(),m.current=e.diffFile.subscribe(_)}),ze(()=>m.current());var g=pe(),x=ne(g);{var w=_=>{var L=og(),y=$(L),C=$(y);{var S=T=>{var M=pe(),U=ne(M);{var P=q=>{var F=eg(),V=$(F);Ct(V,{className:"fill-current"}),N(F),we("click",F,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(q,F)},J=q=>{var F=tg(),V=$(F);Nt(V,{className:"fill-current"}),N(F),we("click",F,()=>e.diffFile.onSplitHunkExpand("down",e.index)),D(q,F)},ee=q=>{var F=ng(),V=$(F);kn(V,{className:"fill-current"}),N(F),we("click",F,()=>e.diffFile.onSplitHunkExpand("all",e.index)),D(q,F)},re=q=>{var F=ig(),V=ne(F),j=$(V);Nt(j,{className:"fill-current"}),N(V);var z=K(V,2),B=$(z);Ct(B,{className:"fill-current"}),N(z),we("click",V,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",z,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(q,F)};Y(U,q=>{s(c)?q(P):s(p)?q(J,1):s(l)?q(ee,2):q(re,-1)})}D(T,M)},E=T=>{var M=rg();D(T,M)};Y(C,T=>{s(o)?T(S):T(E,-1)})}N(y);var h=K(y);G(h,"colspan",3);var b=$(h),A=$(b,!0);N(b),N(h),N(L),X(()=>{G(L,"data-line",`${e.lineNumber}-hunk`),Q(y,`
				background-color: var(${Gn});
				color: var(${ft})
			`),Q(h,`background-color: var(${dn})`),Q(b,`
					color: var(${Un})
				`),$e(A,s(i)?.splitInfo?.plainText||s(i)?.text)}),D(_,L)};Y(x,_=>{(s(u)||s(f))&&_(w)})}D(t,g),fe()}rt(["click"]);var sg=new Set(["$$slots","$$events","$$legacy"]),bu=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),wu=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),xu=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),yu=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),Eu=O('<div class="min-h-[28px]">&ensp;</div>'),ag=O('<tr data-state="hunk" class="diff-line diff-line-hunk"><td class="diff-line-hunk-action relative w-[1%] min-w-[40px] select-none p-[1px]"><!></td><td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td><td class="diff-line-hunk-action relative z-[1] w-[1%] min-w-[40px] select-none border-l-[1px] p-[1px]"><!></td><td class="diff-line-hunk-content relative pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td></tr>');function Fl(t,e){de(e,!0);let n=ue(e,sg),i=I(()=>e.diffFile.getSplitHunkLine(e.index)),r=I(()=>e.diffFile.getExpandEnabled()),o=I(()=>s(r)&&s(i)?.splitInfo),a=()=>{let _=s(i);return _&&_.splitInfo&&_.splitInfo.endHiddenIndex-_.splitInfo.startHiddenIndex<je},l=ce(Le(a())),d=()=>{let _=s(i);return _&&_.splitInfo&&_.splitInfo.startHiddenIndex<_.splitInfo.endHiddenIndex},u=ce(Le(d())),c=I(()=>{let _=s(i);return _&&_.isFirst}),f=I(()=>{let _=s(i);return _&&e.diffFile._getIsPureDiffRender()&&!_.splitInfo}),p=I(()=>{let _=s(i);return _&&_.isLast}),m={current:()=>{}};ye(()=>{m.current();let _=()=>{oe(u,d(),!0),oe(l,a(),!0)};_(),m.current=e.diffFile.subscribe(_)}),ze(()=>m.current());var g=pe(),x=ne(g);{var w=_=>{var L=ag(),y=$(L),C=$(y);{var S=q=>{var F=pe(),V=ne(F);{var j=ie=>{var Z=bu(),ve=$(Z);Ct(ve,{className:"fill-current"}),N(Z),we("click",Z,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(ie,Z)},z=ie=>{var Z=wu(),ve=$(Z);Nt(ve,{className:"fill-current"}),N(Z),we("click",Z,()=>e.diffFile.onSplitHunkExpand("down",e.index)),D(ie,Z)},B=ie=>{var Z=xu(),ve=$(Z);kn(ve,{className:"fill-current"}),N(Z),we("click",Z,()=>e.diffFile.onSplitHunkExpand("all",e.index)),D(ie,Z)},he=ie=>{var Z=yu(),ve=ne(Z),se=$(ve);Nt(se,{className:"fill-current"}),N(ve);var te=K(ve,2),xe=$(te);Ct(xe,{className:"fill-current"}),N(te),we("click",ve,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",te,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(ie,Z)};Y(V,ie=>{s(c)?ie(j):s(p)?ie(z,1):s(l)?ie(B,2):ie(he,-1)})}D(q,F)},E=q=>{var F=Eu();D(q,F)};Y(C,q=>{s(o)?q(S):q(E,-1)})}N(y);var h=K(y),b=$(h),A=$(b,!0);N(b),N(h);var T=K(h),M=$(T);{var U=q=>{var F=pe(),V=ne(F);{var j=ie=>{var Z=bu(),ve=$(Z);Ct(ve,{className:"fill-current"}),N(Z),we("click",Z,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(ie,Z)},z=ie=>{var Z=wu(),ve=$(Z);Nt(ve,{className:"fill-current"}),N(Z),we("click",Z,()=>e.diffFile.onSplitHunkExpand("down",e.index)),D(ie,Z)},B=ie=>{var Z=xu(),ve=$(Z);kn(ve,{className:"fill-current"}),N(Z),we("click",Z,()=>e.diffFile.onSplitHunkExpand("all",e.index)),D(ie,Z)},he=ie=>{var Z=yu(),ve=ne(Z),se=$(ve);Nt(se,{className:"fill-current"}),N(ve);var te=K(ve,2),xe=$(te);Ct(xe,{className:"fill-current"}),N(te),we("click",ve,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",te,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(ie,Z)};Y(V,ie=>{s(c)?ie(j):s(p)?ie(z,1):s(l)?ie(B,2):ie(he,-1)})}D(q,F)},P=q=>{var F=Eu();D(q,F)};Y(M,q=>{s(o)?q(U):q(P,-1)})}N(T);var J=K(T),ee=$(J),re=$(ee,!0);N(ee),N(J),N(L),X(()=>{G(L,"data-line",`${e.lineNumber}-hunk`),Q(y,`
				background-color: var(${Gn});
				color: var(${ft})
			`),Q(h,`background-color: var(${dn})`),Q(b,`
					color: var(${Un})
			...
			`),Q(J,`background-color: var(${dn})`),Q(ee,`
					color: var(${Un})
				`),$e(re,s(i)?.splitInfo?.plainText||s(i)?.text)}),D(_,L)};Y(x,_=>{(s(u)||s(f))&&_(w)})}D(t,g),fe()}rt(["click"]);var lg=new Set(["$$slots","$$events","$$legacy"]);function qs(t,e){de(e,!0);let n=ue(e,lg),i=I(Ws());var r=pe(),o=ne(r);{var a=d=>{Tl(d,{get index(){return e.index},get diffFile(){return e.diffFile},get lineNumber(){return e.lineNumber}})},l=d=>{Fl(d,{get index(){return e.index},get diffFile(){return e.diffFile},get lineNumber(){return e.lineNumber}})};Y(o,d=>{s(i)===Pt.SplitGitHub||s(i)===Pt.Split?d(a):d(l,-1)})}D(t,r),fe()}var dg=new Set(["$$slots","$$events","$$legacy"]),fg=O('<td class="diff-line-widget-old-content p-0"><div class="diff-line-widget-wrapper"><!></div></td>'),cg=O('<td class="diff-line-widget-old-placeholder select-none p-0"></td>'),ug=O('<td class="diff-line-widget-new-content border-l-[1px] p-0"><div class="diff-line-widget-wrapper"><!></div></td>'),pg=O('<td class="diff-line-widget-new-placeholder select-none border-l-[1px] p-0"></td>'),hg=O('<tr data-state="widget" class="diff-line diff-line-widget"><!><!></tr>');function Ml(t,e){de(e,!0);let n=ue(e,dg),i=I(Xr()),r=I(An()),o=I(()=>e.diffFile.getSplitLeftLine(e.index)),a=I(()=>e.diffFile.getSplitRightLine(e.index)),l=I(()=>s(o)?.lineNumber&&s(r)?.side===R.old&&s(r)?.lineNumber===s(o)?.lineNumber),d=I(()=>s(a)?.lineNumber&&s(r)?.side===R.new&&s(r)?.lineNumber===s(a)?.lineNumber),u=I(()=>(!!s(l)||!!s(d))&&!s(o)?.isHidden&&!s(a)?.isHidden&&!!s(i)),c=()=>{s(r).side=void 0,s(r).lineNumber=void 0};var f=pe(),p=ne(f);{var m=g=>{var x=hg(),w=$(x);{var _=E=>{var h=fg();G(h,"colspan",2);var b=$(h),A=$(b);Mt(A,()=>s(i),()=>({diffFile:e.diffFile,side:R.old,lineNumber:s(o)?.lineNumber||0,onClose:c})),N(b),N(h),D(E,h)},L=E=>{var h=cg();G(h,"colspan",2),X(()=>Q(h,`background-color: var(${Xt})`)),D(E,h)};Y(w,E=>{s(l)&&s(i)?E(_):E(L,-1)})}var y=K(w);{var C=E=>{var h=ug();G(h,"colspan",2);var b=$(h),A=$(b);Mt(A,()=>s(i)??ht,()=>({diffFile:e.diffFile,side:R.new,lineNumber:s(a)?.lineNumber||0,onClose:c})),N(b),N(h),X(()=>Q(h,`border-left-color: var(${gn}); border-left-style: solid `)),D(E,h)},S=E=>{var h=pg();G(h,"colspan",2),X(()=>Q(h,`
					background-color: var(${Xt});
					border-left-color: var(${gn});
					border-left-style: solid;
				`)),D(E,h)};Y(y,E=>{s(d)&&s(i)?E(C):E(S,-1)})}N(x),X(()=>G(x,"data-line",`${e.lineNumber}-widget`)),D(g,x)};Y(p,g=>{s(u)&&g(m)})}D(t,f),fe()}var mg=new Set(["$$slots","$$events","$$legacy"]),gg=O("<!> <!> <!> <!>",1),vg=O('<div class="split-diff-view split-diff-view-warp w-full"><div class="diff-table-wrapper w-full"><style data-select-style=""></style> <table class="diff-table w-full table-fixed border-collapse border-spacing-0"><colgroup><col class="diff-table-old-num-col"/><col class="diff-table-old-content-col"/><col class="diff-table-new-num-col"/><col class="diff-table-new-content-col"/></colgroup><thead class="hidden"><tr><th scope="col">old line number</th><th scope="col">old line content</th><th scope="col">new line number</th><th scope="col">new line content</th></tr></thead><tbody class="diff-table-body leading-[1.6]"><!><!></tbody></table></div></div>');function Hl(t,e){de(e,!0);let n=ue(e,mg),i=()=>ds(e.diffFile),r=ce(Le(i())),o={current:void 0},a=ce(void 0),l=I(()=>Math.max(e.diffFile.splitLineLength,e.diffFile.fileLineLength).toString()),d=I(Kr()),u=I(()=>({fontSize:`${s(d)||14}px`,fontFamily:"Menlo, Consolas, monospace"})),c={current:()=>{}};ye(()=>{c.current();let A=()=>oe(r,i(),!0);A(),c.current=e.diffFile.subscribe(A)}),ze(()=>c.current());let f=A=>{let T=s(a);if(T)if(A){let M=A===R.old?R.new:R.old;T.textContent=`#diff-root${e.diffFile.getId()} [data-side="${R[M]}"] {user-select: none} 
#diff-root${e.diffFile.getId()} [data-state="extend"] {user-select: none} 
#diff-root${e.diffFile.getId()} [data-state="hunk"] {user-select: none} 
#diff-root${e.diffFile.getId()} [data-state="widget"] {user-select: none}`}else T.textContent=""},p=A=>{let T=A.target;if(T&&T instanceof HTMLElement&&T.nodeName==="BUTTON"){Ln();return}let M=oo(T);if(!(M&&M!==`diff-root${e.diffFile.getId()}`))for(;T&&T instanceof HTMLElement;){let U=T.getAttribute("data-state"),P=T.getAttribute("data-side");if(P&&o.current!==R[P]&&(o.current=R[P],f(R[P]),Ln()),U)if(U==="extend"||U==="hunk"||U==="widget"){o.current!==void 0&&(o.current=void 0,f(void 0),Ln());return}else return;T=T.parentElement}},m=I(ro({text:()=>s(l),font:()=>s(u)})),g=I(()=>Math.max(40,s(m)+25));var x=vg(),w=$(x),_=$(w);lt(_,()=>A=>oe(a,A,!0));var L=K(_,2),y=$(L),C=$(y),S=K(C,2);er(),N(y);var E=K(y,2),h=$(E);fi(h,17,()=>s(r),di,(A,T)=>{var M=gg(),U=ne(M);qs(U,{get index(){return s(T).index},get lineNumber(){return s(T).lineNumber},get diffFile(){return e.diffFile}});var P=K(U,2);$l(P,{get index(){return s(T).index},get lineNumber(){return s(T).lineNumber},get diffFile(){return e.diffFile}});var J=K(P,2);Ml(J,{get index(){return s(T).index},get lineNumber(){return s(T).lineNumber},get diffFile(){return e.diffFile}});var ee=K(J,2);Dl(ee,{get index(){return s(T).index},get lineNumber(){return s(T).lineNumber},get diffFile(){return e.diffFile}}),D(A,M)});var b=K(h);qs(b,{get index(){return e.diffFile.splitLineLength},get lineNumber(){return e.diffFile.splitLineLength},get diffFile(){return e.diffFile}}),N(E),N(L),N(w),N(x),X((A,T,M)=>{Q(w,A),G(C,"width",T),G(S,"width",M)},[()=>`
			${De}: ${Math.round(s(g))}px;
			font-family: Menlo, Consolas, monospace;
			font-size: var(${nt});
		`,()=>Math.round(s(g)),()=>Math.round(s(g))]),we("mousedown",E,p),D(t,x),fe()}rt(["mousedown"]);var _g=new Set(["$$slots","$$events","$$legacy"]),bg=O("<td><!> <span> </span></td> <td><!></td>",1),wg=O("<td><span>&ensp;</span></td>"),xg=O("<tr><!></tr>");function Bl(t,e){de(e,!0);let n=ue(e,_g),i=I(An()),r=I(io()),o=I(no()),a=I(to()),l=I(()=>e.side===R.old?e.diffFile.getSplitLeftLine(e.index):e.diffFile.getSplitRightLine(e.index)),d=I(()=>!!s(l)?.diff),u=I(()=>Zi(s(l)?.diff)),c=I(()=>s(l)?.isHidden),f=I(()=>!!s(l)?.lineNumber),p=()=>e.side===R.old?e.diffFile.getOldSyntaxLine(s(l)?.lineNumber||0):e.diffFile.getNewSyntaxLine(s(l)?.lineNumber||0),m=()=>e.side===R.old?e.diffFile.getOldPlainLine(s(l)?.lineNumber||0):e.diffFile.getNewPlainLine(s(l)?.lineNumber||0),g=ce(Le(p())),x=ce(Le(m())),w=()=>{oe(g,p(),!0),oe(x,m(),!0)},_={current:()=>{}};ye(()=>{_.current(),w(),_.current=e.diffFile.subscribe(w)}),ze(()=>_.current());let L=(b,A)=>{s(i).side=A,s(i).lineNumber=b},y=()=>s(l)?.diff?.type===He.Add,C=()=>s(l)?.diff?.type===He.Delete;var S=pe(),E=ne(S);{var h=b=>{var A=xg(),T=$(A);{var M=P=>{var J=bg(),ee=ne(J),re=$(ee);{var q=B=>{{let he=I(()=>s(l)?.lineNumber||0);Bi(B,{get index(){return e.index},get lineNumber(){return s(he)},get side(){return e.side},get diffFile(){return e.diffFile},get onWidgetClick(){return s(a)},className:"absolute left-[100%] z-[1] translate-x-[-50%]",onOpenAddWidget:L})}};Y(re,B=>{s(d)&&s(r)&&B(q)})}var F=K(re,2),V=$(F,!0);N(F),N(ee);var j=K(ee,2),z=$(j);{let B=I(()=>s(l)?.value||""),he=I(()=>s(l)?.diff),ie=I(()=>!!s(o));ui(z,{enableWrap:!1,get diffFile(){return e.diffFile},get rawLine(){return s(B)},get diffLine(){return s(he)},get plainLine(){return s(x)},get syntaxLine(){return s(g)},get enableHighlight(){return s(ie)}})}N(j),X((B,he)=>{Se(ee,1,`diff-line-${R[e.side]}-num sticky left-0 z-[1] w-[1%] min-w-[40px] select-none pl-[10px] pr-[10px] text-right align-top`),Q(ee,B),G(F,"data-line-num",s(l)?.lineNumber),Q(F,` opacity: ${s(u)?void 0:.5} `),$e(V,s(l)?.lineNumber),Se(j,1,`diff-line-${R[e.side]}-content pr-[10px] align-top`),Q(j,he)},[()=>`
					background-color: ${Yo(y(),C(),s(d))};
					color: var(${s(d)?ft:hr});
					width: var(${De});
					min-width: var(${De});
					max-width: var(${De})
				`,()=>` background-color: ${Vo(y(),C(),s(d))} `]),D(P,J)},U=P=>{var J=wg();G(J,"colspan",2),X(()=>{Se(J,1,`diff-line-${R[e.side]}-placeholder select-none`),Q(J,`background-color: var(${Xt}) `)}),D(P,J)};Y(T,P=>{s(f)?P(M):P(U,-1)})}N(A),X(()=>{G(A,"data-line",e.lineNumber),G(A,"data-state",s(d)||!s(f)?"diff":"plain"),G(A,"data-side",R[e.side]),Se(A,1,"diff-line"+(s(f)?" group":""))}),D(b,A)};Y(E,b=>{s(c)||b(h)})}D(t,S),fe()}var Ri=({selector:t,enable:e})=>{let n=I(Gs()),i=I(zs()),r=I(ci()),o=ce(0),a={current:()=>{}},l=()=>{if(s(r)&&e()){let c=Qs(s(i)).querySelector(`#diff-root${s(n)}`)?.querySelector(t());if(!c)return;let f=c,p=()=>{let x=c?.getBoundingClientRect();oe(o,x?.width??0,!0)};p();let m=()=>{f?.__observeCallback?.delete(p),f?.__observeCallback?.size===0&&(f.__observeInstance?.disconnect(),f.removeAttribute("data-observe"),delete f.__observeCallback,delete f.__observeInstance)};if(f.__observeCallback){f.__observeCallback.add(p),a.current=()=>m();return}f.__observeCallback=new Set,f.__observeCallback.add(p);let g=new ResizeObserver(()=>f?.__observeCallback?.forEach(x=>x()));f.__observeInstance=g,g.observe(f),f.setAttribute("data-observe","height"),a.current=()=>m()}};return ye(()=>(l(),()=>a.current?.())),()=>s(o)};var Oi=({selector:t,wrapper:e,side:n,enable:i})=>{let r=I(Gs()),o=I(zs()),a=I(ci()),l={current:()=>{}},d=()=>{if(s(a)&&i()){let u=()=>{},f=Qs(s(o)).querySelector(`#diff-root${s(r)}`),p=Array.from(f?.querySelectorAll(t())||[]),m=e()?Array.from(f?.querySelectorAll(e())||[]):p;if(p.length===2&&m.length===2){let g=p[0],x=p[1],w=m[0],_=m[1],L=g.getAttribute("data-side")===n()?g:x,y=L,C=()=>{g.style.height="auto",x.style.height="auto";let h=g.getBoundingClientRect(),b=x.getBoundingClientRect(),A=Math.max(h.height,b.height);w.style.height=A+"px",_.style.height=A+"px",w.setAttribute("data-sync-height",String(A)),_.setAttribute("data-sync-height",String(A))};C();let S=()=>{y.__observeCallback?.delete(C),y.__observeCallback?.size===0&&(y.__observeInstance?.disconnect(),L.removeAttribute("data-observe"),delete y.__observeCallback,delete y.__observeInstance)};if(y.__observeCallback){y.__observeCallback.add(C),u=S;return}y.__observeCallback=new Set,y.__observeCallback.add(C);let E=new ResizeObserver(()=>y.__observeCallback?.forEach(h=>h()));y.__observeInstance=E,E.observe(L),L.setAttribute("data-observe","height"),u=S}l.current=u}};ye(()=>(d(),()=>l.current?.()))};var yg=new Set(["$$slots","$$events","$$legacy"]),Eg=O('<td><div class="diff-line-extend-wrapper sticky left-0 z-[1]"><!></div></td>'),Ag=O("<td><div></div></td>"),Lg=O('<tr data-state="extend" class="diff-line diff-line-extend"><!></tr>');function Rl(t,e){de(e,!0);let n=ue(e,yg),i=ce(null),r=I(Zr()),o=I(eo()),a=I(()=>`div[data-line="${e.lineNumber}-extend-content"]`),l=I(()=>`tr[data-line="${e.lineNumber}-extend"]`),d=I(()=>e.side===R.old?".old-diff-table-wrapper":".new-diff-table-wrapper"),u=I(()=>e.diffFile.getSplitLeftLine(e.index)),c=I(()=>e.diffFile.getSplitRightLine(e.index)),f=I(()=>e.diffFile.getExpandEnabled()),p=I(()=>s(r)?.oldFile?.[s(u)?.lineNumber||""]),m=I(()=>s(r)?.newFile?.[s(c)?.lineNumber||""]),g=I(()=>e.side===R.old?s(u):s(c)),x=I(()=>s(g)?.isHidden),w=I(()=>e.side===R.old?s(p):s(m)),_=I(()=>e.side===R.old?s(u)?.lineNumber:s(c)?.lineNumber),L=I(()=>!!((s(p)||s(m))&&(!s(x)||s(f))&&s(o))),y=I(()=>(e.side===R.old?!!s(p):!!s(m))&&s(L)),C=I(()=>R[s(w)?e.side:e.side===R.new?R.old:R.new]);Oi({selector:()=>s(a),wrapper:()=>s(l),side:()=>s(C),enable:()=>!!(s(L)&&s(i))});let S=I(Ri({selector:()=>s(d),enable:()=>!!(s(y)&&s(i))}));var E=pe(),h=ne(E);{var b=A=>{var T=Lg(),M=$(T);{var U=J=>{var ee=Eg();G(ee,"colspan",2);var re=$(ee),q=$(re);{var F=V=>{var j=pe(),z=ne(j);Mt(z,()=>s(o)??ht,()=>({diffFile:e.diffFile,side:e.side,lineNumber:s(_)||0,data:s(w)?.data,onUpdate:e.diffFile.notifyAll})),D(V,j)};Y(q,V=>{s(S)>0&&V(F)})}N(re),N(ee),X(()=>{Se(ee,1,`diff-line-extend-${R[e.side]}-content p-0`),G(re,"data-line",`${e.lineNumber}-extend-content`),G(re,"data-side",R[e.side]),Q(re,` width: ${s(S)}px `)}),D(J,ee)},P=J=>{var ee=Ag();G(ee,"colspan",2);var re=$(ee);N(ee),X(()=>{Se(ee,1,`diff-line-extend-${R[e.side]}-placeholder select-none p-0`),Q(ee,` background-color: var(${Xt})`),G(re,"data-line",`${e.lineNumber}-extend-content`),G(re,"data-side",R[e.side])}),D(J,ee)};Y(M,J=>{s(o)&&s(w)?J(U):J(P,-1)})}N(T),lt(T,()=>J=>oe(i,J,!0)),X(()=>{G(T,"data-line",`${e.lineNumber}-extend`),G(T,"data-side",R[e.side])}),D(A,T)};Y(h,A=>{s(L)&&A(b)})}D(t,E),fe()}var kg=new Set(["$$slots","$$events","$$legacy"]),Ig=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),Sg=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),Cg=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),Ng=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),$g=O('<div class="min-h-[28px]">&ensp;</div>'),Dg=O('<td class="diff-line-hunk-action sticky left-0 w-[1%] min-w-[40px] select-none p-[1px]"><!></td> <td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td>',1),Tg=O('<td class="diff-line-hunk-placeholder select-none"><div class="min-h-[28px]">&ensp;</div></td>'),Fg=O('<tr data-state="hunk" class="diff-line diff-line-hunk"><!></tr>');function Ol(t,e){de(e,!0);let n=ue(e,kg),i=ce(null),r=I(()=>e.diffFile.getSplitHunkLine(e.index)),o=I(()=>e.diffFile.getExpandEnabled()),a=I(()=>s(o)&&s(r)?.splitInfo),l=I(()=>`tr[data-line="${e.lineNumber}-hunk"]`),d=I(()=>e.side===R.old),u=()=>{let E=s(r);return E&&E.splitInfo&&E.splitInfo.endHiddenIndex-E.splitInfo.startHiddenIndex<je},c=ce(Le(u())),f=()=>{let E=s(r);return E&&E.splitInfo&&E.splitInfo.startHiddenIndex<E.splitInfo.endHiddenIndex},p=ce(Le(f())),m=I(()=>{let E=s(r);return E&&E.isFirst}),g=I(()=>{let E=s(r);return E&&e.diffFile._getIsPureDiffRender()&&!E.splitInfo}),x=I(()=>{let E=s(r);return E&&E.isLast}),w={current:()=>{}};ye(()=>{w.current();let E=()=>{oe(p,f(),!0),oe(c,u(),!0)};E(),w.current=e.diffFile.subscribe(E)}),ze(()=>w.current());let _=I(()=>R[R.old]),L=I(()=>e.side===R.new&&(!!s(p)||s(g)));Oi({selector:()=>s(l),wrapper:()=>s(l),side:()=>s(_),enable:()=>!!(s(L)&&s(i))});var y=pe(),C=ne(y);{var S=E=>{var h=Fg(),b=$(h);{var A=M=>{var U=Dg(),P=ne(U),J=$(P);{var ee=j=>{var z=pe(),B=ne(z);{var he=se=>{var te=Ig(),xe=$(te);Ct(xe,{className:"fill-current"}),N(te),we("click",te,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(se,te)},ie=se=>{var te=Sg(),xe=$(te);Nt(xe,{className:"fill-current"}),N(te),we("click",te,()=>e.diffFile.onSplitHunkExpand("down",e.index)),D(se,te)},Z=se=>{var te=Cg(),xe=$(te);kn(xe,{className:"fill-current"}),N(te),we("click",te,()=>e.diffFile.onSplitHunkExpand("all",e.index)),D(se,te)},ve=se=>{var te=Ng(),xe=ne(te),Ee=$(xe);Nt(Ee,{className:"fill-current"}),N(xe);var ge=K(xe,2),ke=$(ge);Ct(ke,{className:"fill-current"}),N(ge),we("click",xe,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",ge,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(se,te)};Y(B,se=>{s(m)?se(he):s(x)?se(ie,1):s(c)?se(Z,2):se(ve,-1)})}D(j,z)},re=j=>{var z=$g();D(j,z)};Y(J,j=>{s(a)?j(ee):j(re,-1)})}N(P);var q=K(P,2),F=$(q),V=$(F,!0);N(F),N(q),X(()=>{Q(P,`
					background-color: var(${Gn});
					color: var(${ft});
					width: var(${De});
					min-width: var(${De});
				...
				`),Q(q,`background-color: var(${dn})`),Q(F,`
						color: var(${Un})
					`),$e(V,s(r)?.splitInfo?.plainText||s(r)?.text)}),D(M,U)},T=M=>{var U=Tg();G(U,"colspan",2),X(()=>Q(U,`background-color: var(${dn})`)),D(M,U)};Y(b,M=>{s(d)?M(A):M(T,-1)})}N(h),lt(h,()=>M=>oe(i,M,!0)),X(()=>{G(h,"data-line",`${e.lineNumber}-hunk`),G(h,"data-side",R[e.side]),Q(h,`background-color: var(${dn})`)}),D(E,h)};Y(C,E=>{(s(p)||s(g))&&E(S)})}D(t,y),fe()}rt(["click"]);var Mg=new Set(["$$slots","$$events","$$legacy"]),Hg=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),Bg=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),Rg=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),Og=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),Pg=O('<div class="min-h-[28px]">&ensp;</div>'),jg=O('<tr data-state="hunk" class="diff-line diff-line-hunk"><td class="diff-line-hunk-action sticky left-0 w-[1%] min-w-[40px] select-none p-[1px]"><!></td><td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td></tr>');function Pl(t,e){de(e,!0);let n=ue(e,Mg),i=ce(null),r=I(()=>e.diffFile.getSplitHunkLine(e.index)),o=I(()=>e.diffFile.getExpandEnabled()),a=I(()=>s(o)&&s(r)?.splitInfo),l=I(()=>`tr[data-line="${e.lineNumber}-hunk"]`),d=()=>{let S=s(r);return S&&S.splitInfo&&S.splitInfo.endHiddenIndex-S.splitInfo.startHiddenIndex<je},u=ce(Le(d())),c=()=>{let S=s(r);return S&&S.splitInfo&&S.splitInfo.startHiddenIndex<S.splitInfo.endHiddenIndex},f=ce(Le(c())),p=I(()=>{let S=s(r);return S&&S.isFirst}),m=I(()=>{let S=s(r);return S&&e.diffFile._getIsPureDiffRender()&&!S.splitInfo}),g=I(()=>{let S=s(r);return S&&S.isLast}),x=I(()=>R[R.old]),w=I(()=>e.side===R.new&&(!!s(f)||s(m))),_={current:()=>{}};ye(()=>{_.current();let S=()=>{oe(f,c(),!0),oe(u,d(),!0)};S(),_.current=e.diffFile.subscribe(S)}),ze(()=>_.current()),Oi({selector:()=>s(l),wrapper:()=>s(l),side:()=>s(x),enable:()=>!!(s(w)&&s(i))});var L=pe(),y=ne(L);{var C=S=>{var E=jg(),h=$(E),b=$(h);{var A=J=>{var ee=pe(),re=ne(ee);{var q=z=>{var B=Hg(),he=$(B);Ct(he,{className:"fill-current"}),N(B),we("click",B,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(z,B)},F=z=>{var B=Bg(),he=$(B);Nt(he,{className:"fill-current"}),N(B),we("click",B,()=>e.diffFile.onSplitHunkExpand("down",e.index)),D(z,B)},V=z=>{var B=Rg(),he=$(B);kn(he,{className:"fill-current"}),N(B),we("click",B,()=>e.diffFile.onSplitHunkExpand("all",e.index)),D(z,B)},j=z=>{var B=Og(),he=ne(B),ie=$(he);Nt(ie,{className:"fill-current"}),N(he);var Z=K(he,2),ve=$(Z);Ct(ve,{className:"fill-current"}),N(Z),we("click",he,()=>e.diffFile.onSplitHunkExpand("down",e.index)),we("click",Z,()=>e.diffFile.onSplitHunkExpand("up",e.index)),D(z,B)};Y(re,z=>{s(p)?z(q):s(g)?z(F,1):s(u)?z(V,2):z(j,-1)})}D(J,ee)},T=J=>{var ee=Pg();D(J,ee)};Y(b,J=>{s(a)?J(A):J(T,-1)})}N(h);var M=K(h),U=$(M),P=$(U,!0);N(U),N(M),N(E),lt(E,()=>J=>oe(i,J,!0)),X(()=>{G(E,"data-line",`${e.lineNumber}-hunk`),G(E,"data-side",R[e.side]),Q(E,`background-color: var(${dn})`),Q(h,`
				background-color: var(${Gn});
				color: var(${ft});
				width: var(${De});
				min-width: var(${De});
			...
			`),Q(M,`background-color: var(${dn})`),Q(U,`
					color: var(${Un})
				`),$e(P,s(r)?.splitInfo?.plainText||s(r)?.text)}),D(S,E)};Y(y,S=>{(s(f)||s(m))&&S(C)})}D(t,L),fe()}rt(["click"]);var Ug=new Set(["$$slots","$$events","$$legacy"]);function Ks(t,e){de(e,!0);let n=ue(e,Ug),i=I(Ws());var r=pe(),o=ne(r);{var a=d=>{Ol(d,{get index(){return e.index},get side(){return e.side},get diffFile(){return e.diffFile},get lineNumber(){return e.lineNumber}})},l=d=>{Pl(d,{get index(){return e.index},get side(){return e.side},get diffFile(){return e.diffFile},get lineNumber(){return e.lineNumber}})};Y(o,d=>{s(i)===Pt.SplitGitHub||s(i)===Pt.Split?d(a):d(l,-1)})}D(t,r),fe()}var Gg=new Set(["$$slots","$$events","$$legacy"]),zg=O('<td><div class="diff-line-widget-wrapper sticky left-0 z-[1]"><!></div></td>'),Wg=O("<td><div></div></td>"),Qg=O('<tr data-state="widget" class="diff-line diff-line-widget"><!></tr>');function jl(t,e){de(e,!0);let n=ue(e,Gg),i=ce(null),r=I(Xr()),o=I(An()),a=I(()=>e.diffFile.getSplitLeftLine(e.index)),l=I(()=>e.diffFile.getSplitRightLine(e.index)),d=I(()=>!!s(a)?.lineNumber&&s(o)?.side===R.old&&s(o)?.lineNumber===s(a)?.lineNumber),u=I(()=>!!s(l)?.lineNumber&&s(o)?.side===R.new&&s(o)?.lineNumber===s(l)?.lineNumber),c=I(()=>e.side===R.old?s(a):s(l)),f=I(()=>s(c)?.isHidden),p=I(()=>`div[data-line="${e.lineNumber}-widget-content"]`),m=I(()=>`tr[data-line="${e.lineNumber}-widget"]`),g=I(()=>e.side===R.old?".old-diff-table-wrapper":".new-diff-table-wrapper"),x=I(()=>e.side===R.old?s(d):s(u)),w=I(()=>R[s(x)?e.side:e.side===R.old?R.new:R.old]),_=I(()=>(!!s(d)||!!s(u))&&!s(f)&&!!s(r)),L=I(()=>s(x)&&!!s(_)),y=()=>{s(o).side=void 0,s(o).lineNumber=void 0};Oi({selector:()=>s(p),wrapper:()=>s(m),side:()=>s(w),enable:()=>!!(s(_)&&s(i))});let C=I(Ri({selector:()=>s(g),enable:()=>!!(s(L)&&s(i))}));var S=pe(),E=ne(S);{var h=b=>{var A=Qg(),T=$(A);{var M=P=>{var J=zg();G(J,"colspan",2);var ee=$(J),re=$(ee);{var q=F=>{var V=pe(),j=ne(V);Mt(j,()=>s(r),()=>({diffFile:e.diffFile,side:e.side,lineNumber:s(c)?.lineNumber||0,onClose:y})),D(F,V)};Y(re,F=>{s(C)>0&&F(q)})}N(ee),N(J),X(()=>{Se(J,1,`diff-line-widget-${R[e.side]}-content p-0`),G(ee,"data-line",`${e.lineNumber}-widget-content`),G(ee,"data-side",R[e.side]),Q(ee,` width: ${s(C)}px `)}),D(P,J)},U=P=>{var J=Wg();G(J,"colspan",2);var ee=$(J);N(J),X(()=>{Se(J,1,`diff-line-widget-${R[e.side]}-placeholder select-none p-0`),Q(J,`background-color: var(${Xt})`),G(ee,"data-line",`${e.lineNumber}-widget-content`),G(ee,"data-side",R[e.side])}),D(P,J)};Y(T,P=>{s(x)?P(M):P(U,-1)})}N(A),lt(A,()=>P=>oe(i,P,!0)),X(()=>{G(A,"data-line",`${e.lineNumber}-widget`),G(A,"data-side",R[e.side])}),D(b,A)};Y(E,b=>{s(_)&&b(h)})}D(t,S),fe()}var Vg=new Set(["$$slots","$$events","$$legacy"]),Yg=O("<!> <!> <!> <!>",1),Jg=O('<table><colgroup><col/><col/></colgroup><thead class="hidden"><tr><th scope="col"> </th><th scope="col"> </th></tr></thead><tbody class="diff-table-body leading-[1.6]"><!><!></tbody></table>');function Xs(t,e){de(e,!0);let n=ue(e,Vg),i=I(()=>e.side===R.new?"new-diff-table":"old-diff-table"),r=()=>ds(e.diffFile),o=ce(Le(r())),a={current:()=>{}},l=e.selectState;ye(()=>{a.current();let E=()=>oe(o,r(),!0);E(),a.current=e.diffFile.subscribe(E)}),ze(()=>a.current());let d=E=>{let h=E.target;if(h&&h?.nodeName==="BUTTON"){Ln();return}let b=oo(h);if(!(b&&b!==`diff-root${e.diffFile.getId()}`))for(;h&&h instanceof HTMLElement;){let A=h.getAttribute("data-state");if(A){A==="extend"||A==="hunk"||A==="widget"?l.current!==void 0&&(l.current=void 0,e.onSelect?.(void 0),Ln()):l.current!==e.side&&(l.current=n.side,e.onSelect?.(e.side),Ln());return}h=h.parentElement}};var u=Jg(),c=$(u),f=$(c),p=K(f);N(c);var m=K(c),g=$(m),x=$(g),w=$(x);N(x);var _=K(x),L=$(_);N(_),N(g),N(m);var y=K(m),C=$(y);fi(C,17,()=>s(o),di,(E,h)=>{var b=Yg(),A=ne(b);Ks(A,{get index(){return s(h).index},get side(){return e.side},get lineNumber(){return s(h).lineNumber},get diffFile(){return e.diffFile}});var T=K(A,2);Bl(T,{get index(){return s(h).index},get side(){return e.side},get lineNumber(){return s(h).lineNumber},get diffFile(){return e.diffFile}});var M=K(T,2);jl(M,{get index(){return s(h).index},get side(){return e.side},get lineNumber(){return s(h).lineNumber},get diffFile(){return e.diffFile}});var U=K(M,2);Rl(U,{get index(){return s(h).index},get side(){return e.side},get lineNumber(){return s(h).lineNumber},get diffFile(){return e.diffFile}}),D(E,b)});var S=K(C);Ks(S,{get side(){return e.side},get index(){return e.diffFile.splitLineLength},get lineNumber(){return e.diffFile.splitLineLength},get diffFile(){return e.diffFile}}),N(y),N(u),X(()=>{Se(u,1,`${s(i)} w-full border-collapse border-spacing-0`),G(u,"data-mode",R[e.side]),Se(f,1,`diff-table-${R[e.side]}-num-col`),Se(p,1,`diff-table-${R[e.side]}-content-col`),$e(w,`${R[e.side]??""} line number`),$e(L,`${R[e.side]??""} line content`)}),we("mousedown",y,d),D(t,u),fe()}rt(["mousedown"]);var qg=new Set(["$$slots","$$events","$$legacy"]),Kg=O('<div class="split-diff-view split-diff-view-normal flex w-full basis-[50%]"><style data-select-style=""></style> <div class="old-diff-table-wrapper diff-table-scroll-container w-full overflow-x-auto overflow-y-hidden"><!></div> <div class="diff-split-line w-[1.5px]"></div> <div class="new-diff-table-wrapper diff-table-scroll-container w-full overflow-x-auto overflow-y-hidden"><!></div></div>');function Ul(t,e){de(e,!0);let n=ue(e,qg),i=I(ci()),r=ce(void 0),o=ce(void 0),a=ce(null),l=I(()=>Math.max(e.diffFile.fileLineLength,e.diffFile.splitLineLength).toString()),d={current:()=>{}},u={current:void 0};ye(()=>{if(d.current(),!s(i))return;let b=s(r),A=s(o);!b||!A||(d.current=mu(b,A))}),ze(()=>d.current());let f=b=>{let A=s(a);A&&(b?A.textContent=`#${w()} [data-state="extend"] {user-select: none} 
#${w()} [data-state="hunk"] {user-select: none} 
#${w()} [data-state="widget"] {user-select: none}`:A.textContent="")},p=I(Kr()),m=I(()=>({fontSize:`${s(p)||14}px`,fontFamily:"Menlo, Consolas, monospace"})),g=I(ro({text:()=>s(l),font:()=>s(m)})),x=I(()=>Math.max(40,s(g)+25)),w=()=>`diff-split-view-${e.diffFile.getId()}`;var _=Kg(),L=$(_);lt(L,()=>b=>oe(a,b,!0));var y=K(L,2),C=$(y);Xs(C,{get side(){return R.old},get diffFile(){return e.diffFile},onSelect:f,get selectState(){return u}}),N(y),lt(y,()=>b=>{oe(r,b,!0)});var S=K(y,2),E=K(S,2),h=$(E);Xs(h,{get side(){return R.new},get diffFile(){return e.diffFile},onSelect:f,get selectState(){return u}}),N(E),lt(E,()=>b=>{oe(o,b,!0)}),N(_),X((b,A)=>{Q(y,b),Q(S,`background-color: var(${gn})`),Q(E,A)},[()=>`
    ...
    `,()=>`
			...
			font-family: Menlo, Consolas, monospace;
			font-size: var(${nt});
		`]),D(t,_),fe()}var Xg=new Set(["$$slots","$$events","$$legacy"]);function Gl(t,e){de(e,!0);let n=ue(e,Xg),i=I(En());var r=pe(),o=ne(r);{var a=d=>{Hl(d,{get diffFile(){return e.diffFile}})},l=d=>{Ul(d,{get diffFile(){return e.diffFile}})};Y(o,d=>{s(i)?d(a):d(l,-1)})}D(t,r),fe()}var Zg=new Set(["$$slots","$$events","$$legacy"]),ev=O('<div class="diff-add-widget-wrapper invisible absolute left-[100%] translate-x-[-50%] select-none transition-transform hover:scale-110 group-hover:visible"><button class="diff-add-widget z-[1] flex h-full w-full origin-center cursor-pointer items-center justify-center rounded-md text-[1.2em]">+</button></div>');function Ko(t,e){de(e,!0);let n=ue(e,Zg);var i=ev(),r=$(i);N(i),X(()=>{G(i,"data-add-widget",R[e.side]),Q(i,`
		width: calc(var(${nt}) * 1.4);
		height: calc(var(${nt}) * 1.4);
		top: calc(var(${nt}) * 0.1);
	`),Q(r,`
			color: var(${Js});
			background-color: var(${Ys});
		`)}),we("mousedown",r,o=>{o.stopPropagation(),e.onOpenAddWidget(e.lineNumber,e.side),e.onWidgetClick?.(e.lineNumber,e.side)}),D(t,i),fe()}rt(["mousedown"]);var tv=new Set(["$$slots","$$events","$$legacy"]),nv=O('<tr data-state="diff" class="diff-line group"><td class="diff-line-num sticky left-0 z-[1] w-[1%] min-w-[100px] select-none whitespace-nowrap pl-[10px] pr-[10px] text-right align-top"><!> <div class="flex"><span class="inline-block w-[50%]"> </span> <span class="w-[10px] shrink-0"></span> <span class="inline-block w-[50%]"></span></div></td><td class="diff-line-content pr-[10px] align-top"><!></td></tr>'),iv=O('<tr data-state="diff" class="diff-line group"><td class="diff-line-num sticky left-0 z-[1] w-[1%] min-w-[100px] select-none whitespace-nowrap pl-[10px] pr-[10px] text-right align-top"><!> <div class="flex"><span class="inline-block w-[50%]"></span> <span class="w-[10px] shrink-0"></span> <span class="inline-block w-[50%]"> </span></div></td><td class="diff-line-content pr-[10px] align-top"><!></td></tr>'),rv=O("<!> <!>",1),ov=O('<tr class="diff-line group"><td class="diff-line-num sticky left-0 z-[1] w-[1%] min-w-[100px] select-none whitespace-nowrap pl-[10px] pr-[10px] text-right align-top"><!> <div class="flex opacity-[0.5]"><span class="inline-block w-[50%]"> </span> <span class="w-[10px] shrink-0"></span> <span class="inline-block w-[50%]"> </span></div></td><td class="diff-line-content pr-[10px] align-top"><!></td></tr>');function zl(t,e){de(e,!0);let n=ue(e,tv),i=I(()=>e.diffFile.getUnifiedLine(e.index)),r=I(En()),o=I(An()),a=I(to()),l=I(no()),d=I(io()),u=I(()=>s(i)?.isHidden),c=I(()=>Zi(s(i)?.diff)),f=()=>s(i)?.newLineNumber?e.diffFile.getNewSyntaxLine(s(i)?.newLineNumber||0):s(i)?.oldLineNumber?e.diffFile.getOldSyntaxLine(s(i)?.oldLineNumber||0):void 0,p=ce(Le(f())),m=()=>s(i)?.newLineNumber?e.diffFile.getNewPlainLine(s(i)?.newLineNumber||0):s(i)?.oldLineNumber?e.diffFile.getOldPlainLine(s(i)?.oldLineNumber||0):void 0,g=ce(Le(m())),x={current:()=>{}};ye(()=>{x?.current?.();let C=()=>{oe(p,f(),!0),oe(g,m(),!0)};C(),x.current=e.diffFile.subscribe(C)}),ze(()=>x.current());let w=(C,S)=>{s(o).side=S,s(o).lineNumber=C};var _=pe(),L=ne(_);{var y=C=>{var S=pe(),E=ne(S);{var h=A=>{let T=(q,F=ht)=>{var V=nv(),j=$(V),z=$(j);{var B=te=>{{let xe=I(()=>F().index-1);Ko(te,{get index(){return s(xe)},get lineNumber(){return F().lineNumber},get diffFile(){return F().diffFile},get side(){return R.old},get onWidgetClick(){return F().onAddWidgetClick},get onOpenAddWidget(){return F().onOpenAddWidget}})}};Y(z,te=>{F().enableAddWidget&&te(B)})}var he=K(z,2),ie=$(he),Z=$(ie,!0);N(ie),er(4),N(he),N(j);var ve=K(j),se=$(ve);ui(se,{get enableWrap(){return F().enableWrap},get diffFile(){return F().diffFile},get enableHighlight(){return F().enableHighlight},get rawLine(){return F().rawLine},get diffLine(){return F().diffLine},get plainLine(){return F().plainLine},get syntaxLine(){return F().syntaxLine}}),N(ve),N(V),X(()=>{G(V,"data-line",F().index),Q(j,`
          color: var(${ft});
          background-color: var(${Il});
          width: calc(calc(var(${De}) + 5px) * 2);
          max-width: calc(calc(var(${De}) + 5px) * 2);
          min-width: calc(calc(var(${De}) + 5px) * 2);
        `),G(ie,"data-line-old-num",F().lineNumber),$e(Z,F().lineNumber),Q(ve,`background-color: var(${Ll}) `)}),D(q,V)},M=(q,F=ht)=>{var V=iv(),j=$(V),z=$(j);{var B=te=>{{let xe=I(()=>F().index-1);Ko(te,{get index(){return s(xe)},get lineNumber(){return F().lineNumber},get diffFile(){return F().diffFile},get side(){return R.new},get onWidgetClick(){return F().onAddWidgetClick},get onOpenAddWidget(){return F().onOpenAddWidget}})}};Y(z,te=>{F().enableAddWidget&&te(B)})}var he=K(z,2),ie=K($(he),4),Z=$(ie,!0);N(ie),N(he),N(j);var ve=K(j),se=$(ve);ui(se,{get enableWrap(){return F().enableWrap},get diffFile(){return F().diffFile},get enableHighlight(){return F().enableHighlight},get rawLine(){return F().rawLine},get diffLine(){return F().diffLine},get plainLine(){return F().plainLine},get syntaxLine(){return F().syntaxLine}}),N(ve),N(V),X(()=>{G(V,"data-line",F().index),Q(j,`
          color: var(${ft});
          background-color: var(${kl});
          width: calc(calc(var(${De}) + 5px) * 2);
          max-width: calc(calc(var(${De}) + 5px) * 2);
          min-width: calc(calc(var(${De}) + 5px) * 2);
        `),G(ie,"data-line-new-num",F().lineNumber),$e(Z,F().lineNumber),Q(ve,` background-color: var(${Al}) `)}),D(q,V)};var U=rv(),P=ne(U);{var J=q=>{T(q,()=>({index:e.lineNumber,enableWrap:s(r),diffFile:e.diffFile,rawLine:s(i)?.value||"",diffLine:s(i)?.diff,plainLine:s(g),syntaxLine:s(p),enableHighlight:s(l),enableAddWidget:s(d),lineNumber:s(i).oldLineNumber||0,onOpenAddWidget:w,onAddWidgetClick:s(a)}))};Y(P,q=>{s(i).oldLineNumber&&q(J)})}var ee=K(P,2);{var re=q=>{M(q,()=>({index:e.lineNumber,enableWrap:s(r),diffFile:e.diffFile,rawLine:s(i)?.value||"",diffLine:s(i)?.diff,plainLine:s(g),syntaxLine:s(p),enableHighlight:s(l),enableAddWidget:s(d),lineNumber:s(i).newLineNumber||0,onOpenAddWidget:w,onAddWidgetClick:s(a)}))};Y(ee,q=>{s(i).newLineNumber&&q(re)})}D(A,U)},b=A=>{var T=ov(),M=$(T),U=$(M);{var P=z=>{{let B=I(()=>s(i)?.newLineNumber||0);Ko(z,{get index(){return e.index},get diffFile(){return e.diffFile},get lineNumber(){return s(B)},get side(){return R.new},onOpenAddWidget:w,get onWidgetClick(){return s(a)}})}};Y(U,z=>{s(d)&&s(i)?.diff&&z(P)})}var J=K(U,2),ee=$(J),re=$(ee,!0);N(ee);var q=K(ee,4),F=$(q,!0);N(q),N(J),N(M);var V=K(M),j=$(V);{let z=I(()=>!!s(r)),B=I(()=>!!s(l)),he=I(()=>s(i)?.value||""),ie=I(()=>s(i)?.diff);ui(j,{get enableWrap(){return s(z)},get diffFile(){return e.diffFile},get enableHighlight(){return s(B)},get rawLine(){return s(he)},get diffLine(){return s(ie)},get plainLine(){return s(g)},get syntaxLine(){return s(p)}})}N(V),N(T),X(()=>{G(T,"data-line",e.lineNumber),G(T,"data-state",s(i)?.diff?"diff":"plain"),Q(M,`
					color: var(${s(i)?.diff?ft:hr});
					background-color: ${s(i)?.diff?`var(${Cl})`:`var(${Vs})`};
					width: calc(calc(var(${De}) + 5px) * 2);
					max-width: calc(calc(var(${De}) + 5px) * 2);
					min-width: calc(calc(var(${De}) + 5px) * 2;
				`),G(ee,"data-line-old-num",s(i)?.oldLineNumber||0),$e(re,s(i)?.oldLineNumber||0),G(q,"data-line-new-num",s(i)?.newLineNumber||0),$e(F,s(i)?.newLineNumber||0),Q(V,`
					background-color: ${s(i)?.diff?`var(${Sl})`:`var(${Vs})`}
				`)}),D(A,T)};Y(E,A=>{s(c)?A(h):A(b,-1)})}D(C,S)};Y(L,C=>{s(u)||C(y)})}D(t,_),fe()}var sv=new Set(["$$slots","$$events","$$legacy"]),av=O('<tr data-state="extend" class="diff-line diff-line-extend"><td class="diff-line-extend-content p-0 align-top"><div class="diff-line-extend-wrapper sticky left-0 z-[1]"><!> <!></div></td></tr>');function Wl(t,e){de(e,!0);let n=ue(e,sv),i=I(Zr()),r=I(En()),o=I(eo()),a=I(()=>e.diffFile.getUnifiedLine(e.index)),l=I(()=>s(i)?.oldFile?.[s(a)?.oldLineNumber||-1]),d=I(()=>s(i)?.newFile?.[s(a)?.newLineNumber||-1]),u=I(()=>s(a).isHidden),c=I(()=>!!((s(l)||s(d))&&s(u)&&s(o))),f=I(Ri({selector:()=>".unified-diff-table-wrapper",enable:()=>s(c)}));var p=pe(),m=ne(p);{var g=x=>{var w=av(),_=$(w);G(_,"colspan",2);var L=$(_),y=$(L);{var C=h=>{var b=pe(),A=ne(b);Mt(A,()=>s(o),()=>({diffFile:e.diffFile,side:R.old,data:s(l)?.data,lineNumber:s(a)?.oldLineNumber||0,onUpdate:()=>e.diffFile.notifyAll()})),D(h,b)};Y(y,h=>{(s(r)||s(f)>0)&&s(l)&&s(o)&&h(C)})}var S=K(y,2);{var E=h=>{var b=pe(),A=ne(b);Mt(A,()=>s(o),()=>({diffFile:e.diffFile,side:R.new,data:s(d)?.data,lineNumber:s(a)?.newLineNumber||0,onUpdate:()=>e.diffFile.notifyAll()})),D(h,b)};Y(S,h=>{(s(r)||s(f)>0)&&s(d)&&s(o)&&h(E)})}N(L),N(_),N(w),X(()=>{G(w,"data-line",`${e.lineNumber}-extend`),Q(L,`width: ${s(f)}px `)}),D(x,w)};Y(m,x=>{s(c)&&x(g)})}D(t,p),fe()}var lv=new Set(["$$slots","$$events","$$legacy"]),dv=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Up" data-title="Expand Up"><!></button>'),fv=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand Down" data-title="Expand Down"><!></button>'),cv=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[6px]" title="Expand All" data-title="Expand All"><!></button>'),uv=O('<button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Down" data-title="Expand Down"><!></button> <button class="diff-widget-tooltip flex w-full cursor-pointer items-center justify-center rounded-[2px] py-[2px]" title="Expand Up" data-title="Expand Up"><!></button>',1),pv=O('<div class="min-h-[28px]">&ensp;</div>'),hv=O('<tr data-state="hunk" class="diff-line diff-line-hunk"><td class="diff-line-hunk-action sticky left-0 w-[1%] min-w-[100px] select-none"><!></td><td class="diff-line-hunk-content pr-[10px] align-middle"><div class="pl-[1.5em]"> </div></td></tr>');function Zs(t,e){de(e,!0);let n=ue(e,lv),i=I(()=>e.diffFile.getUnifiedHunkLine(e.index)),r=I(()=>e.diffFile.getExpandEnabled()),o=I(()=>s(r)&&s(i)&&s(i).unifiedInfo),a=I(En()),l=()=>s(i)&&s(i).unifiedInfo&&s(i).unifiedInfo.startHiddenIndex<s(i).unifiedInfo.endHiddenIndex,d=ce(Le(l())),u=()=>s(i)&&s(i).unifiedInfo&&s(i).unifiedInfo.endHiddenIndex-s(i).unifiedInfo.startHiddenIndex<je,c=ce(Le(u())),f=I(()=>s(i)&&s(i).isFirst),p=I(()=>s(i)&&s(i).isLast),m=I(()=>s(i)&&e.diffFile._getIsPureDiffRender()&&!s(i).unifiedInfo),g={current:()=>{}};ye(()=>{g?.current?.();let L=()=>{oe(d,l(),!0),oe(c,u(),!0)};L(),g.current=e.diffFile.subscribe(L)}),ze(()=>g.current());var x=pe(),w=ne(x);{var _=L=>{var y=hv(),C=$(y),S=$(C);{var E=M=>{var U=pe(),P=ne(U);{var J=F=>{var V=dv(),j=$(V);Ct(j,{className:"fill-current"}),N(V),we("click",V,()=>e.diffFile.onUnifiedHunkExpand("up",e.index)),D(F,V)},ee=F=>{var V=fv(),j=$(V);Nt(j,{className:"fill-current"}),N(V),we("click",V,()=>e.diffFile.onUnifiedHunkExpand("down",e.index)),D(F,V)},re=F=>{var V=cv(),j=$(V);kn(j,{className:"fill-current"}),N(V),we("click",V,()=>e.diffFile.onUnifiedHunkExpand("all",e.index)),D(F,V)},q=F=>{var V=uv(),j=ne(V),z=$(j);Nt(z,{className:"fill-current"}),N(j);var B=K(j,2),he=$(B);Ct(he,{className:"fill-current"}),N(B),we("click",j,()=>e.diffFile.onUnifiedHunkExpand("down",e.index)),we("click",B,()=>e.diffFile.onUnifiedHunkExpand("up",e.index)),D(F,V)};Y(P,F=>{s(f)?F(J):s(p)?F(ee,1):s(c)?F(re,2):F(q,-1)})}D(M,U)},h=M=>{var U=pv();D(M,U)};Y(S,M=>{s(o)?M(E):M(h,-1)})}N(C);var b=K(C),A=$(b),T=$(A,!0);N(A),N(b),N(y),X(()=>{G(y,"data-line",`${e.lineNumber}-hunk`),Q(C,`
				background-color: var(${Gn});
				color: var(${ft});
				width: calc(calc(var(${De}) + 5px) * 2);
				max-width: calc(calc(var(${De}) + 5px) * 2);
...
`)}return r}function Tu(t,e){let n=new Set(t);return e.add.forEach(i=>n.add(i)),e.remove.forEach(i=>n.delete(i)),[...n]}var Mu=ad(Fu());function Hu(t,e){try{k.csvData=kv(t),k.currentIndex=0,k.retryCount={},k.previousItem=null,localStorage.setItem("bgmCsvData",JSON.stringify(k.csvData)),localStorage.setItem("bgmCurrentIndex","0"),In(),en(e+"\u52A0\u8F7D\u6210\u529F")}catch(n){en("CSV\u89E3\u6790\u9519\u8BEF: "+n.message),console.error(n)}finally{vn(),document.querySelectorAll("#static-buttons-container button").forEach(n=>{n.disabled=!1})}}function Bu(t){let n=t.target.files?.[0];if(!n)return;document.querySelectorAll("#static-buttons-container button").forEach(r=>{r.disabled=!0}),zi("\u6B63\u5728\u89E3\u6790CSV\u6587\u4EF6...");let i=new FileReader;i.onload=function(r){let o=r.target.result;Hu(o,"CSV\u6587\u4EF6")},i.readAsText(n)}function Ru(t){document.querySelectorAll("#static-buttons-container button").forEach(e=>{e.disabled=!0}),zi("\u6B63\u5728\u89E3\u6790\u7C98\u8D34\u7684CSV..."),Hu(t,"\u7C98\u8D34\u7684CSV")}function kv(t){let e=Mu.default.parse(t,{header:!0,skipEmptyLines:!0,transform:a=>a.trim()});if(e.errors.length){let a=e.errors[0];throw new Error(`\u7B2C${a.row!==void 0?a.row+1:"?"}\u884C: ${a.message}`)}let n=e.meta.fields;if(!n||n.length===0)throw new Error("CSV\u6587\u4EF6\u4E3A\u7A7A\u6216\u683C\u5F0F\u9519\u8BEF");let i=n.find(a=>/^(person_id|character_id|id)$/i.test(a));if(!i)throw new Error('CSV\u5FC5\u987B\u5305\u542B"id"\u3001"person_id"\u6216"character_id"\u5217');k.entityType="subject",/^person_id$/i.test(i)?k.entityType="person":/^character_id$/i.test(i)&&(k.entityType="character");let r=n.filter(a=>a!==i),o=[];for(let a of e.data){let l=a[i]?.trim();if(!l)continue;let d={id:l};for(let u of r){let c=a[u];c!==void 0&&(d[u]=c.trim())}o.push(d)}if(o.length===0)throw new Error("\u672A\u627E\u5230\u6709\u6548\u7684\u6570\u636E\u884C");return o}function In(){k.currentView="setup";let t=document.getElementById("core-content"),e=document.getElementById("static-buttons-container");document.getElementById("edit-regions").style.display="none",ld(),t&&(t.innerHTML=`
            <div>
        ...
        `);let n=document.getElementById("setup-access-token");n&&n.addEventListener("input",f=>{k.accessToken=f.target.value,GM_setValue("bgmAccessToken",k.accessToken)});let i=document.getElementById("setup-formhash");i&&i.addEventListener("input",f=>{k.formhash=f.target.value,GM_setValue("bgmFormhash",k.formhash)});let r=document.getElementById("setup-fetch-formhash");r&&r.addEventListener("click",()=>{i&&(r.disabled=!0,r.innerHTML='<i class="fas fa-spinner fa-pulse"></i> \u83B7\u53D6\u4E2D...',GM.xmlHttpRequest({method:"GET",url:"https://bgm.tv/subject/1/edit_detail",onload:f=>{try{let p=f.responseText.match(/<input[^>]*name="formhash"[^>]*value="([^"]+)"/);p&&p[1]?(k.formhash=p[1],GM_setValue("bgmFormhash",k.formhash),i.value=p[1]):alert("\u65E0\u6CD5\u4ECE\u9875\u9762\u63D0\u53D6 formhash\uFF0C\u8BF7\u786E\u4FDD\u5DF2\u767B\u5F55 Bangumi")}catch{alert("\u89E3\u6790\u7F16\u8F91\u9875\u9762\u5931\u8D25")}finally{r.disabled=!1,r.innerHTML='<i class="fas fa-magic"></i> \u81EA\u52A8\u83B7\u53D6'}},onerror:()=>{alert("\u7F51\u7EDC\u8BF7\u6C42\u5931\u8D25\uFF0C\u8BF7\u624B\u52A8\u83B7\u53D6 formhash"),r.disabled=!1,r.innerHTML='<i class="fas fa-magic"></i> \u81EA\u52A8\u83B7\u53D6'}}))}),document.querySelectorAll('input[name="submit-method"]').forEach(f=>{f.addEventListener("change",p=>{k.submitMethod=p.target.value,GM_setValue("bgmSubmitMethod",k.submitMethod);let m=document.getElementById("patch-method-options"),g=document.getElementById("post-method-options");m&&m.classList.toggle("hidden",k.submitMethod!=="patch"),g&&g.classList.toggle("hidden",k.submitMethod!=="post")})}),document.querySelectorAll('input[name="diff-view-mode"]').forEach(f=>{f.addEventListener("change",p=>{k.diffViewMode=p.target.value,localStorage.setItem("bgmDiffViewMode",k.diffViewMode)})});let l=document.getElementById("setup-csv-file");l&&(l.addEventListener("change",Bu),l.addEventListener("change",()=>{let f=l.files?.[0]?.name||"",p=document.getElementById("setup-csv-file-name");p&&(p.textContent=f)}));let d=document.getElementById("setup-csv-btn");d&&l&&d.addEventListener("click",f=>{f.preventDefault(),l.click()});let u=document.getElementById("setup-paste-csv-btn");u&&u.addEventListener("click",async()=>{try{let f=await navigator.clipboard.readText();if(!f||!f.trim()){en("\u526A\u8D34\u677F\u5185\u5BB9\u4E0D\u662F\u6709\u6548\u7684CSV");return}let p=document.getElementById("setup-csv-file-name");p&&(p.textContent="\u5DF2\u4ECE\u526A\u8D34\u677F\u7C98\u8D34"),Ru(f)}catch(f){en("\u8BFB\u53D6\u526A\u8D34\u677F\u5931\u8D25: "+f.message)}});let c=document.getElementById("sync-status");if(c)if(GM_getValue("bgmGistToken","")){let p=GM_getValue("bgmGistId","");c.textContent=p?"\u5DF2\u540C\u6B65 (Gist: "+p.slice(0,8)+"\u2026)":"\u5DF2\u6388\u6743 GitHub"}else c.textContent="\u672A\u540C\u6B65"}function Ou(t){k.currentView="processing";let{currentItem:e,wikiData:n,historyData:i}=t;k.currentSubjectData=n,k.currentItemId=e.id;let r=k.entityType||"subject";k.currentWcode=null,k.currentTags=null,k.currentSeries=null,k.currentCommitMessage=null;let o=document.getElementById("core-content"),a=document.getElementById("static-buttons-container"),l=document.getElementById("edit-regions");l&&(l.style.display="block"),co(),Gi(k.currentIndex,k.totalItems);let d=n.name||"\u672A\u77E5\u540D\u79F0",u=n.infobox||"",c=r==="subject"?n.metaTags||[]:[],f=r==="subject"&&n.series||!1,p=Cu(e,u),m=Nu(e,c),g=$u(e,f);k.currentFieldUpdates=p,k.currentTagUpdates=m,k.currentSeriesUpdate=g;let x={subject:"\u6761\u76EE",character:"\u89D2\u8272",person:"\u4EBA\u7269"},w=document.getElementById("static-last-update"),_=i[0]?.createdAt,L=_?new Date(_*1e3):null,y=i[0]?.creator?.username||"",C=i[0]?.commitMessage||"",S=ku(_);if(L&&w){let{editPagePath:F}=Ui(r,e.id);w.innerHTML=`
        ...
        `,E.style.display="block"}else E&&(E.style.display="none");let h=document.getElementById("static-commit-input"),b=document.getElementById("static-lock-commit"),A=so(p,m,g,r);h.value=k.isCommitMessageLocked?k.lockedCommitMessage:A,b.innerHTML=`<i class="fas ${k.isCommitMessageLocked?"fa-lock":"fa-lock-open"}"></i>`,b.title=k.isCommitMessageLocked?"\u89E3\u9501\u7F16\u8F91\u6458\u8981":"\u56FA\u5B9A\u7F16\u8F91\u6458\u8981";let T=document.getElementById("static-wcode-input"),M=document.getElementById("static-content-diff-container"),U=Du(u,p);T.value=U,Xo(u,U,"static-content-diff-container"),M&&(M.style.display="block");let P=document.getElementById("static-tags-area"),J=document.getElementById("static-tags-diff-wrapper");if(r==="subject"){let F=document.getElementById("static-tags-input"),V=Tu(c,m);F.value=V.join(" "),ta(c,V,"static-tags-diff-container"),P&&(P.style.display="block"),J&&(J.style.display="block")}else P&&(P.style.display="none"),J&&(J.style.display="none");let ee=document.getElementById("static-series-area");if(r==="subject"){let F=document.getElementById("static-series-checkbox"),V=g.hasUpdate?g.newValue:f;F.checked=V,k.currentSeries=V,ee&&(ee.style.display="block")}else ee&&(ee.style.display="none");let re=Ui(r,e.id).editPagePath.replace("/edit",""),q=x[r]||"\u6761\u76EE";o&&(o.innerHTML=`
            <div>
                <div class="item-info">
        ...
        `),ji()}function Pu(t,e){k.currentView="processing";let n=document.getElementById("core-content"),i=document.getElementById("static-buttons-container"),r=document.getElementById("edit-regions");r&&(r.style.display="none"),co(),Gi(k.currentIndex,k.totalItems);let o=t.id,l={subject:"\u6761\u76EE",character:"\u89D2\u8272",person:"\u4EBA\u7269"}[k.entityType]||"\u6761\u76EE",d=(k.retryCount[o]||0)+1;k.retryCount[o]=d,n&&(n.innerHTML=`
            <div>
                <div class="item-info">
        ...
        `)}function ju(t){k.currentView="processing";let e=document.getElementById("core-content"),n=document.getElementById("static-buttons-container"),i=document.getElementById("edit-regions");i&&(i.style.display="none"),co(),Gi(k.currentIndex,k.totalItems);let r=k.currentItemId||"",o=(k.retryCount[r]||0)+1;k.retryCount[r]=o;let l=k.currentSubjectData?.name||"\u672A\u77E5\u540D\u79F0",u={subject:"\u6761\u76EE",character:"\u89D2\u8272",person:"\u4EBA\u7269"}[k.entityType]||"\u6761\u76EE";e&&(e.innerHTML=`
            <div>
                <div class="item-info">
        ...
        `)}function Uu(){k.currentView="completed";let t=document.getElementById("core-content"),e=document.getElementById("static-buttons-container"),n=document.getElementById("edit-regions");n&&(n.style.display="none"),co(),Gi(k.totalItems,k.totalItems),t&&(t.innerHTML=`
            <div>
...
`),f=new FormData;if(f.append("formhash",k.formhash),f.append("editSummary",a),u==="subject")f.append("subject_title",k.currentSubjectData?.name||""),f.append("platform",k.currentSubjectData?.platform||""),f.append("subject_infobox",c),f.append("subject_summary",k.currentSubjectData?.summary||""),f.append("subject_meta_tags",n.join(" ")),f.append("series",i?"1":"0"),f.append("submit","\u63D0\u4EA4");else if(u==="person"){f.append("crt_name",k.currentSubjectData?.name||""),f.append("crt_infobox",c),f.append("crt_summary",k.currentSubjectData?.summary||"");let g=k.currentSubjectData?.profession;if(g)for(let[x,w]of Object.entries(g))w&&f.append(`prsn_pro[${x}]`,"1");f.append("picfile",""),f.append("submit","\u6539\u597D\u4E86")}else f.append("crt_name",k.currentSubjectData?.name||""),f.append("crt_infobox",c),f.append("crt_summary",k.currentSubjectData?.summary||""),f.append("picfile",""),f.append("submit","\u6539\u597D\u4E86");let p=new URLSearchParams;f.forEach((g,x)=>{p.append(x,g)});let m=u==="subject"?`https://bgm.tv/subject/${t}/new_revision`:`https://bgm.tv/${u}/${t}/edit`;GM.xmlHttpRequest({method:"POST",url:m,data:p.toString(),headers:{"Content-Type":"application/x-www-form-urlencoded"},onload:function(g){vn(),k.processing=!1,g.finalUrl===m?d(new Error("\u66F4\u65B0\u5931\u8D25\uFF0C\u53EF\u80FD\u662Fformhash\u65E0\u6548\u6216\u6743\u9650\u4E0D\u8DB3")):l()},onerror:function(g){vn(),k.processing=!1,d(new Error(`\u7F51\u7EDC\u9519\u8BEF: ${g.message}`))},onabort:function(){vn(),k.processing=!1,d(new Error("\u8BF7\u6C42\u5DF2\u4E2D\u6B62"))},ontimeout:function(){vn(),k.processing=!1,d(new Error("\u8BF7\u6C42\u8D85\u65F6"))}})}}var Wu="Ov23lifi6y3LGaJ8A53e",na="wikiBatch-sync.json",Qu="wikiBatch \u8DE8\u8BBE\u5907\u540C\u6B65\u6570\u636E";function Fv(){return{version:1,csvData:localStorage.getItem("bgmCsvData")||"null",currentIndex:parseInt(localStorage.getItem("bgmCurrentIndex")||"0"),retryCount:GM_getValue("bgmRetryCount")||"{}",previousItem:localStorage.getItem("bgmPreviousItem"),entityType:localStorage.getItem("bgmEntityType")||"subject",totalItems:parseInt(localStorage.getItem("bgmTotalItems")||"0")}}function Mv(t){localStorage.setItem("bgmCsvData",t.csvData),localStorage.setItem("bgmCurrentIndex",t.currentIndex.toString()),localStorage.setItem("bgmEntityType",t.entityType),localStorage.setItem("bgmTotalItems",t.totalItems.toString()),GM_setValue("bgmRetryCount",t.retryCount),t.previousItem?localStorage.setItem("bgmPreviousItem",t.previousItem):localStorage.removeItem("bgmPreviousItem")}async function Hv(){return(await zn("https://github.com/login/device/code",{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({client_id:Wu,scope:"gist"})})).json()}async function Bv(t,e){return new Promise((n,i)=>{let r=e,o=async()=>{let l=await(await zn("https://github.com/login/oauth/access_token",{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({client_id:Wu,device_code:t,grant_type:"urn:ietf:params:oauth:grant-type:device_code"})})).json();l.access_token?n(l.access_token):l.error==="authorization_pending"?setTimeout(o,r*1e3):l.error==="slow_down"?(r+=5,setTimeout(o,r*1e3)):i(new Error(l.error_description||l.error||"\u6388\u6743\u5931\u8D25"))};o()})}async function Vu(t){t.textContent="\u6B63\u5728\u83B7\u53D6\u8BBE\u5907\u7801...";let e;try{e=await Hv()}catch{t.textContent="\u7F51\u7EDC\u9519\u8BEF\uFF0C\u65E0\u6CD5\u8FDE\u63A5 GitHub";return}t.innerHTML=`\u8BF7\u5728\u6253\u5F00\u7684\u9875\u9762\u4E2D\u8F93\u5165\u7801: <strong>${e.user_code}</strong>`,GM_openInTab(e.verification_uri);try{let n=await Bv(e.device_code,e.interval);GM_setValue("bgmGistToken",n),t.textContent="\u6388\u6743\u6210\u529F"}catch(n){t.textContent=n.message}}function Yu(){return GM_getValue("bgmGistId")||null}function Xl(t){GM_setValue("bgmGistId",t)}function ia(){return GM_getValue("bgmGistToken")||null}async function Rv(t){let e=ia();if(!e)throw new Error("\u672A\u6388\u6743");return(await(await zn("https://api.github.com/gists",{method:"POST",headers:{Accept:"application/vnd.github+json",Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({description:Qu,public:!1,files:{[na]:{content:t}}})})).json()).id}async function Ov(t,e){let n=ia();if(!n)throw new Error("\u672A\u6388\u6743");await zn(`https://api.github.com/gists/${t}`,{method:"PATCH",headers:{Accept:"application/vnd.github+json",Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({files:{[na]:{content:e}}})})}async function Ju(){let t=ia();return t&&(await(await zn("https://api.github.com/gists?per_page=100",{headers:{Accept:"application/vnd.github+json",Authorization:`Bearer ${t}`}})).json()).find(r=>r.description===Qu&&r.files?.[na])?.id||null}async function Pv(t){let e=ia();if(!e)throw new Error("\u672A\u6388\u6743");let r=(await(await zn(`https://api.github.com/gists/${t}`,{headers:{Accept:"application/vnd.github+json",Authorization:`Bearer ${e}`}})).json()).files?.[na];if(!r)throw new Error("Gist \u4E2D\u672A\u627E\u5230\u540C\u6B65\u6570\u636E");return r.content}async function qu(){let t=Fv(),e=JSON.stringify(t),n=Yu();n||(n=await Ju(),n&&Xl(n)),n?await Ov(n,e):(n=await Rv(e),Xl(n))}async function Ku(){let t=Yu();if(!t){if(t=await Ju(),!t)throw new Error("\u672A\u627E\u5230\u540C\u6B65 Gist\uFF0C\u8BF7\u5148\u5728\u53E6\u4E00\u8BBE\u5907\u4E0A\u4F20");Xl(t)}let e=await Pv(t),n=JSON.parse(e);Mv(n)}function Xu(){GM_deleteValue("bgmGistToken"),GM_deleteValue("bgmGistId")}function Zu(t){switch(t){case"setup-start-processing":Gu();break;case"setup-reset-progress":k.currentIndex=0,k.retryCount={},k.previousItem=null,localStorage.setItem("bgmCurrentIndex","0"),In();break;case"sync-auth-btn":jv();break;case"sync-upload-btn":Uv();break;case"sync-download-btn":Gv();break;case"sync-clear-btn":Xu(),In();break}}async function jv(){let t=document.getElementById("sync-status");if(!t)return;let e=document.getElementById("sync-auth-btn");e&&(e.disabled=!0),await Vu(t),e&&(e.disabled=!1),In()}async function Uv(){let t=document.getElementById("sync-status");if(t){Sn(),t.textContent="\u6B63\u5728\u4E0A\u4F20...";try{await qu(),t.textContent="\u4E0A\u4F20\u6210\u529F: "+new Date().toLocaleString()}catch(e){t.textContent="\u4E0A\u4F20\u5931\u8D25: "+e.message}}}async function Gv(){let t=document.getElementById("sync-status");if(t){t.textContent="\u6B63\u5728\u4E0B\u8F7D...";try{await Ku(),k.csvData=JSON.parse(localStorage.getItem("bgmCsvData")||"null"),k.currentIndex=parseInt(localStorage.getItem("bgmCurrentIndex")||"0"),k.entityType=localStorage.getItem("bgmEntityType")||"subject",k.totalItems=parseInt(localStorage.getItem("bgmTotalItems")||"0"),k.retryCount=JSON.parse(GM_getValue("bgmRetryCount","{}")),k.previousItem=JSON.parse(localStorage.getItem("bgmPreviousItem")||"null"),t.textContent="\u4E0B\u8F7D\u6210\u529F: "+new Date().toLocaleString(),In()}catch(e){t.textContent="\u4E0B\u8F7D\u5931\u8D25: "+e.message}}}function ep(t){if(!k.csvData)return;let e=k.csvData[k.currentIndex],n=k.currentSubjectData,i=e?.id||k.currentItemId||"",r=n?.name||"\u672A\u77E5\u540D\u79F0",o=k.entityType||"subject";function a(){return{id:i,name:r,type:o}}switch(t){case"process-cancel":{k.processing=!1,k.paused=!0,Pi(),In(),np();break}case"process-confirm-update":{let l=document.getElementById("static-wcode-input").value,d=o==="subject"?document.getElementById("static-tags-input").value.split(" ").filter(p=>p):[],u=o==="subject"?document.getElementById("static-series-checkbox").checked:!1,c=document.getElementById("static-commit-input").value||so(k.currentFieldUpdates,k.currentTagUpdates,k.currentSeriesUpdate,o);if(!Yl()){en("\u6CA1\u6709\u68C0\u6D4B\u5230\u5B9E\u8D28\u4FEE\u6539\uFF0C\u5DF2\u8DF3\u8FC7\u66F4\u65B0"),k.previousItem=a(),k.currentIndex++,Pi(),Sn(),pi();return}document.querySelectorAll("#static-buttons-container button").forEach(p=>{p.disabled=!0}),zi("\u6B63\u5728\u63D0\u4EA4\u66F4\u65B0..."),zu(i,l,d,u,r,e,c,()=>{k.previousItem=a(),k.currentIndex++,Pi(),Sn(),pi()},p=>{vn(),document.querySelectorAll("#static-buttons-container button").forEach(m=>{m.disabled=!1}),ju(p.message)});break}case"process-skip-update":k.previousItem=a(),k.currentIndex++,Pi(),Sn(),pi();break;case"process-confirm-continue":k.previousItem=a(),k.currentIndex++,Pi(),Sn(),pi();break;case"process-skip-error":k.currentIndex++,Pi(),Sn(),pi();break;case"process-retry-error":{let l=k.retryCount[i]||0;en(`\u6B63\u5728\u91CD\u8BD5\uFF08${l}\u6B21\uFF09...`),pi();break}case"process-skip-update-fail":k.previousItem=a(),k.currentIndex++,Pi(),Sn(),pi();break;case"process-retry-update":{let l=k.retryCount[i]||0;en(`\u6B63\u5728\u91CD\u8BD5\uFF08${l}\u6B21\uFF09...`),pi(!0);break}}}function tp(t){t==="completed-back-to-setup"&&(In(),np())}function np(){let t=document.getElementById("bgm-tool-progress");t&&(t.style.display="none")}var ip="data:image/png;base64,";var Zl=["light","dark","system"],sp=7,zv=40,ra=Math.floor(Math.random()*sp),oa="bgm-tool-container",Wv="bgm-float-button",ao=null;function ed(){if(ao)return;ao=[];let t=Array.from(document.body.children);for(let e of t){let n=e.id;n===oa||n===Wv||e.tagName!=="SCRIPT"&&(ao.push({el:e,origDisplay:e.style.display||""}),e.style.display="none")}}function Qv(){if(ao){for(let{el:t,origDisplay:e}of ao)t.style.display=e;ao=null}}function Vv(){ra=(ra+1)%sp;let t=document.getElementById("bgm-tool-logo-sprite");t&&(t.style.backgroundPosition=`${-ra*zv}px 0`)}function td(t){let e=document.getElementById("bgm-tool-container");if(!e)return;t==="dark"||t==="system"&&window.matchMedia("(prefers-color-scheme: dark)").matches?e.setAttribute("data-theme","dark"):e.removeAttribute("data-theme")}function Yv(){let t=Zl.indexOf(k.theme);k.theme=Zl[(t+1)%Zl.length],localStorage.setItem("bgmTheme",k.theme),td(k.theme),ap()}function ap(){let t=document.getElementById("bgm-tool-theme");if(!t)return;let e={light:'<i class="fas fa-sun"></i>',dark:'<i class="fas fa-moon"></i>',system:'<i class="fas fa-adjust"></i>'};t.innerHTML=e[k.theme]||e.system,t.title="\u4E3B\u9898: "+k.theme}function rp(){let t=document.getElementById("bgm-float-button");return t||(t=document.createElement("div"),t.id="bgm-float-button",t.innerHTML='<i class="fas fa-tools"></i>',document.body.appendChild(t),t.addEventListener("click",()=>{let e=document.getElementById(oa);e&&(e.style.display="flex",ed(),t&&(t.style.display="none"))})),t}function lp(){let t=rp();if(t.style.display="none",document.getElementById(oa)){document.getElementById(oa).style.display="flex",ed();return}let e=document.createElement("div");e.id="bgm-tool-container",e.innerHTML=`
    ...
    `,document.body.appendChild(e),ed(),Jv();let n=document.getElementById("bgm-tool-close");n&&n.addEventListener("click",()=>{e.style.display="none",Qv();let a=rp();a.style.display="flex",dd(),Sn()});let i=document.getElementById("bgm-tool-settings");i&&i.addEventListener("click",()=>{In()});let r=document.getElementById("bgm-tool-theme");r&&r.addEventListener("click",Yv);let o=document.getElementById("bgm-tool-header-logo");o&&o.addEventListener("click",Vv),td(k.theme),ap(),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{k.theme==="system"&&td("system")}),qv(),In()}function op(t){t.addEventListener("click",e=>{let n=e.target.closest("button");if(!n)return;let i=n.id;switch(k.currentView){case"setup":Zu(i);break;case"processing":ep(i);break;case"completed":tp(i);break}})}function Jv(){let t=document.getElementById("static-buttons-container");t&&op(t);let e=document.getElementById("core-content");e&&op(e)}function qv(){document.getElementById("static-commit-input").addEventListener("input",o=>{k.currentView==="processing"&&k.currentSubjectData&&(k.currentCommitMessage=o.target.value,ji())});let e=document.getElementById("static-lock-commit");e.addEventListener("click",()=>{if(k.currentView!=="processing"||!k.currentSubjectData)return;k.isCommitMessageLocked=!k.isCommitMessageLocked;let o=document.getElementById("static-commit-input");k.isCommitMessageLocked?(k.lockedCommitMessage=o.value,e.innerHTML='<i class="fas fa-lock"></i>',e.title="\u89E3\u9501\u7F16\u8F91\u6458\u8981"):(e.innerHTML='<i class="fas fa-lock-open"></i>',e.title="\u56FA\u5B9A\u7F16\u8F91\u6458\u8981",k.currentCommitMessage=so(k.currentFieldUpdates,k.currentTagUpdates,k.currentSeriesUpdate,k.entityType),o.value=k.currentCommitMessage),Sn(),ji()}),document.getElementById("static-wcode-input").addEventListener("input",o=>{k.currentView==="processing"&&k.currentSubjectData&&(k.currentWcode=o.target.value,Xo(k.currentSubjectData.infobox||"",o.target.value,"static-content-diff-container"),ji())}),document.getElementById("static-tags-input").addEventListener("input",o=>{k.currentView==="processing"&&k.currentSubjectData&&(k.currentTags=o.target.value,ta(k.currentSubjectData.metaTags||[],o.target.value.split(" ").filter(a=>a),"static-tags-diff-container"),ji())}),document.getElementById("static-series-checkbox").addEventListener("change",o=>{k.currentView==="processing"&&k.currentSubjectData&&(k.currentSeries=o.target.checked,ji())})}var dp=`/* stylelint-disable no-descending-specificity */
...
`;var fp=`.diff-tailwindcss-wrapper .\\!container {
	width: 100% !important;
}
...
`;GM_addStyle(dp);GM_addStyle(fp);var nd=document.createElement("link");nd.rel="stylesheet";nd.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css";document.head.appendChild(nd);lp();})();
